...
#include "j3224_v2x_msgs/msg/detail/measurement_time_offset__rosidl_typesupport_fastrtps_c.h"
...
using _MeasurementTimeOffset__ros_msg_type = j3224_v2x_msgs__msg__MeasurementTimeOffset;
...
static uint32_t _MeasurementTimeOffset__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j3224_v2x_msgs__msg__MeasurementTimeOffset(
...
{
  return max_serialized_size_j3224_v2x_msgs__msg__MeasurementTimeOffset(
    full_bounded, 0);
}
