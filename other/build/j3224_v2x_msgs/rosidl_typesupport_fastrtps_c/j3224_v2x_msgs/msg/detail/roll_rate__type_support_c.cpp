...
#include "j3224_v2x_msgs/msg/detail/roll_rate__rosidl_typesupport_fastrtps_c.h"
...
using _RollRate__ros_msg_type = j3224_v2x_msgs__msg__RollRate;
...
static uint32_t _RollRate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j3224_v2x_msgs__msg__RollRate(
...
{
  return max_serialized_size_j3224_v2x_msgs__msg__RollRate(
    full_bounded, 0);
}
