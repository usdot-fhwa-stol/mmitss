...
#include "j3224_v2x_msgs/msg/detail/object_type__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectType__ros_msg_type = j3224_v2x_msgs__msg__ObjectType;
...
static uint32_t _ObjectType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j3224_v2x_msgs__msg__ObjectType(
...
{
  return max_serialized_size_j3224_v2x_msgs__msg__ObjectType(
    full_bounded, 0);
}
