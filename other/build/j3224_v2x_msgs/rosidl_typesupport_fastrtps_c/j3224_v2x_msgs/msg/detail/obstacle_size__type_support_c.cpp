...
#include "j3224_v2x_msgs/msg/detail/obstacle_size__rosidl_typesupport_fastrtps_c.h"
...
#include "j3224_v2x_msgs/msg/detail/size_value__functions.h"  // height, length, width
...
using _ObstacleSize__ros_msg_type = j3224_v2x_msgs__msg__ObstacleSize;
  ...
  // Field name: width
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j3224_v2x_msgs, msg, SizeValue
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j3224_v2x_msgs__msg__SizeValue(
...
static uint32_t _ObstacleSize__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j3224_v2x_msgs__msg__ObstacleSize(
  ...
  size_t current_alignment)
{
  ...
  // member: width
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j3224_v2x_msgs__msg__SizeValue(
...
{
  return max_serialized_size_j3224_v2x_msgs__msg__ObstacleSize(
    full_bounded, 0);
}
