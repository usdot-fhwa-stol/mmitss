...
#include "j3224_v2x_msgs/msg/detail/object_distance__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectDistance__ros_msg_type = j3224_v2x_msgs__msg__ObjectDistance;
...
static uint32_t _ObjectDistance__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j3224_v2x_msgs__msg__ObjectDistance(
...
{
  return max_serialized_size_j3224_v2x_msgs__msg__ObjectDistance(
    full_bounded, 0);
}
