...
#include "j3224_v2x_msgs/msg/detail/detected_obstacle_data__rosidl_typesupport_fastrtps_c.h"
...
#include "j3224_v2x_msgs/msg/detail/obstacle_size__functions.h"  // obst_size
#include "j3224_v2x_msgs/msg/detail/obstacle_size_confidence__functions.h"  // obst_size_confidence

// forward declare type support functions
size_t get_serialized_size_j3224_v2x_msgs__msg__ObstacleSize(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_j3224_v2x_msgs__msg__ObstacleSize(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j3224_v2x_msgs, msg, ObstacleSize)();
...
using _DetectedObstacleData__ros_msg_type = j3224_v2x_msgs__msg__DetectedObstacleData;
  ...
  // Field name: obst_size
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j3224_v2x_msgs, msg, ObstacleSize
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j3224_v2x_msgs__msg__ObstacleSize(
...
static uint32_t _DetectedObstacleData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j3224_v2x_msgs__msg__DetectedObstacleData(
  ...
  size_t current_alignment)
{
  ...
  // member: obst_size
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j3224_v2x_msgs__msg__ObstacleSize(
...
{
  return max_serialized_size_j3224_v2x_msgs__msg__DetectedObstacleData(
    full_bounded, 0);
}
