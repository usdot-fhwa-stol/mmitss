...
#include "j3224_v2x_msgs/msg/detail/detected_object_optional_data__rosidl_typesupport_fastrtps_c.h"
...
#include "j3224_v2x_msgs/msg/detail/detected_obstacle_data__functions.h"  // det_obst
#include "j3224_v2x_msgs/msg/detail/detected_vehicle_data__functions.h"  // det_veh
#include "j3224_v2x_msgs/msg/detail/detected_vru_data__functions.h"  // det_vru

// forward declare type support functions
size_t get_serialized_size_j3224_v2x_msgs__msg__DetectedObstacleData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_j3224_v2x_msgs__msg__DetectedObstacleData(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j3224_v2x_msgs, msg, DetectedObstacleData)();
...
using _DetectedObjectOptionalData__ros_msg_type = j3224_v2x_msgs__msg__DetectedObjectOptionalData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: det_veh
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j3224_v2x_msgs, msg, DetectedVehicleData
      )()->data);
  ...
  // Field name: det_vru
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j3224_v2x_msgs, msg, DetectedVRUData
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: det_obst
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j3224_v2x_msgs, msg, DetectedObstacleData
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j3224_v2x_msgs__msg__DetectedVehicleData(
    &(ros_message->det_veh), current_alignment);
  // field.name det_vru

  current_alignment += get_serialized_size_j3224_v2x_msgs__msg__DetectedVRUData(
    &(ros_message->det_vru), current_alignment);
  // field.name det_obst

  current_alignment += get_serialized_size_j3224_v2x_msgs__msg__DetectedObstacleData(
...
static uint32_t _DetectedObjectOptionalData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j3224_v2x_msgs__msg__DetectedObjectOptionalData(
  ...
  size_t current_alignment)
{
  ...
  // member: det_veh
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j3224_v2x_msgs__msg__DetectedVehicleData(
  ...
  // member: det_vru
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j3224_v2x_msgs__msg__DetectedVRUData(
        full_bounded, current_alignment);
    }
  }
  // member: det_obst
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j3224_v2x_msgs__msg__DetectedObstacleData(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j3224_v2x_msgs__msg__DetectedObjectOptionalData(
    full_bounded, 0);
}
