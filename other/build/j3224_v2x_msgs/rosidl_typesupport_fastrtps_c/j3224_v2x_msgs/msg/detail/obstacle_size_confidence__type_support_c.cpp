...
#include "j3224_v2x_msgs/msg/detail/obstacle_size_confidence__rosidl_typesupport_fastrtps_c.h"
...
#include "j3224_v2x_msgs/msg/detail/size_value_confidence__functions.h"  // height_confidence, length_confidence, width_confidence
...
using _ObstacleSizeConfidence__ros_msg_type = j3224_v2x_msgs__msg__ObstacleSizeConfidence;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObstacleSizeConfidence__ros_msg_type * ros_message = static_cast<const _ObstacleSizeConfidence__ros_msg_type *>(untyped_ros_message);
  // Field name: width_confidence
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->width_confidence, cdr))
    {
      return false;
    }
  }

  // Field name: length_confidence
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->length_confidence, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: height_confidence
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->height_confidence, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _ObstacleSizeConfidence__ros_msg_type * ros_message = static_cast<_ObstacleSizeConfidence__ros_msg_type *>(untyped_ros_message);
  // Field name: width_confidence
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ObstacleSizeConfidence__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j3224_v2x_msgs__msg__ObstacleSizeConfidence(
...
{
  return max_serialized_size_j3224_v2x_msgs__msg__ObstacleSizeConfidence(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ObstacleSizeConfidence = {
  "j3224_v2x_msgs::msg",
...
static rosidl_message_type_support_t _ObstacleSizeConfidence__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObstacleSizeConfidence,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j3224_v2x_msgs, msg, ObstacleSizeConfidence)() {
  return &_ObstacleSizeConfidence__type_support;
}
