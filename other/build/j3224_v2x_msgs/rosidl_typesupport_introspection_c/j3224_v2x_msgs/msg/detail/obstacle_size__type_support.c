...
// Member `length`
// Member `height`
#include "j3224_v2x_msgs/msg/size_value.h"
// Member `width`
// Member `length`
// Member `height`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  j3224_v2x_msgs__msg__ObstacleSize__init(message_memory);
}

void ObstacleSize__rosidl_typesupport_introspection_c__ObstacleSize_fini_function(void * message_memory)
{
  j3224_v2x_msgs__msg__ObstacleSize__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ObstacleSize__rosidl_typesupport_introspection_c__ObstacleSize_message_member_array[4] = {
  {
    ...
    offsetof(j3224_v2x_msgs__msg__ObstacleSize, width),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__ObstacleSize, length),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__ObstacleSize, presence_vector),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__ObstacleSize, height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ObstacleSize__rosidl_typesupport_introspection_c__ObstacleSize_message_members = {
  ...
  4,  // number of fields
  sizeof(j3224_v2x_msgs__msg__ObstacleSize),
