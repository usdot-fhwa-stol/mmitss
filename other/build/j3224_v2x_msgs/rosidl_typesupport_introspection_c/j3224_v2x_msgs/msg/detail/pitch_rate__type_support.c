  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  j3224_v2x_msgs__msg__PitchRate__init(message_memory);
}

void PitchRate__rosidl_typesupport_introspection_c__PitchRate_fini_function(void * message_memory)
{
  j3224_v2x_msgs__msg__PitchRate__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember PitchRate__rosidl_typesupport_introspection_c__PitchRate_message_member_array[1] = {
  {
    "pitch_rate",  // name
    ...
    offsetof(j3224_v2x_msgs__msg__PitchRate, pitch_rate),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers PitchRate__rosidl_typesupport_introspection_c__PitchRate_message_members = {
  ...
  1,  // number of fields
  sizeof(j3224_v2x_msgs__msg__PitchRate),
