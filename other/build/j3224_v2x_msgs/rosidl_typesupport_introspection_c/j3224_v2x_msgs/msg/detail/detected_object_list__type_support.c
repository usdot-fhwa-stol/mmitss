...
#include "j3224_v2x_msgs/msg/detected_object_data.h"
// Member `detected_object_data`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  j3224_v2x_msgs__msg__DetectedObjectList__init(message_memory);
}

void DetectedObjectList__rosidl_typesupport_introspection_c__DetectedObjectList_fini_function(void * message_memory)
{
  j3224_v2x_msgs__msg__DetectedObjectList__fini(message_memory);
}
...
{
  const j3224_v2x_msgs__msg__DetectedObjectData__Sequence * member =
    (const j3224_v2x_msgs__msg__DetectedObjectData__Sequence *)(untyped_member);
  return member->size;
}
...
{
  j3224_v2x_msgs__msg__DetectedObjectData__Sequence * member =
    (j3224_v2x_msgs__msg__DetectedObjectData__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  j3224_v2x_msgs__msg__DetectedObjectData__Sequence * member =
    (j3224_v2x_msgs__msg__DetectedObjectData__Sequence *)(untyped_member);
  j3224_v2x_msgs__msg__DetectedObjectData__Sequence__fini(member);
  return j3224_v2x_msgs__msg__DetectedObjectData__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember DetectedObjectList__rosidl_typesupport_introspection_c__DetectedObjectList_message_member_array[1] = {
  {
    ...
    offsetof(j3224_v2x_msgs__msg__DetectedObjectList, detected_object_data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectedObjectList__rosidl_typesupport_introspection_c__DetectedObjectList_message_members = {
  ...
  1,  // number of fields
  sizeof(j3224_v2x_msgs__msg__DetectedObjectList),
