  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  j3224_v2x_msgs__msg__DetectedVRUData__init(message_memory);
}

void DetectedVRUData__rosidl_typesupport_introspection_c__DetectedVRUData_fini_function(void * message_memory)
{
  j3224_v2x_msgs__msg__DetectedVRUData__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember DetectedVRUData__rosidl_typesupport_introspection_c__DetectedVRUData_message_member_array[5] = {
  {
    ...
    offsetof(j3224_v2x_msgs__msg__DetectedVRUData, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedVRUData, basic_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedVRUData, propulsion),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedVRUData, attachment),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedVRUData, radius),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectedVRUData__rosidl_typesupport_introspection_c__DetectedVRUData_message_members = {
  ...
  5,  // number of fields
  sizeof(j3224_v2x_msgs__msg__DetectedVRUData),
