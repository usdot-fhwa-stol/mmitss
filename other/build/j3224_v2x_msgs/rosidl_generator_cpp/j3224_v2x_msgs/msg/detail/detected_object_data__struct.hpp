...
#ifndef J3224_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_DATA__STRUCT_HPP_
#define J3224_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__j3224_v2x_msgs__msg__DetectedObjectData __attribute__((deprecated))
#else
# define DEPRECATED__j3224_v2x_msgs__msg__DetectedObjectData __declspec(deprecated)
#endif
...
struct DetectedObjectData_
{
  ...
  Type & set__detected_object_common_data(
    const j3224_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator> & _arg)
  {
  ...
  Type & set__detected_object_optional_data(
    const j3224_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator> *;
  using ConstRawPtr =
    const j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__j3224_v2x_msgs__msg__DetectedObjectData
    std::shared_ptr<j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__j3224_v2x_msgs__msg__DetectedObjectData
    std::shared_ptr<j3224_v2x_msgs::msg::DetectedObjectData_<ContainerAllocator> const>
...
using DetectedObjectData =
  j3224_v2x_msgs::msg::DetectedObjectData_<std::allocator<void>>;
...
#endif  // J3224_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_DATA__STRUCT_HPP_
