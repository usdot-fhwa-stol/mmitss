...
static const _ObjectType_type_support_symbol_names_t _ObjectType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, j3224_v2x_msgs, msg, ObjectType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j3224_v2x_msgs, msg, ObjectType)),
  }
};
...
{
  return &::j3224_v2x_msgs::msg::rosidl_typesupport_cpp::ObjectType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, j3224_v2x_msgs, msg, ObjectType)() {
  return get_message_type_support_handle<j3224_v2x_msgs::msg::ObjectType>();
}
