...
bool j3224_v2x_msgs__msg__object_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j3224_v2x_msgs.msg._object_id.ObjectID", full_classname_dest, 38) == 0);
  }
  j3224_v2x_msgs__msg__ObjectID * ros_message = _ros_message;
  {  // object_id
    ...
    ros_message->object_id = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ObjectID */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j3224_v2x_msgs.msg._object_id");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectID");
