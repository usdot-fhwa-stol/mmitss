...
class Metaclass_PitchDetected(type):
    ...
    __constants = {
        'MIN_PITCH_DETECTED': -7200,
        'MAX_PITCH_DETECTED': 7200,
    }
...
class PitchDetected(metaclass=Metaclass_PitchDetected):
    ...
    def __init__(self, **kwargs):
        ...
        self.pitch_detected = kwargs.get('pitch_detected', int())
    ...
    def pitch_detected(self, value):
        if __debug__:
            assert \
                ...
                "The 'pitch_detected' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'pitch_detected' field must be an integer in [-32768, 32767]"
