    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'j3224_v2x_msgs.msg.SensorDataSharingMessage')
            logger.debug(
            ...
            from j3224_v2x_msgs.msg import DetectedObjectList
...
class SensorDataSharingMessage(metaclass=Metaclass_SensorDataSharingMessage):
    ...
    _fields_and_field_types = {
        ...
        'ref_pos': 'j2735_v2x_msgs/Position3D',
        'ref_pos_xy_conf': 'j2735_v2x_msgs/PositionalAccuracy',
        'objects': 'j3224_v2x_msgs/DetectedObjectList',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'DetectedObjectList'),  # noqa: E501
