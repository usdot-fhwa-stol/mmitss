...
class Attitude(metaclass=Metaclass_Attitude):
    ...
    _fields_and_field_types = {
        'pitch': 'j3224_v2x_msgs/PitchDetected',
        'roll': 'j3224_v2x_msgs/RollDetected',
        'yaw': 'j3224_v2x_msgs/YawDetected',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'PitchDetected'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'RollDetected'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'YawDetected'),  # noqa: E501
    )
