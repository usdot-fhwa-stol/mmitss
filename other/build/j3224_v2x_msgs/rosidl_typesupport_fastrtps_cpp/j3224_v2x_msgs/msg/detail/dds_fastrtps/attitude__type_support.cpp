...
#include "j3224_v2x_msgs/msg/detail/attitude__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j3224_v2x_msgs::msg::PitchDetected &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j3224_v2x_msgs::msg::PitchDetected &);
...
{
bool cdr_serialize(
  const j3224_v2x_msgs::msg::RollDetected &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const j3224_v2x_msgs::msg::YawDetected &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const j3224_v2x_msgs::msg::Attitude & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  j3224_v2x_msgs::msg::Attitude & ros_message)
{
  // Member: pitch
  ...
  size_t current_alignment)
{
  ...
  // Member: pitch
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PitchDetected(
  ...
  // Member: roll
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RollDetected(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: yaw
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_YawDetected(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j3224_v2x_msgs::msg::Attitude *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j3224_v2x_msgs::msg::Attitude *>(
    untyped_ros_message);
...
{
  return &j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::_Attitude__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, j3224_v2x_msgs, msg, Attitude)() {
  return &j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::_Attitude__handle;
}
