...
#include "j3224_v2x_msgs/msg/detail/measurement_time_offset__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const j3224_v2x_msgs::msg::MeasurementTimeOffset *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j3224_v2x_msgs::msg::MeasurementTimeOffset *>(
    untyped_ros_message);
...
{
  return &j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::_MeasurementTimeOffset__handle;
}
