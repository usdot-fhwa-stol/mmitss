...
#include "j3224_v2x_msgs/msg/detail/detected_obstacle_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j3224_v2x_msgs::msg::ObstacleSize &,
...
cdr_serialize(
  const j3224_v2x_msgs::msg::DetectedObstacleData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  j3224_v2x_msgs::msg::DetectedObstacleData & ros_message)
{
  // Member: obst_size
  ...
  size_t current_alignment)
{
  ...
  // Member: obst_size
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObstacleSize(
...
{
  auto typed_message =
    static_cast<const j3224_v2x_msgs::msg::DetectedObstacleData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j3224_v2x_msgs::msg::DetectedObstacleData *>(
    untyped_ros_message);
...
{
  return &j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::_DetectedObstacleData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, j3224_v2x_msgs, msg, DetectedObstacleData)() {
  return &j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::_DetectedObstacleData__handle;
}
