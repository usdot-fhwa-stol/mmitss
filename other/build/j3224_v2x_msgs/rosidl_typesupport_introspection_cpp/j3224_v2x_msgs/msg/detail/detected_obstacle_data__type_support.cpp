...
{
  new (message_memory) j3224_v2x_msgs::msg::DetectedObstacleData(_init);
}

void DetectedObstacleData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j3224_v2x_msgs::msg::DetectedObstacleData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectedObstacleData_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<j3224_v2x_msgs::msg::ObstacleSize>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs::msg::DetectedObstacleData, obst_size),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs::msg::DetectedObstacleData, obst_size_confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectedObstacleData_message_members = {
  ...
  2,  // number of fields
  sizeof(j3224_v2x_msgs::msg::DetectedObstacleData),
...
{
  return &::j3224_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedObstacleData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j3224_v2x_msgs, msg, DetectedObstacleData)() {
  return &::j3224_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedObstacleData_message_type_support_handle;
}
