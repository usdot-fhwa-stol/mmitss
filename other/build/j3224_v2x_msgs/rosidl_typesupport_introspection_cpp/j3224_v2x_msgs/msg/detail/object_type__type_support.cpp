...
{
  new (message_memory) j3224_v2x_msgs::msg::ObjectType(_init);
}

void ObjectType_fini_function(void * message_memory)
{
  auto typed_message = static_cast<j3224_v2x_msgs::msg::ObjectType *>(message_memory);
  typed_message->~ObjectType();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectType_message_member_array[1] = {
  {
    "object_type",  // name
    ...
    offsetof(j3224_v2x_msgs::msg::ObjectType, object_type),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectType_message_members = {
  ...
  1,  // number of fields
  sizeof(j3224_v2x_msgs::msg::ObjectType),
...
{
  return &::j3224_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j3224_v2x_msgs, msg, ObjectType)() {
  return &::j3224_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectType_message_type_support_handle;
}
