...
#include "carma_perception_msgs/msg/detail/external_object_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_perception_msgs::msg::ExternalObjectList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_perception_msgs::msg::ExternalObjectList & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_carma_perception_msgs
max_serialized_size_ExternalObjectList(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const carma_perception_msgs::msg::ExternalObjectList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_perception_msgs::msg::ExternalObjectList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ExternalObjectList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_perception_msgs::msg::ExternalObjectList *>(
...
{
  return max_serialized_size_ExternalObjectList(full_bounded, 0);
}

static message_type_support_callbacks_t _ExternalObjectList__callbacks = {
...
static rosidl_message_type_support_t _ExternalObjectList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ExternalObjectList__callbacks,
...
{
  return &carma_perception_msgs::msg::typesupport_fastrtps_cpp::_ExternalObjectList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_perception_msgs, msg, ExternalObjectList)() {
  return &carma_perception_msgs::msg::typesupport_fastrtps_cpp::_ExternalObjectList__handle;
}
