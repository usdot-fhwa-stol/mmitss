...
#include "carma_perception_msgs/msg/detail/roadway_obstacle_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_perception_msgs::msg::RoadwayObstacleList & ros_message,
  ...
  // Member: roadway_obstacles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      carma_perception_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.roadway_obstacles[i],
        cdr);
    }
  }
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_perception_msgs::msg::RoadwayObstacleList & ros_message)
{
  // Member: roadway_obstacles
  {
    uint32_t cdrSize;
    ...
    ros_message.roadway_obstacles.resize(size);
    for (size_t i = 0; i < size; i++) {
      carma_perception_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.roadway_obstacles[i]);
    }
  }
  ...
  // Member: roadway_obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.roadway_obstacles[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_carma_perception_msgs
max_serialized_size_RoadwayObstacleList(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: roadway_obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RoadwayObstacle(
...
{
  auto typed_message =
    static_cast<const carma_perception_msgs::msg::RoadwayObstacleList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_perception_msgs::msg::RoadwayObstacleList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RoadwayObstacleList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_perception_msgs::msg::RoadwayObstacleList *>(
...
{
  return max_serialized_size_RoadwayObstacleList(full_bounded, 0);
}

static message_type_support_callbacks_t _RoadwayObstacleList__callbacks = {
...
static rosidl_message_type_support_t _RoadwayObstacleList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RoadwayObstacleList__callbacks,
...
{
  return &carma_perception_msgs::msg::typesupport_fastrtps_cpp::_RoadwayObstacleList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_perception_msgs, msg, RoadwayObstacleList)() {
  return &carma_perception_msgs::msg::typesupport_fastrtps_cpp::_RoadwayObstacleList__handle;
}
