...
bool carma_perception_msgs__msg__external_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_perception_msgs.msg._external_object.ExternalObject", full_classname_dest, 57) == 0);
  }
  carma_perception_msgs__msg__ExternalObject * ros_message = _ros_message;
  {  // header
  ...
  {  // bsm_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "bsm_id");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->bsm_id.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'bsm_id'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // velocity_inst
    PyObject * field = PyObject_GetAttrString(_pymsg, "velocity_inst");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__twist_with_covariance__convert_from_py(field, &ros_message->velocity_inst)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // dynamic_obj
    PyObject * field = PyObject_GetAttrString(_pymsg, "dynamic_obj");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->dynamic_obj = (Py_True == field);
    Py_DECREF(field);
  }
  {  // predictions
    ...
    if (!carma_perception_msgs__msg__PredictedState__Sequence__init(&(ros_message->predictions), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create carma_perception_msgs__msg__PredictedState__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    carma_perception_msgs__msg__PredictedState * dest = ros_message->predictions.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!carma_perception_msgs__msg__predicted_state__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ExternalObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_perception_msgs.msg._external_object");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExternalObject");
  ...
  {  // bsm_id
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "bsm_id");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->bsm_id.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->bsm_id.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->bsm_id.size * sizeof(uint8_t));
      assert(data != NULL);
  ...
  {  // velocity_inst
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist_with_covariance__convert_to_py(&ros_message->velocity_inst);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "velocity_inst", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // dynamic_obj
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->dynamic_obj ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "dynamic_obj", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // predictions
    ...
    carma_perception_msgs__msg__PredictedState * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->predictions.data[i]);
      PyObject * pyitem = carma_perception_msgs__msg__predicted_state__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
