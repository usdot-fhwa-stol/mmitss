...
static const _CheckActiveGeofence_type_support_symbol_names_t _CheckActiveGeofence_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_perception_msgs, msg, CheckActiveGeofence)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_perception_msgs, msg, CheckActiveGeofence)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_perception_msgs, msg, CheckActiveGeofence)() {
  return &::carma_perception_msgs::msg::rosidl_typesupport_c::CheckActiveGeofence_message_type_support_handle;
}
