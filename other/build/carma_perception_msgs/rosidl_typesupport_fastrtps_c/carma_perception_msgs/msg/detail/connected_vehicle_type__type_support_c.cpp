...
#include "carma_perception_msgs/msg/detail/connected_vehicle_type__rosidl_typesupport_fastrtps_c.h"
...
using _ConnectedVehicleType__ros_msg_type = carma_perception_msgs__msg__ConnectedVehicleType;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ConnectedVehicleType__ros_msg_type * ros_message = static_cast<const _ConnectedVehicleType__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ConnectedVehicleType__ros_msg_type * ros_message = static_cast<_ConnectedVehicleType__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
    cdr >> ros_message->type;
  }
...
static uint32_t _ConnectedVehicleType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_perception_msgs__msg__ConnectedVehicleType(
...
{
  return max_serialized_size_carma_perception_msgs__msg__ConnectedVehicleType(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ConnectedVehicleType = {
...
static rosidl_message_type_support_t _ConnectedVehicleType__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ConnectedVehicleType,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_perception_msgs, msg, ConnectedVehicleType)() {
  return &_ConnectedVehicleType__type_support;
}
