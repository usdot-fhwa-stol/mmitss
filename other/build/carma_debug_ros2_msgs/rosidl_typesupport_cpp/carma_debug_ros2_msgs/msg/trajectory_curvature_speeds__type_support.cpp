...
static const _TrajectoryCurvatureSpeeds_type_support_symbol_names_t _TrajectoryCurvatureSpeeds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_debug_ros2_msgs, msg, TrajectoryCurvatureSpeeds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_debug_ros2_msgs, msg, TrajectoryCurvatureSpeeds)),
  }
};
...
{
  return &::carma_debug_ros2_msgs::msg::rosidl_typesupport_cpp::TrajectoryCurvatureSpeeds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carma_debug_ros2_msgs, msg, TrajectoryCurvatureSpeeds)() {
  return get_message_type_support_handle<carma_debug_ros2_msgs::msg::TrajectoryCurvatureSpeeds>();
}
