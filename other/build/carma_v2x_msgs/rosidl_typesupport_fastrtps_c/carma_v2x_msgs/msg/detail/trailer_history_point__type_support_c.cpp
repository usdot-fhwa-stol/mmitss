...
#include "carma_v2x_msgs/msg/detail/trailer_history_point__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/angle__functions.h"  // pivot_angle
...
using _TrailerHistoryPoint__ros_msg_type = carma_v2x_msgs__msg__TrailerHistoryPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrailerHistoryPoint__ros_msg_type * ros_message = static_cast<const _TrailerHistoryPoint__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _TrailerHistoryPoint__ros_msg_type * ros_message = static_cast<_TrailerHistoryPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: presence_vector
  {
    cdr >> ros_message->presence_vector;
  }
...
static uint32_t _TrailerHistoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__TrailerHistoryPoint(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__TrailerHistoryPoint(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_TrailerHistoryPoint = {
  "carma_v2x_msgs::msg",
  "TrailerHistoryPoint",
...
static rosidl_message_type_support_t _TrailerHistoryPoint__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrailerHistoryPoint,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, TrailerHistoryPoint)() {
  return &_TrailerHistoryPoint__type_support;
}
