...
#include "carma_v2x_msgs/msg/detail/positional_accuracy__rosidl_typesupport_fastrtps_c.h"
...
using _PositionalAccuracy__ros_msg_type = carma_v2x_msgs__msg__PositionalAccuracy;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: semi_major
  {
    cdr << ros_message->semi_major;
  }

  // Field name: semi_minor
  {
...
static uint32_t _PositionalAccuracy__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__PositionalAccuracy(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__PositionalAccuracy(
    full_bounded, 0);
}
