...
#include "carma_v2x_msgs/msg/detail/detected_object_list__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/detected_object_data__functions.h"  // detected_object_data
...
using _DetectedObjectList__ros_msg_type = carma_v2x_msgs__msg__DetectedObjectList;
  ...
  // Field name: detected_object_data
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, DetectedObjectData
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detected_object_data
  {
    ...
    if (ros_message->detected_object_data.data) {
      carma_v2x_msgs__msg__DetectedObjectData__Sequence__fini(&ros_message->detected_object_data);
    }
    if (!carma_v2x_msgs__msg__DetectedObjectData__Sequence__init(&ros_message->detected_object_data, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name detected_object_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_carma_v2x_msgs__msg__DetectedObjectData(
...
static uint32_t _DetectedObjectList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__DetectedObjectList(
  ...
  size_t current_alignment)
{
  ...
  // member: detected_object_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__DetectedObjectData(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__DetectedObjectList(
    full_bounded, 0);
}
