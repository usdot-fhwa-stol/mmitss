...
#include "carma_v2x_msgs/msg/detail/bumper_heights__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/bumper_height__functions.h"  // front, rear
...
using _BumperHeights__ros_msg_type = carma_v2x_msgs__msg__BumperHeights;
  ...
  // Field name: front
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, BumperHeight
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__BumperHeight(
...
static uint32_t _BumperHeights__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__BumperHeights(
  ...
  size_t current_alignment)
{
  ...
  // member: front
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__BumperHeight(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__BumperHeights(
    full_bounded, 0);
}
