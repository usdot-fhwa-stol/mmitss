...
#include "carma_v2x_msgs/msg/detail/detected_object_data__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/detected_object_common_data__functions.h"  // detected_object_common_data
#include "carma_v2x_msgs/msg/detail/detected_object_optional_data__functions.h"  // detected_object_optional_data
...
using _DetectedObjectData__ros_msg_type = carma_v2x_msgs__msg__DetectedObjectData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detected_object_common_data
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, DetectedObjectCommonData
      )()->data);
  ...
  // Field name: detected_object_optional_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, DetectedObjectOptionalData
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_carma_v2x_msgs__msg__DetectedObjectData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DetectedObjectData__ros_msg_type * ros_message = static_cast<const _DetectedObjectData__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__DetectedObjectCommonData(
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__DetectedObjectOptionalData(
...
static uint32_t _DetectedObjectData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__DetectedObjectData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carma_v2x_msgs
size_t max_serialized_size_carma_v2x_msgs__msg__DetectedObjectData(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: detected_object_common_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__DetectedObjectCommonData(
  ...
  // member: detected_object_optional_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__DetectedObjectOptionalData(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__DetectedObjectData(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, DetectedObjectData)() {
