...
#include "carma_v2x_msgs/msg/detail/detected_vru_data__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/attachment_radius__functions.h"  // radius
...
using _DetectedVRUData__ros_msg_type = carma_v2x_msgs__msg__DetectedVRUData;
...
static uint32_t _DetectedVRUData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__DetectedVRUData(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__DetectedVRUData(
    full_bounded, 0);
}
