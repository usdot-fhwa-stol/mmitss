...
#include "carma_v2x_msgs/msg/detail/weather_report__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/coefficient_of_friction__functions.h"  // road_friction
#include "carma_v2x_msgs/msg/detail/ntcip_ess_precip_rate__functions.h"  // rain_rate
...
using _WeatherReport__ros_msg_type = carma_v2x_msgs__msg__WeatherReport;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: rain_rate
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, NTCIPEssPrecipRate
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: road_friction
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, CoefficientOfFriction
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__NTCIPEssPrecipRate(
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__CoefficientOfFriction(
...
static uint32_t _WeatherReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__WeatherReport(
  ...
  size_t current_alignment)
{
  ...
  // member: rain_rate
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__NTCIPEssPrecipRate(
        full_bounded, current_alignment);
    }
  }
  ...
  // member: road_friction
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__CoefficientOfFriction(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__WeatherReport(
    full_bounded, 0);
}
