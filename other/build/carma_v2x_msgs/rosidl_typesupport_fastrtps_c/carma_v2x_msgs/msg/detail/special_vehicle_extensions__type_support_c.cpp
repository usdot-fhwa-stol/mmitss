...
#include "carma_v2x_msgs/msg/detail/special_vehicle_extensions__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/trailer_data__functions.h"  // trailers
...
using _SpecialVehicleExtensions__ros_msg_type = carma_v2x_msgs__msg__SpecialVehicleExtensions;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: trailers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, TrailerData
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__TrailerData(
...
static uint32_t _SpecialVehicleExtensions__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__SpecialVehicleExtensions(
  ...
  size_t current_alignment)
{
  ...
  // member: trailers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__TrailerData(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__SpecialVehicleExtensions(
    full_bounded, 0);
}
