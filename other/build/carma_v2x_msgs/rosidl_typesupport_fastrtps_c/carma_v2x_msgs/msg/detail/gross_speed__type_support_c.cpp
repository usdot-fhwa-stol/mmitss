...
#include "carma_v2x_msgs/msg/detail/gross_speed__rosidl_typesupport_fastrtps_c.h"
...
using _GrossSpeed__ros_msg_type = carma_v2x_msgs__msg__GrossSpeed;
...
static uint32_t _GrossSpeed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__GrossSpeed(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__GrossSpeed(
    full_bounded, 0);
}
