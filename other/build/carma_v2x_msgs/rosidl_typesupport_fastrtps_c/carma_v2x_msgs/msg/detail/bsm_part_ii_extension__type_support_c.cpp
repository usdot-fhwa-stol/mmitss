...
#include "carma_v2x_msgs/msg/detail/bsm_part_ii_extension__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/special_vehicle_extensions__functions.h"  // special_vehicle_extensions
#include "carma_v2x_msgs/msg/detail/supplemental_vehicle_extensions__functions.h"  // supplemental_vehicle_extensions
#include "carma_v2x_msgs/msg/detail/vehicle_safety_extensions__functions.h"  // vehicle_safety_extensions

// forward declare type support functions
size_t get_serialized_size_carma_v2x_msgs__msg__SpecialVehicleExtensions(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__SpecialVehicleExtensions(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, SpecialVehicleExtensions)();
...
using _BSMPartIIExtension__ros_msg_type = carma_v2x_msgs__msg__BSMPartIIExtension;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: vehicle_safety_extensions
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, VehicleSafetyExtensions
      )()->data);
  ...
  // Field name: special_vehicle_extensions
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, SpecialVehicleExtensions
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: supplemental_vehicle_extensions
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, SupplementalVehicleExtensions
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__VehicleSafetyExtensions(
    &(ros_message->vehicle_safety_extensions), current_alignment);
  // field.name special_vehicle_extensions

  current_alignment += get_serialized_size_carma_v2x_msgs__msg__SpecialVehicleExtensions(
    &(ros_message->special_vehicle_extensions), current_alignment);
  // field.name supplemental_vehicle_extensions

  current_alignment += get_serialized_size_carma_v2x_msgs__msg__SupplementalVehicleExtensions(
...
static uint32_t _BSMPartIIExtension__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__BSMPartIIExtension(
  ...
  size_t current_alignment)
{
  ...
  // member: vehicle_safety_extensions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__VehicleSafetyExtensions(
  ...
  // member: special_vehicle_extensions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__SpecialVehicleExtensions(
        full_bounded, current_alignment);
    }
  }
  // member: supplemental_vehicle_extensions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__SupplementalVehicleExtensions(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__BSMPartIIExtension(
    full_bounded, 0);
}
