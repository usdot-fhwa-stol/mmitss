...
#include "carma_v2x_msgs/msg/detail/latitude__rosidl_typesupport_fastrtps_c.h"
...
using _Latitude__ros_msg_type = carma_v2x_msgs__msg__Latitude;
...
static uint32_t _Latitude__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__Latitude(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__Latitude(
    full_bounded, 0);
}
