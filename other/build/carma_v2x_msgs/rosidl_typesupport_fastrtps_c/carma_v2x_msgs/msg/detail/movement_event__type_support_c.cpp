...
#include "carma_v2x_msgs/msg/detail/movement_event__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/advisory_speed__functions.h"  // advisory_speed_list
#include "carma_v2x_msgs/msg/detail/time_change_details__functions.h"  // timing
#include "j2735_v2x_msgs/msg/detail/movement_phase_state__functions.h"  // event_state

// forward declare type support functions
size_t get_serialized_size_carma_v2x_msgs__msg__AdvisorySpeed(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__AdvisorySpeed(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, AdvisorySpeed)();
size_t get_serialized_size_carma_v2x_msgs__msg__TimeChangeDetails(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__TimeChangeDetails(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, TimeChangeDetails)();
...
using _MovementEvent__ros_msg_type = carma_v2x_msgs__msg__MovementEvent;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: timing
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, TimeChangeDetails
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: advisory_speed_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, AdvisorySpeed
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: advisory_speed_list
  {
    ...
    if (ros_message->advisory_speed_list.data) {
      carma_v2x_msgs__msg__AdvisorySpeed__Sequence__fini(&ros_message->advisory_speed_list);
    }
    if (!carma_v2x_msgs__msg__AdvisorySpeed__Sequence__init(&ros_message->advisory_speed_list, size)) {
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__TimeChangeDetails(
  ...
  // field.name advisory_speed_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_carma_v2x_msgs__msg__AdvisorySpeed(
...
static uint32_t _MovementEvent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__MovementEvent(
  ...
  size_t current_alignment)
{
  ...
  // member: timing
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__TimeChangeDetails(
        full_bounded, current_alignment);
    }
  }
  ...
  // member: advisory_speed_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__AdvisorySpeed(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__MovementEvent(
    full_bounded, 0);
}
