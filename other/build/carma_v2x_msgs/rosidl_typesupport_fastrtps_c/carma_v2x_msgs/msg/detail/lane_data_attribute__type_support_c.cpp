...
#include "carma_v2x_msgs/msg/detail/lane_data_attribute__rosidl_typesupport_fastrtps_c.h"
...
using _LaneDataAttribute__ros_msg_type = carma_v2x_msgs__msg__LaneDataAttribute;
...
static uint32_t _LaneDataAttribute__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__LaneDataAttribute(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__LaneDataAttribute(
    full_bounded, 0);
}
