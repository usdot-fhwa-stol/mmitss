...
#include "carma_v2x_msgs/msg/detail/traffic_control_bounds__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // oldest
#include "carma_v2x_msgs/msg/detail/offset_point__functions.h"  // offsets
...
using _TrafficControlBounds__ros_msg_type = carma_v2x_msgs__msg__TrafficControlBounds;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: offsets
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, OffsetPoint
      )()->data);
    size_t size = 3;
  ...
  size_t current_alignment)
{
  ...
  // field.name offsets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_carma_v2x_msgs__msg__OffsetPoint(
...
static uint32_t _TrafficControlBounds__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__TrafficControlBounds(
  ...
  size_t current_alignment)
{
  ...
  // member: offsets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__OffsetPoint(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__TrafficControlBounds(
    full_bounded, 0);
}
