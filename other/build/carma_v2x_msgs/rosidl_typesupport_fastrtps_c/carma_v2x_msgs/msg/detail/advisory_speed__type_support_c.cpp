...
#include "carma_v2x_msgs/msg/detail/advisory_speed__rosidl_typesupport_fastrtps_c.h"
...
using _AdvisorySpeed__ros_msg_type = carma_v2x_msgs__msg__AdvisorySpeed;
...
static uint32_t _AdvisorySpeed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__AdvisorySpeed(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__AdvisorySpeed(
    full_bounded, 0);
}
