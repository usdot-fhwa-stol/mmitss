...
#include "carma_v2x_msgs/msg/detail/traffic_control_detail__rosidl_typesupport_fastrtps_c.h"
...
using _TrafficControlDetail__ros_msg_type = carma_v2x_msgs__msg__TrafficControlDetail;
...
static uint32_t _TrafficControlDetail__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__TrafficControlDetail(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__TrafficControlDetail(
    full_bounded, 0);
}
