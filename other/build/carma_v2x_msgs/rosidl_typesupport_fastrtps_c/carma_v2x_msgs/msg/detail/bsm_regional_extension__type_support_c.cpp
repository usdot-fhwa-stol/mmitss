...
#include "carma_v2x_msgs/msg/detail/bsm_regional_extension__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/position3_d__functions.h"  // route_destination_points
...
using _BSMRegionalExtension__ros_msg_type = carma_v2x_msgs__msg__BSMRegionalExtension;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: route_destination_points
  {
    ...
    if (ros_message->route_destination_points.data) {
      carma_v2x_msgs__msg__Position3D__Sequence__fini(&ros_message->route_destination_points);
    }
...
static uint32_t _BSMRegionalExtension__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__BSMRegionalExtension(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__BSMRegionalExtension(
    full_bounded, 0);
}
