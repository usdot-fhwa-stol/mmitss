...
#include "carma_v2x_msgs/msg/detail/speed__rosidl_typesupport_fastrtps_c.h"
...
using _Speed__ros_msg_type = carma_v2x_msgs__msg__Speed;
...
static uint32_t _Speed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__Speed(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__Speed(
    full_bounded, 0);
}
