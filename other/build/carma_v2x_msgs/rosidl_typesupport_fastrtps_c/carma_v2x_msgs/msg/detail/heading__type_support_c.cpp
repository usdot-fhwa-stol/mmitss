...
#include "carma_v2x_msgs/msg/detail/heading__rosidl_typesupport_fastrtps_c.h"
...
using _Heading__ros_msg_type = carma_v2x_msgs__msg__Heading;
...
static uint32_t _Heading__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__Heading(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__Heading(
    full_bounded, 0);
}
