...
#include "carma_v2x_msgs/msg/detail/rtcm_package__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/rtcm_header__functions.h"  // rtcm_header
...
using _RTCMPackage__ros_msg_type = carma_v2x_msgs__msg__RTCMPackage;
  ...
  // Field name: rtcm_header
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, RTCMHeader
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__RTCMHeader(
...
static uint32_t _RTCMPackage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__RTCMPackage(
  ...
  size_t current_alignment)
{
  ...
  // member: rtcm_header
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__RTCMHeader(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__RTCMPackage(
    full_bounded, 0);
}
