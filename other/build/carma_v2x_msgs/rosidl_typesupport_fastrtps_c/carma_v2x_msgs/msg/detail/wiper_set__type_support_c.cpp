...
#include "carma_v2x_msgs/msg/detail/wiper_set__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/wiper_rate__functions.h"  // rate_front, rate_rear
...
using _WiperSet__ros_msg_type = carma_v2x_msgs__msg__WiperSet;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: rate_front
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, WiperRate
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__WiperRate(
...
static uint32_t _WiperSet__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__WiperSet(
  ...
  size_t current_alignment)
{
  ...
  // member: rate_front
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__WiperRate(
        full_bounded, current_alignment);
    }
  }
  // member: status_rear
...
{
  return max_serialized_size_carma_v2x_msgs__msg__WiperSet(
    full_bounded, 0);
}
