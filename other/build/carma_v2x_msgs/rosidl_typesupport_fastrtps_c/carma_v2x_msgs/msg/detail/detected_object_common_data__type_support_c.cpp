...
#include "carma_v2x_msgs/msg/detail/detected_object_common_data__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/acceleration_set4_way__functions.h"  // accel_4_way
#include "carma_v2x_msgs/msg/detail/heading__functions.h"  // heading
#include "carma_v2x_msgs/msg/detail/measurement_time_offset__functions.h"  // measurement_time
#include "carma_v2x_msgs/msg/detail/position_offset_xyz__functions.h"  // pos
#include "carma_v2x_msgs/msg/detail/speed__functions.h"  // speed, speed_z
...
size_t get_serialized_size_carma_v2x_msgs__msg__PositionOffsetXYZ(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__PositionOffsetXYZ(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, PositionOffsetXYZ)();
...
using _DetectedObjectCommonData__ros_msg_type = carma_v2x_msgs__msg__DetectedObjectCommonData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: measurement_time
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, MeasurementTimeOffset
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: pos
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, PositionOffsetXYZ
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->pos, cdr))
    {
...
size_t get_serialized_size_carma_v2x_msgs__msg__DetectedObjectCommonData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DetectedObjectCommonData__ros_msg_type * ros_message = static_cast<const _DetectedObjectCommonData__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__MeasurementTimeOffset(
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__PositionOffsetXYZ(
...
static uint32_t _DetectedObjectCommonData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__DetectedObjectCommonData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carma_v2x_msgs
size_t max_serialized_size_carma_v2x_msgs__msg__DetectedObjectCommonData(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: measurement_time
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__MeasurementTimeOffset(
        full_bounded, current_alignment);
    }
  }
  ...
  // member: pos
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__PositionOffsetXYZ(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__DetectedObjectCommonData(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, DetectedObjectCommonData)() {
