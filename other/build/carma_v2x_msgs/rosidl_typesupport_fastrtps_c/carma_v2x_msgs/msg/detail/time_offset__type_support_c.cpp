...
#include "carma_v2x_msgs/msg/detail/time_offset__rosidl_typesupport_fastrtps_c.h"
...
using _TimeOffset__ros_msg_type = carma_v2x_msgs__msg__TimeOffset;
...
static uint32_t _TimeOffset__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__TimeOffset(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__TimeOffset(
    full_bounded, 0);
}
