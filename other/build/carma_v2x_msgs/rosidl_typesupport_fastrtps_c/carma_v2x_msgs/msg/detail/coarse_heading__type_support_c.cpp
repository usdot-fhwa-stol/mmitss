...
#include "carma_v2x_msgs/msg/detail/coarse_heading__rosidl_typesupport_fastrtps_c.h"
...
using _CoarseHeading__ros_msg_type = carma_v2x_msgs__msg__CoarseHeading;
...
static uint32_t _CoarseHeading__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__CoarseHeading(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__CoarseHeading(
    full_bounded, 0);
}
