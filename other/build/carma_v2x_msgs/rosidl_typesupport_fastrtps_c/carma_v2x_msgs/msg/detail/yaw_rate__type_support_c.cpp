...
#include "carma_v2x_msgs/msg/detail/yaw_rate__rosidl_typesupport_fastrtps_c.h"
...
using _YawRate__ros_msg_type = carma_v2x_msgs__msg__YawRate;
...
size_t get_serialized_size_carma_v2x_msgs__msg__YawRate(
  const void * untyped_ros_message,
...
static uint32_t _YawRate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__YawRate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carma_v2x_msgs
size_t max_serialized_size_carma_v2x_msgs__msg__YawRate(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_carma_v2x_msgs__msg__YawRate(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, YawRate)() {
