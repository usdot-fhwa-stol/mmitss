...
#include "carma_v2x_msgs/msg/detail/obstacle_distance__rosidl_typesupport_fastrtps_c.h"
...
using _ObstacleDistance__ros_msg_type = carma_v2x_msgs__msg__ObstacleDistance;
...
static uint32_t _ObstacleDistance__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__ObstacleDistance(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__ObstacleDistance(
    full_bounded, 0);
}
