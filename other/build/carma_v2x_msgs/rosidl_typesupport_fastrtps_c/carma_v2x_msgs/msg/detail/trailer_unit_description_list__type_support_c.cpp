...
#include "carma_v2x_msgs/msg/detail/trailer_unit_description_list__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/trailer_unit_description__functions.h"  // trailer_unit_descriptions
...
using _TrailerUnitDescriptionList__ros_msg_type = carma_v2x_msgs__msg__TrailerUnitDescriptionList;
  ...
  // Field name: trailer_unit_descriptions
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, TrailerUnitDescription
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: trailer_unit_descriptions
  {
    ...
    if (ros_message->trailer_unit_descriptions.data) {
      carma_v2x_msgs__msg__TrailerUnitDescription__Sequence__fini(&ros_message->trailer_unit_descriptions);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name trailer_unit_descriptions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_carma_v2x_msgs__msg__TrailerUnitDescription(
...
static uint32_t _TrailerUnitDescriptionList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__TrailerUnitDescriptionList(
  ...
  size_t current_alignment)
{
  ...
  // member: trailer_unit_descriptions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__TrailerUnitDescription(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__TrailerUnitDescriptionList(
    full_bounded, 0);
}
