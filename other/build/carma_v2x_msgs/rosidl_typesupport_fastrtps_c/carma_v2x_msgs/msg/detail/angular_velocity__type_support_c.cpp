...
#include "carma_v2x_msgs/msg/detail/angular_velocity__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/pitch_rate__functions.h"  // pitch_rate
#include "carma_v2x_msgs/msg/detail/roll_rate__functions.h"  // roll_rate

// forward declare type support functions
size_t get_serialized_size_carma_v2x_msgs__msg__PitchRate(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__PitchRate(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, PitchRate)();
...
using _AngularVelocity__ros_msg_type = carma_v2x_msgs__msg__AngularVelocity;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pitch_rate
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, PitchRate
      )()->data);
  ...
  // Field name: roll_rate
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, RollRate
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__PitchRate(
    &(ros_message->pitch_rate), current_alignment);
  // field.name roll_rate

  current_alignment += get_serialized_size_carma_v2x_msgs__msg__RollRate(
...
static uint32_t _AngularVelocity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__AngularVelocity(
  ...
  size_t current_alignment)
{
  ...
  // member: pitch_rate
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__PitchRate(
  ...
  // member: roll_rate
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__RollRate(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__AngularVelocity(
    full_bounded, 0);
}
