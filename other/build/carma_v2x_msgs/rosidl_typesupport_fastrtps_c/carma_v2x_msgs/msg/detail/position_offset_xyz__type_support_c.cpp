...
#include "carma_v2x_msgs/msg/detail/position_offset_xyz__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/object_distance__functions.h"  // offset_x, offset_y, offset_z
...
using _PositionOffsetXYZ__ros_msg_type = carma_v2x_msgs__msg__PositionOffsetXYZ;
  ...
  // Field name: offset_x
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, ObjectDistance
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__ObjectDistance(
...
static uint32_t _PositionOffsetXYZ__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__PositionOffsetXYZ(
  ...
  size_t current_alignment)
{
  ...
  // member: offset_x
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__ObjectDistance(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__PositionOffsetXYZ(
    full_bounded, 0);
}
