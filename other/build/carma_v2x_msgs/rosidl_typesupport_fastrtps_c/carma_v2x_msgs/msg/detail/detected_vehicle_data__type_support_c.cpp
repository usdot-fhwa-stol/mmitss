...
#include "carma_v2x_msgs/msg/detail/detected_vehicle_data__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/angular_velocity__functions.h"  // veh_ang_vel
#include "carma_v2x_msgs/msg/detail/attitude__functions.h"  // veh_attitude
#include "carma_v2x_msgs/msg/detail/vehicle_height__functions.h"  // height
#include "carma_v2x_msgs/msg/detail/vehicle_size__functions.h"  // size
...
size_t get_serialized_size_carma_v2x_msgs__msg__AngularVelocity(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__AngularVelocity(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, AngularVelocity)();
size_t get_serialized_size_carma_v2x_msgs__msg__Attitude(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__Attitude(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, Attitude)();
...
size_t get_serialized_size_carma_v2x_msgs__msg__VehicleSize(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__VehicleSize(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, VehicleSize)();
...
using _DetectedVehicleData__ros_msg_type = carma_v2x_msgs__msg__DetectedVehicleData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: veh_attitude
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, Attitude
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: veh_ang_vel
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, AngularVelocity
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: size
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, VehicleSize
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__Attitude(
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__AngularVelocity(
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__VehicleSize(
...
static uint32_t _DetectedVehicleData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__DetectedVehicleData(
  ...
  size_t current_alignment)
{
  ...
  // member: veh_attitude
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__Attitude(
        full_bounded, current_alignment);
    }
  }
  ...
  // member: veh_ang_vel
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__AngularVelocity(
        full_bounded, current_alignment);
    }
  }
  ...
  // member: size
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__VehicleSize(
        full_bounded, current_alignment);
    }
  }
  // member: height
...
{
  return max_serialized_size_carma_v2x_msgs__msg__DetectedVehicleData(
    full_bounded, 0);
}
