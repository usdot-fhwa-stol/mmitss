...
#include "carma_v2x_msgs/msg/detail/bsm_core_data__rosidl_typesupport_fastrtps_c.h"
...
using _BSMCoreData__ros_msg_type = carma_v2x_msgs__msg__BSMCoreData;
...
static uint32_t _BSMCoreData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__BSMCoreData(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__BSMCoreData(
    full_bounded, 0);
}
