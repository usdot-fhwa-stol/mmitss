...
#include "carma_v2x_msgs/msg/detail/regulatory_speed_limit__rosidl_typesupport_fastrtps_c.h"
...
using _RegulatorySpeedLimit__ros_msg_type = carma_v2x_msgs__msg__RegulatorySpeedLimit;
...
static uint32_t _RegulatorySpeedLimit__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__RegulatorySpeedLimit(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__RegulatorySpeedLimit(
    full_bounded, 0);
}
