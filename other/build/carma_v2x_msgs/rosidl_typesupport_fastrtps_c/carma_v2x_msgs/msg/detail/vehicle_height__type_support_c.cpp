...
#include "carma_v2x_msgs/msg/detail/vehicle_height__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleHeight__ros_msg_type = carma_v2x_msgs__msg__VehicleHeight;
...
static uint32_t _VehicleHeight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__VehicleHeight(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__VehicleHeight(
    full_bounded, 0);
}
