...
#include "carma_v2x_msgs/msg/detail/attachment_radius__rosidl_typesupport_fastrtps_c.h"
...
using _AttachmentRadius__ros_msg_type = carma_v2x_msgs__msg__AttachmentRadius;
...
static uint32_t _AttachmentRadius__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__AttachmentRadius(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__AttachmentRadius(
    full_bounded, 0);
}
