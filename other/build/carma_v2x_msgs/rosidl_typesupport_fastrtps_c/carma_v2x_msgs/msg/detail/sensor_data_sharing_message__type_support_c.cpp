...
#include "carma_v2x_msgs/msg/detail/sensor_data_sharing_message__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/detected_object_list__functions.h"  // objects
#include "carma_v2x_msgs/msg/detail/position3_d__functions.h"  // ref_pos
#include "carma_v2x_msgs/msg/detail/positional_accuracy__functions.h"  // ref_pos_xy_conf
...
size_t get_serialized_size_carma_v2x_msgs__msg__DetectedObjectList(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__DetectedObjectList(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, DetectedObjectList)();
...
using _SensorDataSharingMessage__ros_msg_type = carma_v2x_msgs__msg__SensorDataSharingMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, DetectedObjectList
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_carma_v2x_msgs__msg__SensorDataSharingMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SensorDataSharingMessage__ros_msg_type * ros_message = static_cast<const _SensorDataSharingMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__DetectedObjectList(
...
static uint32_t _SensorDataSharingMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__SensorDataSharingMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carma_v2x_msgs
size_t max_serialized_size_carma_v2x_msgs__msg__SensorDataSharingMessage(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__DetectedObjectList(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__SensorDataSharingMessage(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, SensorDataSharingMessage)() {
