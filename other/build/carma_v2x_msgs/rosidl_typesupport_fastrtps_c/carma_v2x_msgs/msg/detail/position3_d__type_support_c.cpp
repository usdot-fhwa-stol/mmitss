...
#include "carma_v2x_msgs/msg/detail/position3_d__rosidl_typesupport_fastrtps_c.h"
...
using _Position3D__ros_msg_type = carma_v2x_msgs__msg__Position3D;
...
static uint32_t _Position3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__Position3D(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__Position3D(
    full_bounded, 0);
}
