...
#include "carma_v2x_msgs/msg/detail/offset_b10__rosidl_typesupport_fastrtps_c.h"
...
using _OffsetB10__ros_msg_type = carma_v2x_msgs__msg__OffsetB10;
...
static uint32_t _OffsetB10__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__OffsetB10(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__OffsetB10(
    full_bounded, 0);
}
