...
#include "carma_v2x_msgs/msg/detail/path_prediction__rosidl_typesupport_fastrtps_c.h"
...
using _PathPrediction__ros_msg_type = carma_v2x_msgs__msg__PathPrediction;
...
static uint32_t _PathPrediction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__PathPrediction(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__PathPrediction(
    full_bounded, 0);
}
