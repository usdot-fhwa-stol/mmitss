...
#include "carma_v2x_msgs/msg/detail/speed_limit_type__rosidl_typesupport_fastrtps_c.h"
...
using _SpeedLimitType__ros_msg_type = carma_v2x_msgs__msg__SpeedLimitType;
...
size_t get_serialized_size_carma_v2x_msgs__msg__SpeedLimitType(
  const void * untyped_ros_message,
...
static uint32_t _SpeedLimitType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__SpeedLimitType(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carma_v2x_msgs
size_t max_serialized_size_carma_v2x_msgs__msg__SpeedLimitType(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_carma_v2x_msgs__msg__SpeedLimitType(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, SpeedLimitType)() {
