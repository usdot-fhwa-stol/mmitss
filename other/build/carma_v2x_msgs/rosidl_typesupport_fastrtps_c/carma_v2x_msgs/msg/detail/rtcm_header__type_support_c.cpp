...
#include "carma_v2x_msgs/msg/detail/rtcm_header__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/offset_b09__functions.h"  // ant_offset_y
#include "carma_v2x_msgs/msg/detail/offset_b10__functions.h"  // ant_offset_z
#include "carma_v2x_msgs/msg/detail/offset_b12__functions.h"  // ant_offset_x
#include "j2735_v2x_msgs/msg/detail/gnss_status__functions.h"  // status

// forward declare type support functions
size_t get_serialized_size_carma_v2x_msgs__msg__OffsetB09(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__OffsetB09(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, OffsetB09)();
size_t get_serialized_size_carma_v2x_msgs__msg__OffsetB10(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_carma_v2x_msgs__msg__OffsetB10(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, OffsetB10)();
...
using _RTCMHeader__ros_msg_type = carma_v2x_msgs__msg__RTCMHeader;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ant_offset_y
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, OffsetB09
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: ant_offset_z
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, OffsetB10
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_carma_v2x_msgs__msg__RTCMHeader(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RTCMHeader__ros_msg_type * ros_message = static_cast<const _RTCMHeader__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__OffsetB09(
    &(ros_message->ant_offset_y), current_alignment);
  // field.name ant_offset_z

  current_alignment += get_serialized_size_carma_v2x_msgs__msg__OffsetB10(
...
static uint32_t _RTCMHeader__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__RTCMHeader(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carma_v2x_msgs
size_t max_serialized_size_carma_v2x_msgs__msg__RTCMHeader(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: ant_offset_y
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__OffsetB09(
        full_bounded, current_alignment);
    }
  }
  // member: ant_offset_z
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__OffsetB10(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__RTCMHeader(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, RTCMHeader)() {
