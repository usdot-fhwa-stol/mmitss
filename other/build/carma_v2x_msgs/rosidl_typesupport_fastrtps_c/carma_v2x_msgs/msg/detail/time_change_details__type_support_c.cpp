...
#include "carma_v2x_msgs/msg/detail/time_change_details__rosidl_typesupport_fastrtps_c.h"
...
using _TimeChangeDetails__ros_msg_type = carma_v2x_msgs__msg__TimeChangeDetails;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: max_end_time_exists
  {
...
static uint32_t _TimeChangeDetails__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__TimeChangeDetails(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__TimeChangeDetails(
    full_bounded, 0);
}
