...
#include "carma_v2x_msgs/msg/detail/traffic_control_message_v01__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // updated
#include "carma_v2x_msgs/msg/detail/traffic_control_geometry__functions.h"  // geometry
#include "carma_v2x_msgs/msg/detail/traffic_control_params__functions.h"  // params
...
using _TrafficControlMessageV01__ros_msg_type = carma_v2x_msgs__msg__TrafficControlMessageV01;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: params
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, TrafficControlParams
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: geometry
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, TrafficControlGeometry
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_builtin_interfaces__msg__Time(
    &(ros_message->updated), current_alignment);
  // field.name package
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__TrafficControlParams(
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__TrafficControlGeometry(
...
static uint32_t _TrafficControlMessageV01__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__TrafficControlMessageV01(
  ...
  size_t current_alignment)
{
  ...
  // member: params
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__TrafficControlParams(
        full_bounded, current_alignment);
    }
  }
  ...
  // member: geometry
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__TrafficControlGeometry(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__TrafficControlMessageV01(
    full_bounded, 0);
}
