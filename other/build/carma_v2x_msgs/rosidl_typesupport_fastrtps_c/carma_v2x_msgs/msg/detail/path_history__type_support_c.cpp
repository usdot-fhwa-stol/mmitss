...
#include "carma_v2x_msgs/msg/detail/path_history__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/full_position_vector__functions.h"  // initial_position
#include "carma_v2x_msgs/msg/detail/path_history_point_list__functions.h"  // crumb_data
...
using _PathHistory__ros_msg_type = carma_v2x_msgs__msg__PathHistory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: crumb_data
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, PathHistoryPointList
      )()->data);
  ...
  // Field name: initial_position
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, FullPositionVector
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__PathHistoryPointList(
    &(ros_message->crumb_data), current_alignment);
  // field.name initial_position

  current_alignment += get_serialized_size_carma_v2x_msgs__msg__FullPositionVector(
...
static uint32_t _PathHistory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__PathHistory(
  ...
  size_t current_alignment)
{
  ...
  // member: crumb_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__PathHistoryPointList(
  ...
  // member: initial_position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__FullPositionVector(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_carma_v2x_msgs__msg__PathHistory(
    full_bounded, 0);
}
