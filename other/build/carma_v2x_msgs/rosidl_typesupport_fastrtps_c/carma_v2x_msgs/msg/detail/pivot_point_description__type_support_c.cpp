...
#include "carma_v2x_msgs/msg/detail/pivot_point_description__rosidl_typesupport_fastrtps_c.h"
...
#include "carma_v2x_msgs/msg/detail/offset_b11__functions.h"  // pivot_offset
...
using _PivotPointDescription__ros_msg_type = carma_v2x_msgs__msg__PivotPointDescription;
  ...
  // Field name: pivot_offset
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, OffsetB11
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_carma_v2x_msgs__msg__OffsetB11(
...
static uint32_t _PivotPointDescription__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__PivotPointDescription(
  ...
  size_t current_alignment)
{
  ...
  // member: pivot_offset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_carma_v2x_msgs__msg__OffsetB11(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__PivotPointDescription(
    full_bounded, 0);
}
