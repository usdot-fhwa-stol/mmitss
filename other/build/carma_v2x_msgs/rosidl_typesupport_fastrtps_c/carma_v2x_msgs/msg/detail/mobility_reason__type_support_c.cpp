...
#include "carma_v2x_msgs/msg/detail/mobility_reason__rosidl_typesupport_fastrtps_c.h"
...
using _MobilityReason__ros_msg_type = carma_v2x_msgs__msg__MobilityReason;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MobilityReason__ros_msg_type * ros_message = static_cast<const _MobilityReason__ros_msg_type *>(untyped_ros_message);
  // Field name: reason
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MobilityReason__ros_msg_type * ros_message = static_cast<_MobilityReason__ros_msg_type *>(untyped_ros_message);
  // Field name: reason
  {
    cdr >> ros_message->reason;
  }
...
static uint32_t _MobilityReason__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_v2x_msgs__msg__MobilityReason(
...
{
  return max_serialized_size_carma_v2x_msgs__msg__MobilityReason(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MobilityReason = {
  "carma_v2x_msgs::msg",
  "MobilityReason",
...
static rosidl_message_type_support_t _MobilityReason__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MobilityReason,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, MobilityReason)() {
  return &_MobilityReason__type_support;
}
