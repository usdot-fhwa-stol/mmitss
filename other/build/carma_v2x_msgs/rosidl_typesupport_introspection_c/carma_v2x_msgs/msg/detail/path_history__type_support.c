  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__PathHistory__init(message_memory);
}

void PathHistory__rosidl_typesupport_introspection_c__PathHistory_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__PathHistory__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember PathHistory__rosidl_typesupport_introspection_c__PathHistory_message_member_array[4] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__PathHistory, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__PathHistory, crumb_data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__PathHistory, initial_position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__PathHistory, curr_gnss_status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PathHistory__rosidl_typesupport_introspection_c__PathHistory_message_members = {
  ...
  4,  // number of fields
  sizeof(carma_v2x_msgs__msg__PathHistory),
