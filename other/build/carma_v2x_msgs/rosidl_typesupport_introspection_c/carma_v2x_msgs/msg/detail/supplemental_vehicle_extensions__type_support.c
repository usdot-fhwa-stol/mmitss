...
// Member `vehicle_data`
#include "carma_v2x_msgs/msg/vehicle_data.h"
// Member `vehicle_data`
#include "carma_v2x_msgs/msg/detail/vehicle_data__rosidl_typesupport_introspection_c.h"
// Member `weather_report`
#include "carma_v2x_msgs/msg/weather_report.h"
// Member `weather_report`
#include "carma_v2x_msgs/msg/detail/weather_report__rosidl_typesupport_introspection_c.h"
// Member `weather_probe`
#include "carma_v2x_msgs/msg/weather_probe.h"
// Member `weather_probe`
#include "carma_v2x_msgs/msg/detail/weather_probe__rosidl_typesupport_introspection_c.h"
// Member `obstacle`
#include "carma_v2x_msgs/msg/obstacle_detection.h"
// Member `obstacle`
#include "carma_v2x_msgs/msg/detail/obstacle_detection__rosidl_typesupport_introspection_c.h"
// Member `status`
...
#include "carma_v2x_msgs/msg/gross_speed.h"
// Member `speed_profile`
#include "carma_v2x_msgs/msg/detail/gross_speed__rosidl_typesupport_introspection_c.h"
// Member `the_rtcm`
#include "carma_v2x_msgs/msg/rtcm_package.h"
// Member `the_rtcm`
#include "carma_v2x_msgs/msg/detail/rtcm_package__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__SupplementalVehicleExtensions__init(message_memory);
}
...
{
  carma_v2x_msgs__msg__SupplementalVehicleExtensions__fini(message_memory);
}

size_t SupplementalVehicleExtensions__rosidl_typesupport_introspection_c__size_function__GrossSpeed__speed_profile(
  const void * untyped_member)
{
  const carma_v2x_msgs__msg__GrossSpeed__Sequence * member =
    (const carma_v2x_msgs__msg__GrossSpeed__Sequence *)(untyped_member);
  return member->size;
}
...
{
  carma_v2x_msgs__msg__GrossSpeed__Sequence * member =
    (carma_v2x_msgs__msg__GrossSpeed__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  carma_v2x_msgs__msg__GrossSpeed__Sequence * member =
    (carma_v2x_msgs__msg__GrossSpeed__Sequence *)(untyped_member);
  carma_v2x_msgs__msg__GrossSpeed__Sequence__fini(member);
  return carma_v2x_msgs__msg__GrossSpeed__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember SupplementalVehicleExtensions__rosidl_typesupport_introspection_c__SupplementalVehicleExtensions_message_member_array[10] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, classification),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, class_details),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, vehicle_data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, weather_report),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, weather_probe),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, obstacle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, speed_profile),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__SupplementalVehicleExtensions, the_rtcm),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SupplementalVehicleExtensions__rosidl_typesupport_introspection_c__SupplementalVehicleExtensions_message_members = {
  ...
  10,  // number of fields
  sizeof(carma_v2x_msgs__msg__SupplementalVehicleExtensions),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, SupplementalVehicleExtensions)() {
  ...
  SupplementalVehicleExtensions__rosidl_typesupport_introspection_c__SupplementalVehicleExtensions_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, VehicleData)();
  SupplementalVehicleExtensions__rosidl_typesupport_introspection_c__SupplementalVehicleExtensions_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, WeatherReport)();
  ...
  SupplementalVehicleExtensions__rosidl_typesupport_introspection_c__SupplementalVehicleExtensions_message_member_array[6].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, ObstacleDetection)();
  ...
  SupplementalVehicleExtensions__rosidl_typesupport_introspection_c__SupplementalVehicleExtensions_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, GrossSpeed)();
  SupplementalVehicleExtensions__rosidl_typesupport_introspection_c__SupplementalVehicleExtensions_message_member_array[9].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, RTCMPackage)();
