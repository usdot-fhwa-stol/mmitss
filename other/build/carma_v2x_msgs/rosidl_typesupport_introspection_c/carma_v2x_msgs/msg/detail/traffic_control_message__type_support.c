...
#include <stddef.h>
#include "carma_v2x_msgs/msg/detail/traffic_control_message__rosidl_typesupport_introspection_c.h"
...
// Member `tcm_v01`
#include "carma_v2x_msgs/msg/traffic_control_message_v01.h"
// Member `tcm_v01`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__TrafficControlMessage__init(message_memory);
}

void TrafficControlMessage__rosidl_typesupport_introspection_c__TrafficControlMessage_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__TrafficControlMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrafficControlMessage__rosidl_typesupport_introspection_c__TrafficControlMessage_message_member_array[2] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__TrafficControlMessage, choice),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlMessage, tcm_v01),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrafficControlMessage__rosidl_typesupport_introspection_c__TrafficControlMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(carma_v2x_msgs__msg__TrafficControlMessage),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, TrafficControlMessage)() {
