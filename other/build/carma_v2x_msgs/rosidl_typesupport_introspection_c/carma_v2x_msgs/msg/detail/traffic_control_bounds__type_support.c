...
// Member `offsets`
#include "carma_v2x_msgs/msg/offset_point.h"
// Member `offsets`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__TrafficControlBounds__init(message_memory);
}

void TrafficControlBounds__rosidl_typesupport_introspection_c__TrafficControlBounds_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__TrafficControlBounds__fini(message_memory);
}
...
{
  const carma_v2x_msgs__msg__OffsetPoint ** member =
    (const carma_v2x_msgs__msg__OffsetPoint **)(untyped_member);
  return &(*member)[index];
}
...
{
  carma_v2x_msgs__msg__OffsetPoint ** member =
    (carma_v2x_msgs__msg__OffsetPoint **)(untyped_member);
  return &(*member)[index];
}
...
static rosidl_typesupport_introspection_c__MessageMember TrafficControlBounds__rosidl_typesupport_introspection_c__TrafficControlBounds_message_member_array[4] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__TrafficControlBounds, oldest),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlBounds, reflon),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlBounds, reflat),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlBounds, offsets),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers TrafficControlBounds__rosidl_typesupport_introspection_c__TrafficControlBounds_message_members = {
  ...
  4,  // number of fields
  sizeof(carma_v2x_msgs__msg__TrafficControlBounds),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, TrafficControlBounds)() {
  TrafficControlBounds__rosidl_typesupport_introspection_c__TrafficControlBounds_message_member_array[0].members_ =
