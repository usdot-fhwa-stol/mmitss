  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__ObstacleDistance__init(message_memory);
}

void ObstacleDistance__rosidl_typesupport_introspection_c__ObstacleDistance_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__ObstacleDistance__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ObstacleDistance__rosidl_typesupport_introspection_c__ObstacleDistance_message_member_array[1] = {
  {
    "distance",  // name
    ...
    offsetof(carma_v2x_msgs__msg__ObstacleDistance, distance),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers ObstacleDistance__rosidl_typesupport_introspection_c__ObstacleDistance_message_members = {
  ...
  1,  // number of fields
  sizeof(carma_v2x_msgs__msg__ObstacleDistance),
