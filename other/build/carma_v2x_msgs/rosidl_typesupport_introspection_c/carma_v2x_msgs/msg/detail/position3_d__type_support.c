  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__Position3D__init(message_memory);
}

void Position3D__rosidl_typesupport_introspection_c__Position3D_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__Position3D__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Position3D__rosidl_typesupport_introspection_c__Position3D_message_member_array[4] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__Position3D, latitude),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__Position3D, longitude),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__Position3D, elevation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__Position3D, elevation_exists),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Position3D__rosidl_typesupport_introspection_c__Position3D_message_members = {
  ...
  4,  // number of fields
  sizeof(carma_v2x_msgs__msg__Position3D),
