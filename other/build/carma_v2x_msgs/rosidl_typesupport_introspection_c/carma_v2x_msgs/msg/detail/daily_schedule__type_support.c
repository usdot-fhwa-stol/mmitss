  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__DailySchedule__init(message_memory);
}

void DailySchedule__rosidl_typesupport_introspection_c__DailySchedule_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__DailySchedule__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember DailySchedule__rosidl_typesupport_introspection_c__DailySchedule_message_member_array[2] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__DailySchedule, begin),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__DailySchedule, duration),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DailySchedule__rosidl_typesupport_introspection_c__DailySchedule_message_members = {
  ...
  2,  // number of fields
  sizeof(carma_v2x_msgs__msg__DailySchedule),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, DailySchedule)() {
  DailySchedule__rosidl_typesupport_introspection_c__DailySchedule_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Duration)();
  DailySchedule__rosidl_typesupport_introspection_c__DailySchedule_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Duration)();
