...
// Member `rtcm_header`
#include "carma_v2x_msgs/msg/rtcm_header.h"
// Member `rtcm_header`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__RTCMPackage__init(message_memory);
}

void RTCMPackage__rosidl_typesupport_introspection_c__RTCMPackage_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__RTCMPackage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RTCMPackage__rosidl_typesupport_introspection_c__RTCMPackage_message_member_array[3] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__RTCMPackage, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__RTCMPackage, rtcm_header),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__RTCMPackage, messages),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RTCMPackage__rosidl_typesupport_introspection_c__RTCMPackage_message_members = {
  ...
  3,  // number of fields
  sizeof(carma_v2x_msgs__msg__RTCMPackage),
