  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__BSMRegionalExtension__init(message_memory);
}

void BSMRegionalExtension__rosidl_typesupport_introspection_c__BSMRegionalExtension_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__BSMRegionalExtension__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember BSMRegionalExtension__rosidl_typesupport_introspection_c__BSMRegionalExtension_message_member_array[2] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__BSMRegionalExtension, regional_extension_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__BSMRegionalExtension, route_destination_points),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers BSMRegionalExtension__rosidl_typesupport_introspection_c__BSMRegionalExtension_message_members = {
  ...
  2,  // number of fields
  sizeof(carma_v2x_msgs__msg__BSMRegionalExtension),
