...
// Member `schedule`
#include "carma_v2x_msgs/msg/traffic_control_schedule.h"
// Member `schedule`
#include "carma_v2x_msgs/msg/detail/traffic_control_schedule__rosidl_typesupport_introspection_c.h"
// Member `detail`
#include "carma_v2x_msgs/msg/traffic_control_detail.h"
// Member `detail`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__TrafficControlParams__init(message_memory);
}

void TrafficControlParams__rosidl_typesupport_introspection_c__TrafficControlParams_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__TrafficControlParams__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrafficControlParams__rosidl_typesupport_introspection_c__TrafficControlParams_message_member_array[4] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__TrafficControlParams, vclasses),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlParams, schedule),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlParams, regulatory),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlParams, detail),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrafficControlParams__rosidl_typesupport_introspection_c__TrafficControlParams_message_members = {
  ...
  4,  // number of fields
  sizeof(carma_v2x_msgs__msg__TrafficControlParams),
