  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__VehicleData__init(message_memory);
}

void VehicleData__rosidl_typesupport_introspection_c__VehicleData_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__VehicleData__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember VehicleData__rosidl_typesupport_introspection_c__VehicleData_message_member_array[5] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__VehicleData, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__VehicleData, height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__VehicleData, bumpers),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__VehicleData, mass),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__VehicleData, trailer_weight),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleData__rosidl_typesupport_introspection_c__VehicleData_message_members = {
  ...
  5,  // number of fields
  sizeof(carma_v2x_msgs__msg__VehicleData),
