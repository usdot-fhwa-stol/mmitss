...
static const _BSMPartIIExtension_type_support_symbol_names_t _BSMPartIIExtension_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_v2x_msgs, msg, BSMPartIIExtension)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, BSMPartIIExtension)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_v2x_msgs, msg, BSMPartIIExtension)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_c::BSMPartIIExtension_message_type_support_handle;
}
