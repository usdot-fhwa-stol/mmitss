...
{
  new (message_memory) carma_v2x_msgs::msg::Speed(_init);
}

void Speed_fini_function(void * message_memory)
{
  auto typed_message = static_cast<carma_v2x_msgs::msg::Speed *>(message_memory);
  typed_message->~Speed();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Speed_message_member_array[2] = {
  {
    ...
    offsetof(carma_v2x_msgs::msg::Speed, speed),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::Speed, unavailable),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Speed_message_members = {
  ...
  "Speed",  // message name
  2,  // number of fields
  sizeof(carma_v2x_msgs::msg::Speed),
...
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Speed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, Speed)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Speed_message_type_support_handle;
}
