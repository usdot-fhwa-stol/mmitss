...
{
  new (message_memory) carma_v2x_msgs::msg::Angle(_init);
}

void Angle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<carma_v2x_msgs::msg::Angle *>(message_memory);
  typed_message->~Angle();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Angle_message_member_array[2] = {
  {
    ...
    offsetof(carma_v2x_msgs::msg::Angle, angle),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::Angle, unavailable),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Angle_message_members = {
  ...
  "Angle",  // message name
  2,  // number of fields
  sizeof(carma_v2x_msgs::msg::Angle),
...
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Angle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, Angle)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::Angle_message_type_support_handle;
}
