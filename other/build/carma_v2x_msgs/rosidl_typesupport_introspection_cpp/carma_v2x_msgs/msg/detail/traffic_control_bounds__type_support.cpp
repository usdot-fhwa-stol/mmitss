...
{
  new (message_memory) carma_v2x_msgs::msg::TrafficControlBounds(_init);
}

void TrafficControlBounds_fini_function(void * message_memory)
{
  auto typed_message = static_cast<carma_v2x_msgs::msg::TrafficControlBounds *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<carma_v2x_msgs::msg::OffsetPoint, 3> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<carma_v2x_msgs::msg::OffsetPoint, 3> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrafficControlBounds_message_member_array[4] = {
  {
    ...
    offsetof(carma_v2x_msgs::msg::TrafficControlBounds, oldest),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::TrafficControlBounds, reflon),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::TrafficControlBounds, reflat),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<carma_v2x_msgs::msg::OffsetPoint>(),  // members of sub message
    true,  // is array
    3,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::TrafficControlBounds, offsets),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrafficControlBounds_message_members = {
  ...
  4,  // number of fields
  sizeof(carma_v2x_msgs::msg::TrafficControlBounds),
...
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficControlBounds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, TrafficControlBounds)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficControlBounds_message_type_support_handle;
}
