...
{
  new (message_memory) carma_v2x_msgs::msg::TrailerWeight(_init);
}

void TrailerWeight_fini_function(void * message_memory)
{
  auto typed_message = static_cast<carma_v2x_msgs::msg::TrailerWeight *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrailerWeight_message_member_array[1] = {
  {
    ...
    offsetof(carma_v2x_msgs::msg::TrailerWeight, trailer_weight),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrailerWeight_message_members = {
  ...
  1,  // number of fields
  sizeof(carma_v2x_msgs::msg::TrailerWeight),
...
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::TrailerWeight_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, TrailerWeight)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::TrailerWeight_message_type_support_handle;
}
