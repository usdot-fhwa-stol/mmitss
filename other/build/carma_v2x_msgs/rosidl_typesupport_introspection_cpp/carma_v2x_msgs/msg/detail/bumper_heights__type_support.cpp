...
{
  new (message_memory) carma_v2x_msgs::msg::BumperHeights(_init);
}

void BumperHeights_fini_function(void * message_memory)
{
  auto typed_message = static_cast<carma_v2x_msgs::msg::BumperHeights *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BumperHeights_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<carma_v2x_msgs::msg::BumperHeight>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::BumperHeights, front),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::BumperHeights, rear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BumperHeights_message_members = {
  ...
  2,  // number of fields
  sizeof(carma_v2x_msgs::msg::BumperHeights),
...
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::BumperHeights_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, BumperHeights)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::BumperHeights_message_type_support_handle;
}
