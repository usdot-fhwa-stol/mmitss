...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_VEHICLE_DATA__FUNCTIONS_H_
#define CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_VEHICLE_DATA__FUNCTIONS_H_
...
/// Initialize msg/DetectedVehicleData message.
/**
...
/// Finalize msg/DetectedVehicleData message.
/**
...
/// Create msg/DetectedVehicleData message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * carma_v2x_msgs__msg__DetectedVehicleData__init().
...
/// Destroy msg/DetectedVehicleData message.
/**
 * It calls
 * carma_v2x_msgs__msg__DetectedVehicleData__fini()
...
/// Check for msg/DetectedVehicleData message equality.
/**
...
/// Copy a msg/DetectedVehicleData message.
/**
...
/// Initialize array of msg/DetectedVehicleData messages.
/**
...
/// Finalize array of msg/DetectedVehicleData messages.
/**
 * It calls
 * carma_v2x_msgs__msg__DetectedVehicleData__fini()
...
/// Create array of msg/DetectedVehicleData messages.
/**
 * It allocates the memory for the array and calls
 * carma_v2x_msgs__msg__DetectedVehicleData__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of msg/DetectedVehicleData messages.
/**
 * It calls
 * carma_v2x_msgs__msg__DetectedVehicleData__Sequence__fini()
 * on the array,
...
/// Check for msg/DetectedVehicleData message array equality.
/**
...
/// Copy an array of msg/DetectedVehicleData messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_VEHICLE_DATA__FUNCTIONS_H_
