...
bool carma_v2x_msgs__msg__wiper_rate__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool carma_v2x_msgs__msg__wiper_set__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._wiper_set.WiperSet", full_classname_dest, 38) == 0);
  }
  carma_v2x_msgs__msg__WiperSet * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // rate_front
    ...
    if (!carma_v2x_msgs__msg__wiper_rate__convert_from_py(field, &ros_message->rate_front)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // rate_rear
    ...
    if (!carma_v2x_msgs__msg__wiper_rate__convert_from_py(field, &ros_message->rate_rear)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__wiper_set__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._wiper_set");
  ...
  {  // rate_front
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__wiper_rate__convert_to_py(&ros_message->rate_front);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // rate_rear
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__wiper_rate__convert_to_py(&ros_message->rate_rear);
    if (!field) {
      return NULL;
    }
    {
