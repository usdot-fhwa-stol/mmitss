...
class Metaclass_BumperHeights(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import BumperHeight
            if BumperHeight.__class__._TYPE_SUPPORT is None:
                BumperHeight.__class__.__import_type_support__()
...
class BumperHeights(metaclass=Metaclass_BumperHeights):
    ...
    _fields_and_field_types = {
        'front': 'carma_v2x_msgs/BumperHeight',
        'rear': 'carma_v2x_msgs/BumperHeight',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'BumperHeight'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'BumperHeight'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from carma_v2x_msgs.msg import BumperHeight
        self.front = kwargs.get('front', BumperHeight())
        from carma_v2x_msgs.msg import BumperHeight
        self.rear = kwargs.get('rear', BumperHeight())
    ...
    def front(self, value):
        if __debug__:
            from carma_v2x_msgs.msg import BumperHeight
            assert \
                isinstance(value, BumperHeight), \
                "The 'front' field must be a sub message of type 'BumperHeight'"
        self._front = value
    ...
    def rear(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, BumperHeight), \
                "The 'rear' field must be a sub message of type 'BumperHeight'"
        self._rear = value
