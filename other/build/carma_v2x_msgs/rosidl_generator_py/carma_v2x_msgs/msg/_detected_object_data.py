...
class DetectedObjectData(metaclass=Metaclass_DetectedObjectData):
    ...
    _fields_and_field_types = {
        'detected_object_common_data': 'carma_v2x_msgs/DetectedObjectCommonData',
        'presence_vector': 'uint8',
        'detected_object_optional_data': 'carma_v2x_msgs/DetectedObjectOptionalData',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'DetectedObjectCommonData'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'DetectedObjectOptionalData'),  # noqa: E501
    )
