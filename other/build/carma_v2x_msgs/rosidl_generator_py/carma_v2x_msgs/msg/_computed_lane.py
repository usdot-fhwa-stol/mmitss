...
class Metaclass_ComputedLane(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import OffsetAxis
            if OffsetAxis.__class__._TYPE_SUPPORT is None:
                OffsetAxis.__class__.__import_type_support__()
...
class ComputedLane(metaclass=Metaclass_ComputedLane):
    ...
    _fields_and_field_types = {
        ...
        'offset_x_axis': 'carma_v2x_msgs/OffsetAxis',
        'offset_y_axis': 'carma_v2x_msgs/OffsetAxis',
        'rotate_xy': 'float',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'OffsetAxis'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'OffsetAxis'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from carma_v2x_msgs.msg import OffsetAxis
        self.offset_x_axis = kwargs.get('offset_x_axis', OffsetAxis())
        from carma_v2x_msgs.msg import OffsetAxis
        self.offset_y_axis = kwargs.get('offset_y_axis', OffsetAxis())
        self.rotate_xy = kwargs.get('rotate_xy', float())
    ...
    def offset_x_axis(self, value):
        if __debug__:
            from carma_v2x_msgs.msg import OffsetAxis
            assert \
                isinstance(value, OffsetAxis), \
                "The 'offset_x_axis' field must be a sub message of type 'OffsetAxis'"
    ...
    def offset_y_axis(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, OffsetAxis), \
                "The 'offset_y_axis' field must be a sub message of type 'OffsetAxis'"
    ...
    def rotate_xy(self, value):
        if __debug__:
            assert \
                ...
                "The 'rotate_xy' field must be of type 'float'"
