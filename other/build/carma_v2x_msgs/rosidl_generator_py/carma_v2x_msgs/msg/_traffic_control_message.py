    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'carma_v2x_msgs.msg.TrafficControlMessage')
            logger.debug(
            ...
            from carma_v2x_msgs.msg import TrafficControlMessageV01
...
class TrafficControlMessage(metaclass=Metaclass_TrafficControlMessage):
    ...
    _fields_and_field_types = {
        'choice': 'uint8',
        'tcm_v01': 'carma_v2x_msgs/TrafficControlMessageV01',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'TrafficControlMessageV01'),  # noqa: E501
    )
