...
bool carma_v2x_msgs__msg__vert_offset_b07__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._vert_offset_b07.VertOffsetB07", full_classname_dest, 49) == 0);
  }
  carma_v2x_msgs__msg__VertOffsetB07 * ros_message = _ros_message;
  {  // offset
...
PyObject * carma_v2x_msgs__msg__vert_offset_b07__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._vert_offset_b07");
