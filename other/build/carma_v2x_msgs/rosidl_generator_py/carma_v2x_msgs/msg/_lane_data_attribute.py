...
class LaneDataAttribute(metaclass=Metaclass_LaneDataAttribute):
    ...
    _fields_and_field_types = {
        ...
        'lane_crown_point_center': 'float',
        'lane_crown_point_right': 'float',
        'lane_crown_point_left': 'float',
        'lane_angle': 'float',
    ...
    def __init__(self, **kwargs):
        ...
        self.lane_crown_point_center = kwargs.get('lane_crown_point_center', float())
        self.lane_crown_point_right = kwargs.get('lane_crown_point_right', float())
        self.lane_crown_point_left = kwargs.get('lane_crown_point_left', float())
    ...
    def lane_crown_point_center(self, value):
        if __debug__:
            assert \
                ...
                "The 'lane_crown_point_center' field must be of type 'float'"
    ...
    def lane_crown_point_right(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'lane_crown_point_right' field must be of type 'float'"
    ...
    def lane_crown_point_left(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'lane_crown_point_left' field must be of type 'float'"
