...
class PathHistoryPoint(metaclass=Metaclass_PathHistoryPoint):
    ...
    _fields_and_field_types = {
        'lat_offset': 'carma_v2x_msgs/OffsetLLB18',
        'lon_offset': 'carma_v2x_msgs/OffsetLLB18',
        'elevation_offset': 'carma_v2x_msgs/VertOffsetB12',
        'time_offset': 'carma_v2x_msgs/TimeOffset',
        'speed': 'carma_v2x_msgs/Speed',
        'pos_accuracy': 'carma_v2x_msgs/PositionalAccuracy',
        'heading': 'carma_v2x_msgs/CoarseHeading',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'OffsetLLB18'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'OffsetLLB18'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'VertOffsetB12'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'TimeOffset'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'Speed'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'PositionalAccuracy'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'CoarseHeading'),  # noqa: E501
    )
