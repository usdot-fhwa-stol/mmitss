...
bool carma_v2x_msgs__msg__mobility_repeat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._mobility_repeat.MobilityRepeat", full_classname_dest, 50) == 0);
  }
  carma_v2x_msgs__msg__MobilityRepeat * ros_message = _ros_message;
  {  // repeat
...
{
  /* NOTE(esteve): Call constructor of MobilityRepeat */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._mobility_repeat");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MobilityRepeat");
