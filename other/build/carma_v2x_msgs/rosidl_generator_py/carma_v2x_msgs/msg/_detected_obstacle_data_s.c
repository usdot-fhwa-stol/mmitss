...
bool carma_v2x_msgs__msg__detected_obstacle_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._detected_obstacle_data.DetectedObstacleData", full_classname_dest, 63) == 0);
  }
  carma_v2x_msgs__msg__DetectedObstacleData * ros_message = _ros_message;
  {  // obst_size
    PyObject * field = PyObject_GetAttrString(_pymsg, "obst_size");
    if (!field) {
      return false;
    }
    if (!carma_v2x_msgs__msg__obstacle_size__convert_from_py(field, &ros_message->obst_size)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__detected_obstacle_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._detected_obstacle_data");
  ...
  {  // obst_size
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__obstacle_size__convert_to_py(&ros_message->obst_size);
    if (!field) {
      return NULL;
    }
    {
