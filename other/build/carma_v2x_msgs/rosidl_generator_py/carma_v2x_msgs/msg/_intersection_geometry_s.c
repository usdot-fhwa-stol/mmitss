...
bool carma_v2x_msgs__msg__intersection_geometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._intersection_geometry.IntersectionGeometry", full_classname_dest, 62) == 0);
  }
  carma_v2x_msgs__msg__IntersectionGeometry * ros_message = _ros_message;
  {  // name
  ...
  {  // lane_list
    ...
    carma_v2x_msgs__msg__GenericLane * dest = ros_message->lane_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * carma_v2x_msgs__msg__intersection_geometry__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._intersection_geometry");
