...
class Metaclass_SpecialVehicleExtensions(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import TrailerData
...
class SpecialVehicleExtensions(metaclass=Metaclass_SpecialVehicleExtensions):
    ...
    _fields_and_field_types = {
        ...
        'trailers': 'carma_v2x_msgs/TrailerData',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'TrailerData'),  # noqa: E501
    )
