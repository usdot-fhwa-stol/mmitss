...
bool carma_v2x_msgs__msg__mobility_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._mobility_request.MobilityRequest", full_classname_dest, 52) == 0);
  }
  carma_v2x_msgs__msg__MobilityRequest * ros_message = _ros_message;
  {  // m_header
  ...
  {  // trajectory
    ...
    if (!carma_v2x_msgs__msg__trajectory__convert_from_py(field, &ros_message->trajectory)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // expiration
    PyObject * field = PyObject_GetAttrString(_pymsg, "expiration");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->expiration = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of MobilityRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._mobility_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MobilityRequest");
  ...
  {  // trajectory
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__trajectory__convert_to_py(&ros_message->trajectory);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // expiration
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->expiration);
    {
      int rc = PyObject_SetAttrString(_pymessage, "expiration", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
