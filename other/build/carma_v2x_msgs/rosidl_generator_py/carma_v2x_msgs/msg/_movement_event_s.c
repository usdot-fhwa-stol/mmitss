...
bool carma_v2x_msgs__msg__movement_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._movement_event.MovementEvent", full_classname_dest, 48) == 0);
  }
  carma_v2x_msgs__msg__MovementEvent * ros_message = _ros_message;
  {  // event_state
  ...
  {  // timing
    ...
    if (!carma_v2x_msgs__msg__time_change_details__convert_from_py(field, &ros_message->timing)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // advisory_speed_list
    ...
    if (!carma_v2x_msgs__msg__AdvisorySpeed__Sequence__init(&(ros_message->advisory_speed_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create carma_v2x_msgs__msg__AdvisorySpeed__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    carma_v2x_msgs__msg__AdvisorySpeed * dest = ros_message->advisory_speed_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!carma_v2x_msgs__msg__advisory_speed__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * carma_v2x_msgs__msg__movement_event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._movement_event");
  ...
  {  // timing
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__time_change_details__convert_to_py(&ros_message->timing);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // advisory_speed_list
    ...
    carma_v2x_msgs__msg__AdvisorySpeed * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->advisory_speed_list.data[i]);
      PyObject * pyitem = carma_v2x_msgs__msg__advisory_speed__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
