...
bool carma_v2x_msgs__msg__obstacle_distance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._obstacle_distance.ObstacleDistance", full_classname_dest, 54) == 0);
  }
  carma_v2x_msgs__msg__ObstacleDistance * ros_message = _ros_message;
  {  // distance
...
PyObject * carma_v2x_msgs__msg__obstacle_distance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._obstacle_distance");
