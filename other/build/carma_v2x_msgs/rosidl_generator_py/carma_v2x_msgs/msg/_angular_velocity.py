...
class AngularVelocity(metaclass=Metaclass_AngularVelocity):
    ...
    _fields_and_field_types = {
        'pitch_rate': 'carma_v2x_msgs/PitchRate',
        'roll_rate': 'carma_v2x_msgs/RollRate',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'PitchRate'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'RollRate'),  # noqa: E501
    )
