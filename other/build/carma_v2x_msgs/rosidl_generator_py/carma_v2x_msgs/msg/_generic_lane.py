...
class Metaclass_GenericLane(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import NodeListXY
...
class GenericLane(metaclass=Metaclass_GenericLane):
    ...
    _fields_and_field_types = {
        ...
        'node_list': 'carma_v2x_msgs/NodeListXY',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'NodeListXY'),  # noqa: E501
