...
bool carma_v2x_msgs__msg__velocity__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool carma_v2x_msgs__msg__transmission_and_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._transmission_and_speed.TransmissionAndSpeed", full_classname_dest, 63) == 0);
  }
  carma_v2x_msgs__msg__TransmissionAndSpeed * ros_message = _ros_message;
  {  // transmission
  ...
  {  // speed
    ...
    if (!carma_v2x_msgs__msg__velocity__convert_from_py(field, &ros_message->speed)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__transmission_and_speed__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._transmission_and_speed");
  ...
  {  // speed
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__velocity__convert_to_py(&ros_message->speed);
    if (!field) {
      return NULL;
    }
    {
