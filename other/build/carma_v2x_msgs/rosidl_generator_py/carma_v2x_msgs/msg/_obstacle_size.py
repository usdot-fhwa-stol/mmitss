...
class Metaclass_ObstacleSize(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import SizeValue
...
class ObstacleSize(metaclass=Metaclass_ObstacleSize):
    ...
    _fields_and_field_types = {
        'width': 'carma_v2x_msgs/SizeValue',
        'length': 'carma_v2x_msgs/SizeValue',
        'presence_vector': 'uint8',
        'height': 'carma_v2x_msgs/SizeValue',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'SizeValue'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'SizeValue'),  # noqa: E501
