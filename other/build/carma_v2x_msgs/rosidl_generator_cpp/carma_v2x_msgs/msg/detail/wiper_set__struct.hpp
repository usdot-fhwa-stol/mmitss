...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__WIPER_SET__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__WIPER_SET__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__WiperSet __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__WiperSet __declspec(deprecated)
#endif
...
struct WiperSet_
{
  ...
  Type & set__rate_front(
    const carma_v2x_msgs::msg::WiperRate_<ContainerAllocator> & _arg)
  {
  ...
  using ConstRawPtr =
    const carma_v2x_msgs::msg::WiperSet_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::WiperSet_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::WiperSet_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::WiperSet_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::WiperSet_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::WiperSet_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::WiperSet_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::WiperSet_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__WiperSet
    std::shared_ptr<carma_v2x_msgs::msg::WiperSet_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__WiperSet
    std::shared_ptr<carma_v2x_msgs::msg::WiperSet_<ContainerAllocator> const>
...
using WiperSet =
  carma_v2x_msgs::msg::WiperSet_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__WIPER_SET__STRUCT_HPP_
