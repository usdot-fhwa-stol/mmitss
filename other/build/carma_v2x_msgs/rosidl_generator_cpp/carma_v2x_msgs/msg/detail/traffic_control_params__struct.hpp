...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__TRAFFIC_CONTROL_PARAMS__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__TRAFFIC_CONTROL_PARAMS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__TrafficControlParams __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__TrafficControlParams __declspec(deprecated)
#endif
...
struct TrafficControlParams_
{
  ...
  Type & set__schedule(
    const carma_v2x_msgs::msg::TrafficControlSchedule_<ContainerAllocator> & _arg)
  {
    this->schedule = _arg;
    return *this;
  }
  ...
  Type & set__detail(
    const carma_v2x_msgs::msg::TrafficControlDetail_<ContainerAllocator> & _arg)
  {
    this->detail = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__TrafficControlParams
    std::shared_ptr<carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__TrafficControlParams
    std::shared_ptr<carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator> const>
...
using TrafficControlParams =
  carma_v2x_msgs::msg::TrafficControlParams_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__TRAFFIC_CONTROL_PARAMS__STRUCT_HPP_
