...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__SPECIAL_VEHICLE_EXTENSIONS__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__SPECIAL_VEHICLE_EXTENSIONS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__SpecialVehicleExtensions __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__SpecialVehicleExtensions __declspec(deprecated)
#endif
...
struct SpecialVehicleExtensions_
{
  ...
  using _trailers_type =
    carma_v2x_msgs::msg::TrailerData_<ContainerAllocator>;
  ...
  Type & set__trailers(
    const carma_v2x_msgs::msg::TrailerData_<ContainerAllocator> & _arg)
  {
    this->trailers = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__SpecialVehicleExtensions
    std::shared_ptr<carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__SpecialVehicleExtensions
    std::shared_ptr<carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator> const>
...
using SpecialVehicleExtensions =
  carma_v2x_msgs::msg::SpecialVehicleExtensions_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__SPECIAL_VEHICLE_EXTENSIONS__STRUCT_HPP_
