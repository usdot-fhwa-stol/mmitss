...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__TIME_CHANGE_DETAILS__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__TIME_CHANGE_DETAILS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__TimeChangeDetails __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__TimeChangeDetails __declspec(deprecated)
#endif
...
struct TimeChangeDetails_
{
  ...
  explicit TimeChangeDetails_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->min_end_time = 0.0f;
      this->max_end_time = 0.0f;
      this->max_end_time_exists = false;
      this->likely_time = 0.0f;
  ...
  using ConstRawPtr =
    const carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__TimeChangeDetails
    std::shared_ptr<carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__TimeChangeDetails
    std::shared_ptr<carma_v2x_msgs::msg::TimeChangeDetails_<ContainerAllocator> const>
...
using TimeChangeDetails =
  carma_v2x_msgs::msg::TimeChangeDetails_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__TIME_CHANGE_DETAILS__STRUCT_HPP_
