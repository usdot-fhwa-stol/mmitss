...
#include "carma_v2x_msgs/msg/detail/traffic_control_params__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::TrafficControlVehClass &,
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::TrafficControlSchedule &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::TrafficControlDetail &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::TrafficControlParams & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::TrafficControlParams & ros_message)
{
  // Member: vclasses
  {
    uint32_t cdrSize;
  ...
  // Member: vclasses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.vclasses[index], current_alignment);
    }
  }
  // Member: schedule
  ...
  size_t current_alignment)
{
  ...
  // Member: vclasses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficControlVehClass(
  ...
  // Member: schedule
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficControlSchedule(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: detail
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficControlDetail(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::TrafficControlParams *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::TrafficControlParams *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrafficControlParams__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::TrafficControlParams *>(
...
{
  return max_serialized_size_TrafficControlParams(full_bounded, 0);
}

static message_type_support_callbacks_t _TrafficControlParams__callbacks = {
  "carma_v2x_msgs::msg",
...
static rosidl_message_type_support_t _TrafficControlParams__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrafficControlParams__callbacks,
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlParams__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, TrafficControlParams)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlParams__handle;
}
