...
#include "carma_v2x_msgs/msg/detail/mobility_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::MobilityPath & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::MobilityPath & ros_message)
{
  // Member: m_header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_carma_v2x_msgs
max_serialized_size_MobilityPath(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::MobilityPath *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::MobilityPath *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MobilityPath__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::MobilityPath *>(
...
{
  return max_serialized_size_MobilityPath(full_bounded, 0);
}

static message_type_support_callbacks_t _MobilityPath__callbacks = {
  "carma_v2x_msgs::msg",
  "MobilityPath",
...
static rosidl_message_type_support_t _MobilityPath__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MobilityPath__callbacks,
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_MobilityPath__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, MobilityPath)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_MobilityPath__handle;
}
