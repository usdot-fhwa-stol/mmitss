...
#include "carma_v2x_msgs/msg/detail/traffic_control_schedule__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::DailySchedule &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::DailySchedule &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::DailySchedule &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::RepeatParams &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::TrafficControlSchedule & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::TrafficControlSchedule & ros_message)
{
  // Member: start
  ...
  size_t current_alignment)
{
  ...
  // Member: between
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DailySchedule(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: repeat
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RepeatParams(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::TrafficControlSchedule *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::TrafficControlSchedule *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlSchedule__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, TrafficControlSchedule)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlSchedule__handle;
}
