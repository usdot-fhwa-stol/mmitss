...
#include "carma_v2x_msgs/msg/detail/node_list_xy__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::NodeSetXY &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::NodeSetXY &);
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::ComputedLane &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::ComputedLane &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::ComputedLane &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const carma_v2x_msgs::msg::NodeListXY & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::NodeListXY & ros_message)
{
  // Member: choice
  cdr >> ros_message.choice;
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_NodeSetXY(
  ...
  // Member: computed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ComputedLane(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::NodeListXY *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::NodeListXY *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_NodeListXY__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, NodeListXY)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_NodeListXY__handle;
}
