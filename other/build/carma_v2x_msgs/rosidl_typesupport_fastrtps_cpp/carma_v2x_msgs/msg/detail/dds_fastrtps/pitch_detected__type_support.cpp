...
#include "carma_v2x_msgs/msg/detail/pitch_detected__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::PitchDetected & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::PitchDetected & ros_message)
{
  // Member: pitch_detected
  cdr >> ros_message.pitch_detected;
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::PitchDetected *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::PitchDetected *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_PitchDetected__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, PitchDetected)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_PitchDetected__handle;
}
