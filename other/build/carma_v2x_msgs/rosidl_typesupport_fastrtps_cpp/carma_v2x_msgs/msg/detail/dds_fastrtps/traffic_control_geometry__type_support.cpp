...
#include "carma_v2x_msgs/msg/detail/traffic_control_geometry__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::PathNode &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::TrafficControlGeometry & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::TrafficControlGeometry & ros_message)
{
  // Member: proj
  cdr >> ros_message.proj;
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PathNode(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::TrafficControlGeometry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::TrafficControlGeometry *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlGeometry__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, TrafficControlGeometry)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlGeometry__handle;
}
