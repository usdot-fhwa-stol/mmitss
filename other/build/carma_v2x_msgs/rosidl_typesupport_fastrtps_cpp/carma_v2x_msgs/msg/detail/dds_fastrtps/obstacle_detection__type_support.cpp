...
#include "carma_v2x_msgs/msg/detail/obstacle_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::ObstacleDistance &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::ObstacleDistance &);
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::ObstacleDirection &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::ObstacleDirection &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::ObstacleDirection &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const carma_v2x_msgs::msg::ObstacleDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::ObstacleDetection & ros_message)
{
  // Member: presence_vector
  cdr >> ros_message.presence_vector;
  ...
  size_t current_alignment)
{
  ...
  // Member: ob_dist
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObstacleDistance(
  ...
  // Member: ob_direct
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObstacleDirection(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::ObstacleDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::ObstacleDetection *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_ObstacleDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, ObstacleDetection)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_ObstacleDetection__handle;
}
