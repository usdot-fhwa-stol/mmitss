...
#include "carma_v2x_msgs/msg/detail/weather_report__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::NTCIPEssPrecipRate &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::NTCIPEssPrecipRate &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::NTCIPEssPrecipRate &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::CoefficientOfFriction &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::WeatherReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::WeatherReport & ros_message)
{
  // Member: presence_vector
  cdr >> ros_message.presence_vector;
  ...
  size_t current_alignment)
{
  ...
  // Member: rain_rate
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_NTCIPEssPrecipRate(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: road_friction
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CoefficientOfFriction(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::WeatherReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::WeatherReport *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_WeatherReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, WeatherReport)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_WeatherReport__handle;
}
