...
#include "carma_v2x_msgs/msg/detail/traffic_control_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::TrafficControlMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::TrafficControlMessage & ros_message)
{
  // Member: choice
  cdr >> ros_message.choice;
  ...
  size_t current_alignment)
{
  ...
  // Member: tcm_v01
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficControlMessageV01(
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::TrafficControlMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::TrafficControlMessage *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, TrafficControlMessage)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlMessage__handle;
}
