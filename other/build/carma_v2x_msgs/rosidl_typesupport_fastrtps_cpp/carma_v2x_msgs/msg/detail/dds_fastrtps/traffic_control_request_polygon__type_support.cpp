...
#include "carma_v2x_msgs/msg/detail/traffic_control_request_polygon__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::TrafficControlRequestPolygon & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::TrafficControlRequestPolygon & ros_message)
{
  // Member: polygon_list
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_carma_v2x_msgs
max_serialized_size_TrafficControlRequestPolygon(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::TrafficControlRequestPolygon *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::TrafficControlRequestPolygon *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrafficControlRequestPolygon__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::TrafficControlRequestPolygon *>(
...
{
  return max_serialized_size_TrafficControlRequestPolygon(full_bounded, 0);
}

static message_type_support_callbacks_t _TrafficControlRequestPolygon__callbacks = {
  "carma_v2x_msgs::msg",
...
static rosidl_message_type_support_t _TrafficControlRequestPolygon__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrafficControlRequestPolygon__callbacks,
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlRequestPolygon__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, TrafficControlRequestPolygon)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlRequestPolygon__handle;
}
