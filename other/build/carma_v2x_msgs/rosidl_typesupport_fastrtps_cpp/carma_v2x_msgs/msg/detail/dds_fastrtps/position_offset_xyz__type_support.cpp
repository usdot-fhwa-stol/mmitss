...
#include "carma_v2x_msgs/msg/detail/position_offset_xyz__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::ObjectDistance &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::ObjectDistance &);
...
cdr_serialize(
  const carma_v2x_msgs::msg::PositionOffsetXYZ & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::PositionOffsetXYZ & ros_message)
{
  // Member: offset_x
  ...
  size_t current_alignment)
{
  ...
  // Member: offset_x
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectDistance(
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::PositionOffsetXYZ *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::PositionOffsetXYZ *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_PositionOffsetXYZ__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, PositionOffsetXYZ)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_PositionOffsetXYZ__handle;
}
