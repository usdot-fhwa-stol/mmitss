...
#include "carma_v2x_msgs/msg/detail/heading__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::Heading & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::Heading & ros_message)
{
  // Member: heading
  cdr >> ros_message.heading;
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::Heading *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::Heading *>(
    untyped_ros_message);
...
static size_t _Heading__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Heading(full_bounded, 0);
}
...
get_message_type_support_handle<carma_v2x_msgs::msg::Heading>()
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_Heading__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, Heading)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_Heading__handle;
}
