...
#include "carma_v2x_msgs/msg/detail/detected_object_optional_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::DetectedVehicleData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::DetectedVehicleData &);
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::DetectedVRUData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::DetectedVRUData &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::DetectedVRUData &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::DetectedObstacleData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::DetectedObjectOptionalData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::DetectedObjectOptionalData & ros_message)
{
  // Member: choice
  cdr >> ros_message.choice;
  ...
  size_t current_alignment)
{
  ...
  // Member: det_veh
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedVehicleData(
  ...
  // Member: det_vru
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedVRUData(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: det_obst
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedObstacleData(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::DetectedObjectOptionalData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::DetectedObjectOptionalData *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjectOptionalData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, DetectedObjectOptionalData)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjectOptionalData__handle;
}
