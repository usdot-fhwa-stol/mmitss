...
#include "carma_v2x_msgs/msg/detail/movement_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::MovementEvent &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::MovementEvent &);
...
cdr_serialize(
  const carma_v2x_msgs::msg::MovementState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::MovementState & ros_message)
{
  // Member: movement_name
  cdr >> ros_message.movement_name;
  ...
  size_t current_alignment)
{
  ...
  // Member: movement_event_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MovementEvent(
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::MovementState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::MovementState *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_MovementState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, MovementState)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_MovementState__handle;
}
