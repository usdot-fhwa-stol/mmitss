...
#include "carma_v2x_msgs/msg/detail/rtcm_package__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::RTCMHeader &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::RTCMPackage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::RTCMPackage & ros_message)
{
  // Member: presence_vector
  cdr >> ros_message.presence_vector;
  ...
  size_t current_alignment)
{
  ...
  // Member: rtcm_header
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RTCMHeader(
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::RTCMPackage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::RTCMPackage *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_RTCMPackage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, RTCMPackage)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_RTCMPackage__handle;
}
