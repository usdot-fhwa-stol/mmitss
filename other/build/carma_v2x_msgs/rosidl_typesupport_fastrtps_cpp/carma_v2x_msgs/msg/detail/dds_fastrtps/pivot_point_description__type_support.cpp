...
#include "carma_v2x_msgs/msg/detail/pivot_point_description__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::OffsetB11 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::OffsetB11 &);
...
cdr_serialize(
  const carma_v2x_msgs::msg::PivotPointDescription & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::PivotPointDescription & ros_message)
{
  // Member: pivot_offset
  ...
  size_t current_alignment)
{
  ...
  // Member: pivot_offset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_OffsetB11(
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::PivotPointDescription *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::PivotPointDescription *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_PivotPointDescription__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, PivotPointDescription)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_PivotPointDescription__handle;
}
