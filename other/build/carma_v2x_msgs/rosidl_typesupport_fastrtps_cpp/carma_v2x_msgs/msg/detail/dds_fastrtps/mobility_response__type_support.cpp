...
#include "carma_v2x_msgs/msg/detail/mobility_response__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::MobilityReason &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::MobilityRepeat &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::MobilityResponse & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::MobilityResponse & ros_message)
{
  // Member: m_header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_carma_v2x_msgs
max_serialized_size_MobilityResponse(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: reason
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MobilityReason(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: repeat
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MobilityRepeat(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::MobilityResponse *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::MobilityResponse *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MobilityResponse__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::MobilityResponse *>(
...
{
  return max_serialized_size_MobilityResponse(full_bounded, 0);
}

static message_type_support_callbacks_t _MobilityResponse__callbacks = {
  "carma_v2x_msgs::msg",
  "MobilityResponse",
...
static rosidl_message_type_support_t _MobilityResponse__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MobilityResponse__callbacks,
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_MobilityResponse__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, MobilityResponse)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_MobilityResponse__handle;
}
