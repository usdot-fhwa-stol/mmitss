...
#include "carma_v2x_msgs/msg/detail/vehicle_safety_extensions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::VehicleSafetyExtensions & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::VehicleSafetyExtensions & ros_message)
{
  // Member: presence_vector
  cdr >> ros_message.presence_vector;
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::VehicleSafetyExtensions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::VehicleSafetyExtensions *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_VehicleSafetyExtensions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, VehicleSafetyExtensions)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_VehicleSafetyExtensions__handle;
}
