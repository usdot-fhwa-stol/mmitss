...
#include "carma_v2x_msgs/msg/detail/wiper_set__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::WiperRate &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::WiperSet & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::WiperSet & ros_message)
{
  // Member: presence_vector
  cdr >> ros_message.presence_vector;
  ...
  size_t current_alignment)
{
  ...
  // Member: rate_front
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_WiperRate(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::WiperSet *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::WiperSet *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_WiperSet__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, WiperSet)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_WiperSet__handle;
}
