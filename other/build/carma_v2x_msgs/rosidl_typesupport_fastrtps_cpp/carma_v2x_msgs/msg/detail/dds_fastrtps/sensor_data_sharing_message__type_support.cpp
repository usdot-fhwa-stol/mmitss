...
#include "carma_v2x_msgs/msg/detail/sensor_data_sharing_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j3224_v2x_msgs::msg::EquipmentType &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j3224_v2x_msgs::msg::EquipmentType &);
size_t get_serialized_size(
  const j3224_v2x_msgs::msg::EquipmentType &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::DetectedObjectList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::DetectedObjectList &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::DetectedObjectList &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const carma_v2x_msgs::msg::SensorDataSharingMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::SensorDataSharingMessage & ros_message)
{
  // Member: msg_cnt
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_carma_v2x_msgs
max_serialized_size_SensorDataSharingMessage(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: equipment_type
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j3224_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_EquipmentType(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedObjectList(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::SensorDataSharingMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::SensorDataSharingMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SensorDataSharingMessage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::SensorDataSharingMessage *>(
...
{
  return max_serialized_size_SensorDataSharingMessage(full_bounded, 0);
}

static message_type_support_callbacks_t _SensorDataSharingMessage__callbacks = {
  "carma_v2x_msgs::msg",
...
static rosidl_message_type_support_t _SensorDataSharingMessage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SensorDataSharingMessage__callbacks,
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_SensorDataSharingMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, SensorDataSharingMessage)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_SensorDataSharingMessage__handle;
}
