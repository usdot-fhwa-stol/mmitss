...
#include "carma_v2x_msgs/msg/detail/bsm_regional_extension__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::BSMRegionalExtension *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::BSMRegionalExtension *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_BSMRegionalExtension__handle;
}
