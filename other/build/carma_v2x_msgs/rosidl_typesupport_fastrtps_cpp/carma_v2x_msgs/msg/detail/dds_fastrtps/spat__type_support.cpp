...
#include "carma_v2x_msgs/msg/detail/spat__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::IntersectionState &,
...
cdr_serialize(
  const carma_v2x_msgs::msg::SPAT & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::SPAT & ros_message)
{
  // Member: time_stamp
  cdr >> ros_message.time_stamp;
  ...
  size_t current_alignment)
{
  ...
  // Member: intersection_state_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_IntersectionState(
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::SPAT *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::SPAT *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_SPAT__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, SPAT)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_SPAT__handle;
}
