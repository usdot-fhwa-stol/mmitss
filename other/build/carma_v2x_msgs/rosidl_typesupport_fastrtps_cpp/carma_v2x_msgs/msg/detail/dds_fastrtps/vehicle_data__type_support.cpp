...
#include "carma_v2x_msgs/msg/detail/vehicle_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::VehicleHeight &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::VehicleHeight &);
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::BumperHeights &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::BumperHeights &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::BumperHeights &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::VehicleMass &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::VehicleMass &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::VehicleMass &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const carma_v2x_msgs::msg::TrailerWeight &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  carma_v2x_msgs::msg::TrailerWeight &);
size_t get_serialized_size(
  const carma_v2x_msgs::msg::TrailerWeight &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const carma_v2x_msgs::msg::VehicleData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::VehicleData & ros_message)
{
  // Member: presence_vector
  cdr >> ros_message.presence_vector;
  ...
  size_t current_alignment)
{
  ...
  // Member: height
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VehicleHeight(
  ...
  // Member: bumpers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BumperHeights(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: mass
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VehicleMass(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: trailer_weight
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrailerWeight(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::VehicleData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::VehicleData *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_VehicleData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, VehicleData)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_VehicleData__handle;
}
