...
#include "carma_v2x_msgs/msg/detail/intersection_geometry__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::IntersectionGeometry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::IntersectionGeometry *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_IntersectionGeometry__handle;
}
