...
#include "carma_v2x_msgs/msg/detail/bumper_height__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::BumperHeight & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::BumperHeight & ros_message)
{
  // Member: bumper_height
  cdr >> ros_message.bumper_height;
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::BumperHeight *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::BumperHeight *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_BumperHeight__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, BumperHeight)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_BumperHeight__handle;
}
