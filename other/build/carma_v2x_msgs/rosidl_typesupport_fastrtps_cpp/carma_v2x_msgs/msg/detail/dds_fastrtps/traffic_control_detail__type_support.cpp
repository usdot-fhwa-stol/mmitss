...
#include "carma_v2x_msgs/msg/detail/traffic_control_detail__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::TrafficControlDetail & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::TrafficControlDetail & ros_message)
{
  // Member: choice
  cdr >> ros_message.choice;
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::TrafficControlDetail *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::TrafficControlDetail *>(
    untyped_ros_message);
...
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlDetail__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, TrafficControlDetail)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlDetail__handle;
}
