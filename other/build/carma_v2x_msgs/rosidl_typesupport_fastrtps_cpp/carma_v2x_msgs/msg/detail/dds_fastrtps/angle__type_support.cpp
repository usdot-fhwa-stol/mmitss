...
#include "carma_v2x_msgs/msg/detail/angle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_v2x_msgs::msg::Angle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_v2x_msgs::msg::Angle & ros_message)
{
  // Member: angle
  cdr >> ros_message.angle;
...
{
  auto typed_message =
    static_cast<const carma_v2x_msgs::msg::Angle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_v2x_msgs::msg::Angle *>(
    untyped_ros_message);
...
static size_t _Angle__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Angle(full_bounded, 0);
}
...
get_message_type_support_handle<carma_v2x_msgs::msg::Angle>()
{
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_Angle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, Angle)() {
  return &carma_v2x_msgs::msg::typesupport_fastrtps_cpp::_Angle__handle;
}
