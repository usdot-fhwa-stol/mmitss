...
static const _MobilityOperation_type_support_symbol_names_t _MobilityOperation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_v2x_msgs, msg, MobilityOperation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, MobilityOperation)),
  }
};
...
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_cpp::MobilityOperation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carma_v2x_msgs, msg, MobilityOperation)() {
  return get_message_type_support_handle<carma_v2x_msgs::msg::MobilityOperation>();
}
