...
#include "carma_planning_msgs/msg/detail/intersection_transit_straight_maneuver__rosidl_typesupport_fastrtps_c.h"
...
using _IntersectionTransitStraightManeuver__ros_msg_type = carma_planning_msgs__msg__IntersectionTransitStraightManeuver;

static bool _IntersectionTransitStraightManeuver__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IntersectionTransitStraightManeuver__ros_msg_type * ros_message = static_cast<const _IntersectionTransitStraightManeuver__ros_msg_type *>(untyped_ros_message);
...
static bool _IntersectionTransitStraightManeuver__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _IntersectionTransitStraightManeuver__ros_msg_type * ros_message = static_cast<_IntersectionTransitStraightManeuver__ros_msg_type *>(untyped_ros_message);
  // Field name: parameters
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _IntersectionTransitStraightManeuver__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_planning_msgs__msg__IntersectionTransitStraightManeuver(
...
static size_t _IntersectionTransitStraightManeuver__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_carma_planning_msgs__msg__IntersectionTransitStraightManeuver(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_IntersectionTransitStraightManeuver = {
  "carma_planning_msgs::msg",
  "IntersectionTransitStraightManeuver",
  _IntersectionTransitStraightManeuver__cdr_serialize,
  _IntersectionTransitStraightManeuver__cdr_deserialize,
  _IntersectionTransitStraightManeuver__get_serialized_size,
  _IntersectionTransitStraightManeuver__max_serialized_size
};

static rosidl_message_type_support_t _IntersectionTransitStraightManeuver__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IntersectionTransitStraightManeuver,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, msg, IntersectionTransitStraightManeuver)() {
  return &_IntersectionTransitStraightManeuver__type_support;
}
