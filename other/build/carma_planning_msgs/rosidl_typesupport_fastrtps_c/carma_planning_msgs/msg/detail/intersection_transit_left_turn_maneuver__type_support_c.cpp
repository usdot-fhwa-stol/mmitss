...
#include "carma_planning_msgs/msg/detail/intersection_transit_left_turn_maneuver__rosidl_typesupport_fastrtps_c.h"
...
using _IntersectionTransitLeftTurnManeuver__ros_msg_type = carma_planning_msgs__msg__IntersectionTransitLeftTurnManeuver;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IntersectionTransitLeftTurnManeuver__ros_msg_type * ros_message = static_cast<const _IntersectionTransitLeftTurnManeuver__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _IntersectionTransitLeftTurnManeuver__ros_msg_type * ros_message = static_cast<_IntersectionTransitLeftTurnManeuver__ros_msg_type *>(untyped_ros_message);
  // Field name: parameters
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _IntersectionTransitLeftTurnManeuver__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_planning_msgs__msg__IntersectionTransitLeftTurnManeuver(
...
{
  return max_serialized_size_carma_planning_msgs__msg__IntersectionTransitLeftTurnManeuver(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_IntersectionTransitLeftTurnManeuver = {
...
static rosidl_message_type_support_t _IntersectionTransitLeftTurnManeuver__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IntersectionTransitLeftTurnManeuver,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, msg, IntersectionTransitLeftTurnManeuver)() {
  return &_IntersectionTransitLeftTurnManeuver__type_support;
}
