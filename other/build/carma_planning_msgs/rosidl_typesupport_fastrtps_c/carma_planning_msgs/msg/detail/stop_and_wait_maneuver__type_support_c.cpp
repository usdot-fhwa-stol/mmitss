...
#include "carma_planning_msgs/msg/detail/stop_and_wait_maneuver__rosidl_typesupport_fastrtps_c.h"
...
using _StopAndWaitManeuver__ros_msg_type = carma_planning_msgs__msg__StopAndWaitManeuver;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _StopAndWaitManeuver__ros_msg_type * ros_message = static_cast<const _StopAndWaitManeuver__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _StopAndWaitManeuver__ros_msg_type * ros_message = static_cast<_StopAndWaitManeuver__ros_msg_type *>(untyped_ros_message);
  // Field name: parameters
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _StopAndWaitManeuver__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_planning_msgs__msg__StopAndWaitManeuver(
...
{
  return max_serialized_size_carma_planning_msgs__msg__StopAndWaitManeuver(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_StopAndWaitManeuver = {
...
static rosidl_message_type_support_t _StopAndWaitManeuver__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_StopAndWaitManeuver,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, msg, StopAndWaitManeuver)() {
  return &_StopAndWaitManeuver__type_support;
}
