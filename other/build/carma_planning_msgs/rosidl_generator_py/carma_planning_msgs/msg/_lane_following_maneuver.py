...
class Metaclass_LaneFollowingManeuver(type):
    """Metaclass of message 'LaneFollowingManeuver'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__lane_following_maneuver
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__lane_following_maneuver
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__lane_following_maneuver
            cls._TYPE_SUPPORT = module.type_support_msg__msg__lane_following_maneuver
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__lane_following_maneuver
...
class LaneFollowingManeuver(metaclass=Metaclass_LaneFollowingManeuver):
    """Message class 'LaneFollowingManeuver'."""
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'lane_ids' field must be a set or sequence and each value of type 'str'"
