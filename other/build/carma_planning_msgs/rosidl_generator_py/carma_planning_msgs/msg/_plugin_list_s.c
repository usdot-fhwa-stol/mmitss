...
bool carma_planning_msgs__msg__plugin_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_planning_msgs.msg._plugin_list.PluginList", full_classname_dest, 47) == 0);
  }
  carma_planning_msgs__msg__PluginList * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PluginList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_planning_msgs.msg._plugin_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PluginList");
