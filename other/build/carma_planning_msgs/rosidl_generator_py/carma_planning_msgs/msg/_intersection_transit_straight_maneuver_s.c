...
bool carma_planning_msgs__msg__intersection_transit_straight_maneuver__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_planning_msgs.msg._intersection_transit_straight_maneuver.IntersectionTransitStraightManeuver", full_classname_dest, 99) == 0);
  }
  carma_planning_msgs__msg__IntersectionTransitStraightManeuver * ros_message = _ros_message;
  {  // parameters
...
{
  /* NOTE(esteve): Call constructor of IntersectionTransitStraightManeuver */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_planning_msgs.msg._intersection_transit_straight_maneuver");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IntersectionTransitStraightManeuver");
