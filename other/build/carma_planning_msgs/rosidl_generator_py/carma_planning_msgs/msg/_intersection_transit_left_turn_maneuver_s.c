...
bool carma_planning_msgs__msg__intersection_transit_left_turn_maneuver__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_planning_msgs.msg._intersection_transit_left_turn_maneuver.IntersectionTransitLeftTurnManeuver", full_classname_dest, 100) == 0);
  }
  carma_planning_msgs__msg__IntersectionTransitLeftTurnManeuver * ros_message = _ros_message;
  {  // parameters
...
{
  /* NOTE(esteve): Call constructor of IntersectionTransitLeftTurnManeuver */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_planning_msgs.msg._intersection_transit_left_turn_maneuver");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IntersectionTransitLeftTurnManeuver");
