...
#include "carma_planning_msgs/msg/detail/lane_following_maneuver__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_planning_msgs::msg::LaneFollowingManeuver & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_planning_msgs::msg::LaneFollowingManeuver & ros_message)
{
  // Member: parameters
  ...
  size_t current_alignment)
{
  ...
  // Member: lane_ids
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.lane_ids[index].size() + 1);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::LaneFollowingManeuver *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_planning_msgs::msg::LaneFollowingManeuver *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LaneFollowingManeuver__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::LaneFollowingManeuver *>(
...
{
  return max_serialized_size_LaneFollowingManeuver(full_bounded, 0);
}

static message_type_support_callbacks_t _LaneFollowingManeuver__callbacks = {
...
static rosidl_message_type_support_t _LaneFollowingManeuver__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LaneFollowingManeuver__callbacks,
...
{
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_LaneFollowingManeuver__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_planning_msgs, msg, LaneFollowingManeuver)() {
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_LaneFollowingManeuver__handle;
}
