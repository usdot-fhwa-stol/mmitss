...
#include "carma_planning_msgs/msg/detail/lane_change_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_planning_msgs::msg::LaneChangeStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_planning_msgs::msg::LaneChangeStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
...
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::LaneChangeStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_planning_msgs::msg::LaneChangeStatus *>(
    untyped_ros_message);
...
{
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_LaneChangeStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_planning_msgs, msg, LaneChangeStatus)() {
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_LaneChangeStatus__handle;
}
