...
#include "carma_planning_msgs/msg/detail/stop_and_wait_maneuver__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_planning_msgs::msg::StopAndWaitManeuver & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_planning_msgs::msg::StopAndWaitManeuver & ros_message)
{
  // Member: parameters
...
static bool _StopAndWaitManeuver__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::StopAndWaitManeuver *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _StopAndWaitManeuver__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<carma_planning_msgs::msg::StopAndWaitManeuver *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StopAndWaitManeuver__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::StopAndWaitManeuver *>(
...
static size_t _StopAndWaitManeuver__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_StopAndWaitManeuver(full_bounded, 0);
}

static message_type_support_callbacks_t _StopAndWaitManeuver__callbacks = {
  "carma_planning_msgs::msg",
  "StopAndWaitManeuver",
  _StopAndWaitManeuver__cdr_serialize,
  _StopAndWaitManeuver__cdr_deserialize,
  _StopAndWaitManeuver__get_serialized_size,
  _StopAndWaitManeuver__max_serialized_size
};

static rosidl_message_type_support_t _StopAndWaitManeuver__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StopAndWaitManeuver__callbacks,
...
{
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_StopAndWaitManeuver__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_planning_msgs, msg, StopAndWaitManeuver)() {
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_StopAndWaitManeuver__handle;
}
