...
#include "carma_planning_msgs/msg/detail/intersection_transit_right_turn_maneuver__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carma_planning_msgs::msg::IntersectionTransitRightTurnManeuver & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_planning_msgs::msg::IntersectionTransitRightTurnManeuver & ros_message)
{
  // Member: parameters
...
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::IntersectionTransitRightTurnManeuver *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_planning_msgs::msg::IntersectionTransitRightTurnManeuver *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IntersectionTransitRightTurnManeuver__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::IntersectionTransitRightTurnManeuver *>(
...
{
  return max_serialized_size_IntersectionTransitRightTurnManeuver(full_bounded, 0);
}

static message_type_support_callbacks_t _IntersectionTransitRightTurnManeuver__callbacks = {
...
static rosidl_message_type_support_t _IntersectionTransitRightTurnManeuver__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IntersectionTransitRightTurnManeuver__callbacks,
...
{
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_IntersectionTransitRightTurnManeuver__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_planning_msgs, msg, IntersectionTransitRightTurnManeuver)() {
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_IntersectionTransitRightTurnManeuver__handle;
}
