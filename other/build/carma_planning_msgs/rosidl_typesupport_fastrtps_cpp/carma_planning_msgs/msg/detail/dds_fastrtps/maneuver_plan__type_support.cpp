...
#include "carma_planning_msgs/msg/detail/maneuver_plan__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const carma_planning_msgs::msg::Maneuver &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const carma_planning_msgs::msg::ManeuverPlan & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.maneuver_plan_id;
  // Member: planning_start_time
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.planning_start_time,
    cdr);
  // Member: planning_completion_time
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.planning_completion_time,
    cdr);
  // Member: maneuvers
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carma_planning_msgs::msg::ManeuverPlan & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: maneuvers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        carma_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Maneuver(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::ManeuverPlan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carma_planning_msgs::msg::ManeuverPlan *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ManeuverPlan__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carma_planning_msgs::msg::ManeuverPlan *>(
...
{
  return max_serialized_size_ManeuverPlan(full_bounded, 0);
}

static message_type_support_callbacks_t _ManeuverPlan__callbacks = {
...
static rosidl_message_type_support_t _ManeuverPlan__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ManeuverPlan__callbacks,
...
{
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_ManeuverPlan__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_planning_msgs, msg, ManeuverPlan)() {
  return &carma_planning_msgs::msg::typesupport_fastrtps_cpp::_ManeuverPlan__handle;
}
