...
static const _PlanTrajectory_Request_type_support_symbol_names_t _PlanTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, srv, PlanTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_planning_msgs, srv, PlanTrajectory_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_planning_msgs, srv, PlanTrajectory_Request)() {
  return &::carma_planning_msgs::srv::rosidl_typesupport_c::PlanTrajectory_Request_message_type_support_handle;
}
...
static const _PlanTrajectory_Response_type_support_symbol_names_t _PlanTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, srv, PlanTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_planning_msgs, srv, PlanTrajectory_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_carma_planning_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_planning_msgs, srv, PlanTrajectory_Response)() {
  return &::carma_planning_msgs::srv::rosidl_typesupport_c::PlanTrajectory_Response_message_type_support_handle;
}
...
static const _PlanTrajectory_type_support_symbol_names_t _PlanTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, srv, PlanTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_planning_msgs, srv, PlanTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, carma_planning_msgs, srv, PlanTrajectory)() {
  return &::carma_planning_msgs::srv::rosidl_typesupport_c::PlanTrajectory_service_type_support_handle;
}
