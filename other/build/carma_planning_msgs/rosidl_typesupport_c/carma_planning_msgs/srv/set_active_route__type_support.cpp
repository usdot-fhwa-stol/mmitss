...
static const _SetActiveRoute_Request_type_support_symbol_names_t _SetActiveRoute_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, srv, SetActiveRoute_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_planning_msgs, srv, SetActiveRoute_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_planning_msgs, srv, SetActiveRoute_Request)() {
  return &::carma_planning_msgs::srv::rosidl_typesupport_c::SetActiveRoute_Request_message_type_support_handle;
}
...
static const _SetActiveRoute_Response_type_support_symbol_names_t _SetActiveRoute_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, srv, SetActiveRoute_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_planning_msgs, srv, SetActiveRoute_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_carma_planning_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_planning_msgs, srv, SetActiveRoute_Response)() {
  return &::carma_planning_msgs::srv::rosidl_typesupport_c::SetActiveRoute_Response_message_type_support_handle;
}
...
static const _SetActiveRoute_type_support_symbol_names_t _SetActiveRoute_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, srv, SetActiveRoute)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_planning_msgs, srv, SetActiveRoute)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, carma_planning_msgs, srv, SetActiveRoute)() {
  return &::carma_planning_msgs::srv::rosidl_typesupport_c::SetActiveRoute_service_type_support_handle;
}
