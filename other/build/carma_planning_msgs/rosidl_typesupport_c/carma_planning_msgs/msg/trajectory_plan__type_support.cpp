...
static const _TrajectoryPlan_type_support_symbol_names_t _TrajectoryPlan_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_planning_msgs, msg, TrajectoryPlan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_planning_msgs, msg, TrajectoryPlan)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_planning_msgs, msg, TrajectoryPlan)() {
  return &::carma_planning_msgs::msg::rosidl_typesupport_c::TrajectoryPlan_message_type_support_handle;
}
