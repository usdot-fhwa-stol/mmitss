...
#ifndef CARMA_PLANNING_MSGS__SRV__DETAIL__PLAN_TRAJECTORY__FUNCTIONS_H_
#define CARMA_PLANNING_MSGS__SRV__DETAIL__PLAN_TRAJECTORY__FUNCTIONS_H_
 ...
 * calls
 * carma_planning_msgs__srv__PlanTrajectory_Request__init().
...
/**
 * It calls
 * carma_planning_msgs__srv__PlanTrajectory_Request__fini()
 ...
 * carma_planning_msgs__srv__PlanTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * carma_planning_msgs__srv__PlanTrajectory_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * carma_planning_msgs__srv__PlanTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_carma_planning_msgs
...
/**
 * It calls
 * carma_planning_msgs__srv__PlanTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_carma_planning_msgs
...
/**
 * It allocates the memory for the array and calls
 * carma_planning_msgs__srv__PlanTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_carma_planning_msgs
...
/**
 * It calls
 * carma_planning_msgs__srv__PlanTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CARMA_PLANNING_MSGS__SRV__DETAIL__PLAN_TRAJECTORY__FUNCTIONS_H_
