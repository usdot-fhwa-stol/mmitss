...
carma_planning_msgs__msg__RouteEvent__init(carma_planning_msgs__msg__RouteEvent * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    carma_planning_msgs__msg__RouteEvent__fini(msg);
    return false;
  }
  // event
  return true;
...
carma_planning_msgs__msg__RouteEvent__create()
{
  ...
  carma_planning_msgs__msg__RouteEvent * msg = (carma_planning_msgs__msg__RouteEvent *)allocator.allocate(sizeof(carma_planning_msgs__msg__RouteEvent), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(carma_planning_msgs__msg__RouteEvent));
  bool success = carma_planning_msgs__msg__RouteEvent__init(msg);
  if (!success) {
...
carma_planning_msgs__msg__RouteEvent__Sequence__init(carma_planning_msgs__msg__RouteEvent__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_planning_msgs__msg__RouteEvent * data = NULL;

  if (size) {
    data = (carma_planning_msgs__msg__RouteEvent *)allocator.zero_allocate(size, sizeof(carma_planning_msgs__msg__RouteEvent), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = carma_planning_msgs__msg__RouteEvent__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        carma_planning_msgs__msg__RouteEvent__fini(&data[i - 1]);
      }
...
carma_planning_msgs__msg__RouteEvent__Sequence__fini(carma_planning_msgs__msg__RouteEvent__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      carma_planning_msgs__msg__RouteEvent__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_planning_msgs__msg__RouteEvent__Sequence * array = (carma_planning_msgs__msg__RouteEvent__Sequence *)allocator.allocate(sizeof(carma_planning_msgs__msg__RouteEvent__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = carma_planning_msgs__msg__RouteEvent__Sequence__init(array, size);
  if (!success) {
...
carma_planning_msgs__msg__RouteEvent__Sequence__destroy(carma_planning_msgs__msg__RouteEvent__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    carma_planning_msgs__msg__RouteEvent__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
carma_planning_msgs__msg__RouteEvent__Sequence__are_equal(const carma_planning_msgs__msg__RouteEvent__Sequence * lhs, const carma_planning_msgs__msg__RouteEvent__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!carma_planning_msgs__msg__RouteEvent__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  carma_planning_msgs__msg__RouteEvent__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(carma_planning_msgs__msg__RouteEvent);
    carma_planning_msgs__msg__RouteEvent * data =
      (carma_planning_msgs__msg__RouteEvent *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carma_planning_msgs__msg__RouteEvent__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          carma_planning_msgs__msg__RouteEvent__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!carma_planning_msgs__msg__RouteEvent__copy(
