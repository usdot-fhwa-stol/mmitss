    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'j2735_v2x_msgs.msg.TrafficControlRequest')
            logger.debug(
            ...
            from j2735_v2x_msgs.msg import TrafficControlRequestV01
...
class TrafficControlRequest(metaclass=Metaclass_TrafficControlRequest):
    ...
    _fields_and_field_types = {
        'choice': 'uint8',
        'tcr_v01': 'j2735_v2x_msgs/TrafficControlRequestV01',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'TrafficControlRequestV01'),  # noqa: E501
    )
