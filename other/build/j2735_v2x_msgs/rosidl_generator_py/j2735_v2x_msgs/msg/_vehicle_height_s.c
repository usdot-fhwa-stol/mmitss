...
bool j2735_v2x_msgs__msg__vehicle_height__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._vehicle_height.VehicleHeight", full_classname_dest, 48) == 0);
  }
  j2735_v2x_msgs__msg__VehicleHeight * ros_message = _ros_message;
  {  // vehicle_height
...
PyObject * j2735_v2x_msgs__msg__vehicle_height__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._vehicle_height");
  ...
  j2735_v2x_msgs__msg__VehicleHeight * ros_message = (j2735_v2x_msgs__msg__VehicleHeight *)raw_ros_message;
  {  // vehicle_height
    PyObject * field = NULL;
