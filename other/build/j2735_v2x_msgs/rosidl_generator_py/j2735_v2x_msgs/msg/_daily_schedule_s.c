...
bool j2735_v2x_msgs__msg__daily_schedule__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._daily_schedule.DailySchedule", full_classname_dest, 48) == 0);
  }
  j2735_v2x_msgs__msg__DailySchedule * ros_message = _ros_message;
  {  // begin
    ...
    ros_message->begin = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // duration
...
PyObject * j2735_v2x_msgs__msg__daily_schedule__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._daily_schedule");
  ...
  j2735_v2x_msgs__msg__DailySchedule * ros_message = (j2735_v2x_msgs__msg__DailySchedule *)raw_ros_message;
  {  // begin
    PyObject * field = NULL;
