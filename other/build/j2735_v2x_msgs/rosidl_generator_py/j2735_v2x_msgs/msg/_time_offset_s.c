...
bool j2735_v2x_msgs__msg__time_offset__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._time_offset.TimeOffset", full_classname_dest, 42) == 0);
  }
  j2735_v2x_msgs__msg__TimeOffset * ros_message = _ros_message;
  {  // offset
...
PyObject * j2735_v2x_msgs__msg__time_offset__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._time_offset");
  ...
  j2735_v2x_msgs__msg__TimeOffset * ros_message = (j2735_v2x_msgs__msg__TimeOffset *)raw_ros_message;
  {  // offset
    PyObject * field = NULL;
