...
class Metaclass_PivotPointDescription(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import OffsetB11
...
class PivotPointDescription(metaclass=Metaclass_PivotPointDescription):
    ...
    _fields_and_field_types = {
        'pivot_offset': 'j2735_v2x_msgs/OffsetB11',
        'pivot_angle': 'j2735_v2x_msgs/Angle',
        'pivots': 'j2735_v2x_msgs/PivotingAllowed',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'OffsetB11'),  # noqa: E501
