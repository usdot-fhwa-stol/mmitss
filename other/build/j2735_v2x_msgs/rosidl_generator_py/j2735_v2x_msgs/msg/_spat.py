...
class Metaclass_SPAT(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import IntersectionStateList
            if IntersectionStateList.__class__._TYPE_SUPPORT is None:
                IntersectionStateList.__class__.__import_type_support__()
...
class SPAT(metaclass=Metaclass_SPAT):
    ...
    _fields_and_field_types = {
        ...
        'name': 'string',
        'name_exists': 'boolean',
        'intersections': 'j2735_v2x_msgs/IntersectionStateList',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'IntersectionStateList'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from j2735_v2x_msgs.msg import IntersectionStateList
        self.intersections = kwargs.get('intersections', IntersectionStateList())
    ...
    def intersections(self, value):
        if __debug__:
            from j2735_v2x_msgs.msg import IntersectionStateList
            assert \
                isinstance(value, IntersectionStateList), \
                "The 'intersections' field must be a sub message of type 'IntersectionStateList'"
