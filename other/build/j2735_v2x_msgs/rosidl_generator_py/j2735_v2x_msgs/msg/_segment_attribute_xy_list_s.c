...
bool j2735_v2x_msgs__msg__segment_attribute_xy_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._segment_attribute_xy_list.SegmentAttributeXYList", full_classname_dest, 68) == 0);
  }
  j2735_v2x_msgs__msg__SegmentAttributeXYList * ros_message = _ros_message;
  {  // segment_attribute_xy
    PyObject * field = PyObject_GetAttrString(_pymsg, "segment_attribute_xy");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'segment_attribute_xy'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    j2735_v2x_msgs__msg__SegmentAttributeXY * dest = ros_message->segment_attribute_xy.data;
...
{
  /* NOTE(esteve): Call constructor of SegmentAttributeXYList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._segment_attribute_xy_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SegmentAttributeXYList");
  ...
  j2735_v2x_msgs__msg__SegmentAttributeXYList * ros_message = (j2735_v2x_msgs__msg__SegmentAttributeXYList *)raw_ros_message;
  {  // segment_attribute_xy
    PyObject * field = NULL;
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->segment_attribute_xy.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "segment_attribute_xy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
