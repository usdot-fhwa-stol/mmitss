...
bool j2735_v2x_msgs__msg__restriction_class_assignment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._restriction_class_assignment.RestrictionClassAssignment", full_classname_dest, 75) == 0);
  }
  j2735_v2x_msgs__msg__RestrictionClassAssignment * ros_message = _ros_message;
  {  // id
...
PyObject * j2735_v2x_msgs__msg__restriction_class_assignment__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._restriction_class_assignment");
  ...
  j2735_v2x_msgs__msg__RestrictionClassAssignment * ros_message = (j2735_v2x_msgs__msg__RestrictionClassAssignment *)raw_ros_message;
  {  // id
    PyObject * field = NULL;
