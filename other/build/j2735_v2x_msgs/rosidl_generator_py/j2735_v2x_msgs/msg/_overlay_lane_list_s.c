...
bool j2735_v2x_msgs__msg__overlay_lane_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._overlay_lane_list.OverlayLaneList", full_classname_dest, 53) == 0);
  }
  j2735_v2x_msgs__msg__OverlayLaneList * ros_message = _ros_message;
  {  // overlay_lane_list
...
{
  /* NOTE(esteve): Call constructor of OverlayLaneList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._overlay_lane_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OverlayLaneList");
  ...
  j2735_v2x_msgs__msg__OverlayLaneList * ros_message = (j2735_v2x_msgs__msg__OverlayLaneList *)raw_ros_message;
  {  // overlay_lane_list
    PyObject * field = NULL;
