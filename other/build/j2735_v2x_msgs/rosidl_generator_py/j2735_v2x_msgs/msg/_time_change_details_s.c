...
bool j2735_v2x_msgs__msg__time_change_details__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._time_change_details.TimeChangeDetails", full_classname_dest, 57) == 0);
  }
  j2735_v2x_msgs__msg__TimeChangeDetails * ros_message = _ros_message;
  {  // start_time
    ...
    ros_message->start_time = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // start_time_exists
  ...
  {  // max_end_time
    ...
    assert(PyLong_Check(field));
    ros_message->max_end_time = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // max_end_time_exists
  ...
  {  // likely_time
    ...
    assert(PyLong_Check(field));
    ros_message->likely_time = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // likely_time_exists
  ...
  {  // next_time
    ...
    assert(PyLong_Check(field));
    ros_message->next_time = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // next_time_exists
...
PyObject * j2735_v2x_msgs__msg__time_change_details__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._time_change_details");
  ...
  j2735_v2x_msgs__msg__TimeChangeDetails * ros_message = (j2735_v2x_msgs__msg__TimeChangeDetails *)raw_ros_message;
  {  // start_time
    PyObject * field = NULL;
  ...
  {  // max_end_time
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->max_end_time);
    {
  ...
  {  // likely_time
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->likely_time);
    {
  ...
  {  // next_time
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->next_time);
    {
