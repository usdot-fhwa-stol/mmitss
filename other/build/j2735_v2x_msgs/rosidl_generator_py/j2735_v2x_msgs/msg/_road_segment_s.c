...
bool j2735_v2x_msgs__msg__road_segment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._road_segment.RoadSegment", full_classname_dest, 44) == 0);
  }
  j2735_v2x_msgs__msg__RoadSegment * ros_message = _ros_message;
  {  // name
  ...
  {  // road_lane_set
    PyObject * field = PyObject_GetAttrString(_pymsg, "road_lane_set");
    if (!field) {
      return false;
    }
    if (!j2735_v2x_msgs__msg__road_lane_set_list__convert_from_py(field, &ros_message->road_lane_set)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j2735_v2x_msgs__msg__road_segment__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._road_segment");
  ...
  j2735_v2x_msgs__msg__RoadSegment * ros_message = (j2735_v2x_msgs__msg__RoadSegment *)raw_ros_message;
  {  // name
    PyObject * field = NULL;
  ...
  {  // road_lane_set
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__road_lane_set_list__convert_to_py(&ros_message->road_lane_set);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "road_lane_set", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
