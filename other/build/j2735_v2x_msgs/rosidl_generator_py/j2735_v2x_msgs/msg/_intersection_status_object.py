...
class IntersectionStatusObject(metaclass=Metaclass_IntersectionStatusObject):
    ...
    __slots__ = [
        '_intersection_status_object',
    ]

    _fields_and_field_types = {
        'intersection_status_object': 'uint16',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.intersection_status_object = kwargs.get('intersection_status_object', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.intersection_status_object != other.intersection_status_object:
            return False
        return True
    ...
    @property
    def intersection_status_object(self):
        """Message field 'intersection_status_object'."""
        return self._intersection_status_object

    @intersection_status_object.setter
    def intersection_status_object(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'intersection_status_object' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'intersection_status_object' field must be an unsigned integer in [0, 65535]"
        self._intersection_status_object = value
