...
class BumperHeight(metaclass=Metaclass_BumperHeight):
    ...
    def __init__(self, **kwargs):
        ...
        self.bumper_height = kwargs.get('bumper_height', int())
    ...
    def bumper_height(self, value):
        if __debug__:
            assert \
                ...
                "The 'bumper_height' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'bumper_height' field must be an unsigned integer in [0, 255]"
