...
bool j2735_v2x_msgs__msg__connects_to_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._connects_to_list.ConnectsToList", full_classname_dest, 51) == 0);
  }
  j2735_v2x_msgs__msg__ConnectsToList * ros_message = _ros_message;
  {  // connect_to_list
...
{
  /* NOTE(esteve): Call constructor of ConnectsToList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._connects_to_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConnectsToList");
  ...
  j2735_v2x_msgs__msg__ConnectsToList * ros_message = (j2735_v2x_msgs__msg__ConnectsToList *)raw_ros_message;
  {  // connect_to_list
    PyObject * field = NULL;
