...
bool j2735_v2x_msgs__msg__node_xy24b__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._node_xy24b.NodeXY24b", full_classname_dest, 40) == 0);
  }
  j2735_v2x_msgs__msg__NodeXY24b * ros_message = _ros_message;
  {  // x
...
PyObject * j2735_v2x_msgs__msg__node_xy24b__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._node_xy24b");
  ...
  j2735_v2x_msgs__msg__NodeXY24b * ros_message = (j2735_v2x_msgs__msg__NodeXY24b *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
