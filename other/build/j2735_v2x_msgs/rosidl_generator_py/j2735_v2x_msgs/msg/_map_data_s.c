...
bool j2735_v2x_msgs__msg__road_segment_list__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__road_segment_list__convert_to_py(void * raw_ros_message);
...
bool j2735_v2x_msgs__msg__restriction_class_list__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__restriction_class_list__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool j2735_v2x_msgs__msg__map_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._map_data.MapData", full_classname_dest, 36) == 0);
  }
  j2735_v2x_msgs__msg__MapData * ros_message = _ros_message;
  {  // header
  ...
  {  // intersections
    ...
    if (!j2735_v2x_msgs__msg__IntersectionGeometry__Sequence__init(&(ros_message->intersections), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create j2735_v2x_msgs__msg__IntersectionGeometry__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    j2735_v2x_msgs__msg__IntersectionGeometry * dest = ros_message->intersections.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!j2735_v2x_msgs__msg__intersection_geometry__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // road_segments
    PyObject * field = PyObject_GetAttrString(_pymsg, "road_segments");
    if (!field) {
      return false;
    }
    if (!j2735_v2x_msgs__msg__road_segment_list__convert_from_py(field, &ros_message->road_segments)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // restriction_list
    PyObject * field = PyObject_GetAttrString(_pymsg, "restriction_list");
    if (!field) {
      return false;
    }
    if (!j2735_v2x_msgs__msg__restriction_class_list__convert_from_py(field, &ros_message->restriction_list)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * j2735_v2x_msgs__msg__map_data__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MapData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._map_data");
  ...
  j2735_v2x_msgs__msg__MapData * ros_message = (j2735_v2x_msgs__msg__MapData *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // intersections
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = j2735_v2x_msgs__msg__intersection_geometry__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // road_segments
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__road_segment_list__convert_to_py(&ros_message->road_segments);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "road_segments", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // restriction_list
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__restriction_class_list__convert_to_py(&ros_message->restriction_list);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "restriction_list", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
