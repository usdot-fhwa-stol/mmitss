...
bool j2735_v2x_msgs__msg__advisory_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._advisory_speed.AdvisorySpeed", full_classname_dest, 48) == 0);
  }
  j2735_v2x_msgs__msg__AdvisorySpeed * ros_message = _ros_message;
  {  // type
...
PyObject * j2735_v2x_msgs__msg__advisory_speed__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._advisory_speed");
  ...
  j2735_v2x_msgs__msg__AdvisorySpeed * ros_message = (j2735_v2x_msgs__msg__AdvisorySpeed *)raw_ros_message;
  {  // type
    PyObject * field = NULL;
