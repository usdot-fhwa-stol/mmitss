...
bool j2735_v2x_msgs__msg__trailer_weight__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._trailer_weight.TrailerWeight", full_classname_dest, 48) == 0);
  }
  j2735_v2x_msgs__msg__TrailerWeight * ros_message = _ros_message;
  {  // trailer_weight
    ...
    ros_message->trailer_weight = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * j2735_v2x_msgs__msg__trailer_weight__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._trailer_weight");
  ...
  j2735_v2x_msgs__msg__TrailerWeight * ros_message = (j2735_v2x_msgs__msg__TrailerWeight *)raw_ros_message;
  {  // trailer_weight
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->trailer_weight);
    {
