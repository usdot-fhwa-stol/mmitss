...
class Metaclass_PSM(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import Velocity
...
class PSM(metaclass=Metaclass_PSM):
    ...
    _fields_and_field_types = {
        ...
        'position': 'j2735_v2x_msgs/Position3D',
        'accuracy': 'j2735_v2x_msgs/PositionalAccuracy',
        'speed': 'j2735_v2x_msgs/Velocity',
        ...
        'attachment_radius': 'j2735_v2x_msgs/AttachmentRadius',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'Velocity'),  # noqa: E501
