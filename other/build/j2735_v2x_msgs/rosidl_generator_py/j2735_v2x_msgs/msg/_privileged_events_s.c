...
bool j2735_v2x_msgs__msg__privileged_events__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._privileged_events.PrivilegedEvents", full_classname_dest, 54) == 0);
  }
  j2735_v2x_msgs__msg__PrivilegedEvents * ros_message = _ros_message;
  {  // ssp_index
  ...
  {  // event
    ...
    if (!j2735_v2x_msgs__msg__privileged_event_flags__convert_from_py(field, &ros_message->event)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j2735_v2x_msgs__msg__privileged_events__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._privileged_events");
  ...
  j2735_v2x_msgs__msg__PrivilegedEvents * ros_message = (j2735_v2x_msgs__msg__PrivilegedEvents *)raw_ros_message;
  {  // ssp_index
    PyObject * field = NULL;
  ...
  {  // event
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__privileged_event_flags__convert_to_py(&ros_message->event);
    if (!field) {
      return NULL;
    }
    {
