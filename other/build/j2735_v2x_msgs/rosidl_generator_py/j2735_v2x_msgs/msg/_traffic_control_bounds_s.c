...
bool j2735_v2x_msgs__msg__offset_point__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__offset_point__convert_to_py(void * raw_ros_message);
...
bool j2735_v2x_msgs__msg__traffic_control_bounds__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._traffic_control_bounds.TrafficControlBounds", full_classname_dest, 63) == 0);
  }
  j2735_v2x_msgs__msg__TrafficControlBounds * ros_message = _ros_message;
  {  // oldest
    ...
    ros_message->oldest = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // reflon
  ...
  {  // offsets
    ...
    Py_ssize_t size = 3;
    j2735_v2x_msgs__msg__OffsetPoint * dest = ros_message->offsets;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!j2735_v2x_msgs__msg__offset_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * j2735_v2x_msgs__msg__traffic_control_bounds__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._traffic_control_bounds");
  ...
  j2735_v2x_msgs__msg__TrafficControlBounds * ros_message = (j2735_v2x_msgs__msg__TrafficControlBounds *)raw_ros_message;
  {  // oldest
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->oldest);
    {
  ...
  {  // offsets
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = j2735_v2x_msgs__msg__offset_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
