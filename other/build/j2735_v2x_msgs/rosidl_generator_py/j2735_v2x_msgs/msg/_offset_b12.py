...
class Metaclass_OffsetB12(type):
    ...
    def OFFSET_MIN(self):
        ...
        return Metaclass_OffsetB12.__constants['OFFSET_MIN']

    @property
    def OFFSET_MAX(self):
        """Message constant 'OFFSET_MAX'."""
        return Metaclass_OffsetB12.__constants['OFFSET_MAX']

    @property
    def OFFSET_UNKNOWN(self):
        """Message constant 'OFFSET_UNKNOWN'."""
        return Metaclass_OffsetB12.__constants['OFFSET_UNKNOWN']
