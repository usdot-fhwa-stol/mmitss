...
bool j2735_v2x_msgs__msg__time_confidence__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._time_confidence.TimeConfidence", full_classname_dest, 50) == 0);
  }
  j2735_v2x_msgs__msg__TimeConfidence * ros_message = _ros_message;
  {  // confidence
...
{
  /* NOTE(esteve): Call constructor of TimeConfidence */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._time_confidence");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TimeConfidence");
  ...
  j2735_v2x_msgs__msg__TimeConfidence * ros_message = (j2735_v2x_msgs__msg__TimeConfidence *)raw_ros_message;
  {  // confidence
    PyObject * field = NULL;
