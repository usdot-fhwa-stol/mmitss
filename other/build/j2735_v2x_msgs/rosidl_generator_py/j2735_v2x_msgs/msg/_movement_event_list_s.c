...
bool j2735_v2x_msgs__msg__movement_event_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._movement_event_list.MovementEventList", full_classname_dest, 57) == 0);
  }
  j2735_v2x_msgs__msg__MovementEventList * ros_message = _ros_message;
  {  // movement_event_list
    ...
    if (!j2735_v2x_msgs__msg__MovementEvent__Sequence__init(&(ros_message->movement_event_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create j2735_v2x_msgs__msg__MovementEvent__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    j2735_v2x_msgs__msg__MovementEvent * dest = ros_message->movement_event_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!j2735_v2x_msgs__msg__movement_event__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of MovementEventList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._movement_event_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MovementEventList");
  ...
  j2735_v2x_msgs__msg__MovementEventList * ros_message = (j2735_v2x_msgs__msg__MovementEventList *)raw_ros_message;
  {  // movement_event_list
    PyObject * field = NULL;
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = j2735_v2x_msgs__msg__movement_event__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
