...
bool j2735_v2x_msgs__msg__offset_b12__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._offset_b12.OffsetB12", full_classname_dest, 40) == 0);
  }
  j2735_v2x_msgs__msg__OffsetB12 * ros_message = _ros_message;
  {  // offset
...
PyObject * j2735_v2x_msgs__msg__offset_b12__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._offset_b12");
  ...
  j2735_v2x_msgs__msg__OffsetB12 * ros_message = (j2735_v2x_msgs__msg__OffsetB12 *)raw_ros_message;
  {  // offset
    PyObject * field = NULL;
