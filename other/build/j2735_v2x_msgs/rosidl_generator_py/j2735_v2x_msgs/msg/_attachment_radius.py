...
class AttachmentRadius(metaclass=Metaclass_AttachmentRadius):
    ...
    def __init__(self, **kwargs):
        ...
        self.attachment_radius = kwargs.get('attachment_radius', int())
    ...
    def attachment_radius(self, value):
        if __debug__:
            assert \
                ...
                "The 'attachment_radius' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'attachment_radius' field must be an unsigned integer in [0, 255]"
