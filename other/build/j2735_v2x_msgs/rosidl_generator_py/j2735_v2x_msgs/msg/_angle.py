...
class Metaclass_Angle(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ANGLE_UNAVAILABLE': cls.__constants['ANGLE_UNAVAILABLE'],
            'ANGLE_MAX': cls.__constants['ANGLE_MAX'],
            'ANGLE_MIN': cls.__constants['ANGLE_MIN'],
        }

    @property
    def ANGLE_UNAVAILABLE(self):
        """Message constant 'ANGLE_UNAVAILABLE'."""
        return Metaclass_Angle.__constants['ANGLE_UNAVAILABLE']

    @property
    def ANGLE_MAX(self):
        """Message constant 'ANGLE_MAX'."""
        return Metaclass_Angle.__constants['ANGLE_MAX']

    @property
    def ANGLE_MIN(self):
        """Message constant 'ANGLE_MIN'."""
        return Metaclass_Angle.__constants['ANGLE_MIN']
