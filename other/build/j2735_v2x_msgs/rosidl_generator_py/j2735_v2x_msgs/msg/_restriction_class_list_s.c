...
bool j2735_v2x_msgs__msg__restriction_class_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._restriction_class_list.RestrictionClassList", full_classname_dest, 63) == 0);
  }
  j2735_v2x_msgs__msg__RestrictionClassList * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of RestrictionClassList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._restriction_class_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RestrictionClassList");
  ...
  j2735_v2x_msgs__msg__RestrictionClassList * ros_message = (j2735_v2x_msgs__msg__RestrictionClassList *)raw_ros_message;
  {  // restriction_class_list
    PyObject * field = NULL;
