...
class NodeXY(metaclass=Metaclass_NodeXY):
    ...
    _fields_and_field_types = {
        'delta': 'j2735_v2x_msgs/NodeOffsetPointXY',
        'attributes': 'j2735_v2x_msgs/NodeAttributeSetXY',
        'attributes_exists': 'boolean',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'NodeOffsetPointXY'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'NodeAttributeSetXY'),  # noqa: E501
