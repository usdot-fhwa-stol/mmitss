...
static rosidl_typesupport_introspection_c__MessageMember RoadSegmentReferenceID__rosidl_typesupport_introspection_c__RoadSegmentReferenceID_message_member_array[4] = {
  {
    "region",  // name
