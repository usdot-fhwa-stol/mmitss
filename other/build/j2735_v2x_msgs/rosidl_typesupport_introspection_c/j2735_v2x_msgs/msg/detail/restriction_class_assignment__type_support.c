...
static rosidl_typesupport_introspection_c__MessageMember RestrictionClassAssignment__rosidl_typesupport_introspection_c__RestrictionClassAssignment_message_member_array[1] = {
  {
    "id",  // name
