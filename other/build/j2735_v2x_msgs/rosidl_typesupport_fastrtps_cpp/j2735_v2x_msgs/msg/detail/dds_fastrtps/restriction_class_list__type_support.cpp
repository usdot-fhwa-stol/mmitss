...
#include "j2735_v2x_msgs/msg/detail/restriction_class_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::RestrictionClassList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::RestrictionClassList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RestrictionClassList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::RestrictionClassList *>(
...
{
  return max_serialized_size_RestrictionClassList(full_bounded, 0);
}

static message_type_support_callbacks_t _RestrictionClassList__callbacks = {
  "j2735_v2x_msgs::msg",
...
static rosidl_message_type_support_t _RestrictionClassList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RestrictionClassList__callbacks,
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_RestrictionClassList__handle;
}
