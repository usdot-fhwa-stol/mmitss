...
#include "j2735_v2x_msgs/msg/detail/path_history_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::OffsetLLB18 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::OffsetLLB18 &);
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::VertOffsetB12 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::VertOffsetB12 &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::VertOffsetB12 &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::TimeOffset &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::TimeOffset &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::TimeOffset &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::CoarseHeading &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::CoarseHeading &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::CoarseHeading &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: lat_offset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_OffsetLLB18(
  ...
  // Member: elevation_offset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VertOffsetB12(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: time_offset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TimeOffset(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: heading
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CoarseHeading(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::PathHistoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::PathHistoryPoint *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_PathHistoryPoint__handle;
}
