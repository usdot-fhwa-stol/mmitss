...
#include "j2735_v2x_msgs/msg/detail/traffic_control_request_v01__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::TrafficControlBounds &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: bounds
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficControlBounds(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::TrafficControlRequestV01 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::TrafficControlRequestV01 *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlRequestV01__handle;
}
