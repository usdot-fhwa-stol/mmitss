...
#include "j2735_v2x_msgs/msg/detail/bsm_part_ii_extension__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::VehicleSafetyExtensions &,
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::SpecialVehicleExtensions &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::SupplementalVehicleExtensions &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: vehicle_safety_extensions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VehicleSafetyExtensions(
  ...
  // Member: special_vehicle_extensions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SpecialVehicleExtensions(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: supplemental_vehicle_extensions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SupplementalVehicleExtensions(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::BSMPartIIExtension *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::BSMPartIIExtension *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_BSMPartIIExtension__handle;
}
