...
#include "j2735_v2x_msgs/msg/detail/rtcm_header__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::OffsetB09 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::OffsetB09 &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::OffsetB09 &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::OffsetB10 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::OffsetB10 &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::OffsetB10 &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: ant_offset_y
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_OffsetB09(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: ant_offset_z
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_OffsetB10(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::RTCMHeader *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::RTCMHeader *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_RTCMHeader__handle;
}
