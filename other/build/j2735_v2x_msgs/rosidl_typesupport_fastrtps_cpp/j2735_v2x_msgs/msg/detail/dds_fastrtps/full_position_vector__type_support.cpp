...
#include "j2735_v2x_msgs/msg/detail/full_position_vector__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::Longitude &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::Longitude &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::Longitude &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::Latitude &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::Latitude &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::Latitude &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::Elevation &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::Elevation &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::Elevation &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::TransmissionAndSpeed &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::TransmissionAndSpeed &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::TransmissionAndSpeed &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::SpeedandHeadingandThrottleConfidence &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::SpeedandHeadingandThrottleConfidence &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::SpeedandHeadingandThrottleConfidence &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: lon
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Longitude(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: lat
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Latitude(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: elevation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Elevation(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TransmissionAndSpeed(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: speed_confidence
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SpeedandHeadingandThrottleConfidence(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::FullPositionVector *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::FullPositionVector *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_FullPositionVector__handle;
}
