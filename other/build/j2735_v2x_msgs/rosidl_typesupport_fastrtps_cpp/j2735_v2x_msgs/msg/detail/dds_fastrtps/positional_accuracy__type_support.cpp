...
#include "j2735_v2x_msgs/msg/detail/positional_accuracy__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::PositionalAccuracy *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::PositionalAccuracy *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_PositionalAccuracy__handle;
}
