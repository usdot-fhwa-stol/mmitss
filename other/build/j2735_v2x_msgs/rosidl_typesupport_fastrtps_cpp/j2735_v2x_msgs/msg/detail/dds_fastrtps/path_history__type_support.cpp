...
#include "j2735_v2x_msgs/msg/detail/path_history__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::PathHistoryPointList &,
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::FullPositionVector &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: crumb_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PathHistoryPointList(
  ...
  // Member: initial_position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_FullPositionVector(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::PathHistory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::PathHistory *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_PathHistory__handle;
}
