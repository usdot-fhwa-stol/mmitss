...
#include "j2735_v2x_msgs/msg/detail/intersection_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::EnabledLaneList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::EnabledLaneList &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::EnabledLaneList &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::MovementList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::MovementList &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::MovementList &,
  size_t current_alignment);
size_t
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.maneuever_assist_list,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: enabled_lanes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_EnabledLaneList(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MovementList(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::IntersectionState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::IntersectionState *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_IntersectionState__handle;
}
