...
#include "j2735_v2x_msgs/msg/detail/transmission_and_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::Velocity &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Velocity(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::TransmissionAndSpeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::TransmissionAndSpeed *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_TransmissionAndSpeed__handle;
}
