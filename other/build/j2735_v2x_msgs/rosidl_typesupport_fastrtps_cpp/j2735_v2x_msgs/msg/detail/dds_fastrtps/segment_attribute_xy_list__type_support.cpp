...
#include "j2735_v2x_msgs/msg/detail/segment_attribute_xy_list__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  // Member: segment_attribute_xy
  {
    ...
    for (size_t i = 0; i < size; i++) {
      j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.segment_attribute_xy[i],
        cdr);
    }
  }
  return true;
  ...
  j2735_v2x_msgs::msg::SegmentAttributeXYList & ros_message)
{
  // Member: segment_attribute_xy
  {
    ...
    ros_message.segment_attribute_xy.resize(size);
    for (size_t i = 0; i < size; i++) {
      j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.segment_attribute_xy[i]);
    }
  }
  ...
  // Member: segment_attribute_xy
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.segment_attribute_xy[index], current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::SegmentAttributeXYList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::SegmentAttributeXYList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SegmentAttributeXYList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::SegmentAttributeXYList *>(
...
{
  return max_serialized_size_SegmentAttributeXYList(full_bounded, 0);
}

static message_type_support_callbacks_t _SegmentAttributeXYList__callbacks = {
  "j2735_v2x_msgs::msg",
...
static rosidl_message_type_support_t _SegmentAttributeXYList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SegmentAttributeXYList__callbacks,
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_SegmentAttributeXYList__handle;
}
