...
#include "j2735_v2x_msgs/msg/detail/bumper_heights__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::BumperHeight &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::BumperHeight &);
  ...
  size_t current_alignment)
{
  ...
  // Member: front
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BumperHeight(
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::BumperHeights *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::BumperHeights *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_BumperHeights__handle;
}
