...
#include "j2735_v2x_msgs/msg/detail/traffic_control_bounds__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::OffsetPoint &,
  ...
  size_t current_alignment)
{
  ...
  // Member: offsets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_OffsetPoint(
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::TrafficControlBounds *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::TrafficControlBounds *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_TrafficControlBounds__handle;
}
