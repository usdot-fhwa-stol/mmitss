...
#include "j2735_v2x_msgs/msg/detail/path_history_point_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::PathHistoryPoint &,
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PathHistoryPoint(
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::PathHistoryPointList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::PathHistoryPointList *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_PathHistoryPointList__handle;
}
