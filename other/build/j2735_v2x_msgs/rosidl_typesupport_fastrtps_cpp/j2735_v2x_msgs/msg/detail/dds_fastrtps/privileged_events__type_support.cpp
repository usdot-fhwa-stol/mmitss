...
#include "j2735_v2x_msgs/msg/detail/privileged_events__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::PrivilegedEventFlags &,
  ...
  size_t current_alignment)
{
  ...
  // Member: event
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PrivilegedEventFlags(
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::PrivilegedEvents *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::PrivilegedEvents *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_PrivilegedEvents__handle;
}
