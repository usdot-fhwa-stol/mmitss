...
#include "j2735_v2x_msgs/msg/detail/intersection_geometry__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::SpeedLimitList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::SpeedLimitList &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::SpeedLimitList &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::LaneList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  j2735_v2x_msgs::msg::LaneList &);
size_t get_serialized_size(
  const j2735_v2x_msgs::msg::LaneList &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::PreemptPriorityList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: lane_set
  j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.lane_set,
    cdr);
  // Member: preempt_priority_data
  j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.preempt_priority_data,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: speed_limits
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SpeedLimitList(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: lane_set
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_LaneList(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: preempt_priority_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PreemptPriorityList(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::IntersectionGeometry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::IntersectionGeometry *>(
    untyped_ros_message);
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_IntersectionGeometry__handle;
}
