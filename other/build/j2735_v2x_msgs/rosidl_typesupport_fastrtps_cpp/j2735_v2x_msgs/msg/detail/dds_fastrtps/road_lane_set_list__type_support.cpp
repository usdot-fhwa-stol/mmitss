...
#include "j2735_v2x_msgs/msg/detail/road_lane_set_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const j2735_v2x_msgs::msg::GenericLane &,
  ...
  size_t current_alignment)
{
  ...
  // Member: road_lane_set_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_GenericLane(
...
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::RoadLaneSetList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<j2735_v2x_msgs::msg::RoadLaneSetList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RoadLaneSetList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const j2735_v2x_msgs::msg::RoadLaneSetList *>(
...
{
  return max_serialized_size_RoadLaneSetList(full_bounded, 0);
}

static message_type_support_callbacks_t _RoadLaneSetList__callbacks = {
  "j2735_v2x_msgs::msg",
  "RoadLaneSetList",
...
static rosidl_message_type_support_t _RoadLaneSetList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RoadLaneSetList__callbacks,
...
{
  return &j2735_v2x_msgs::msg::typesupport_fastrtps_cpp::_RoadLaneSetList__handle;
}
