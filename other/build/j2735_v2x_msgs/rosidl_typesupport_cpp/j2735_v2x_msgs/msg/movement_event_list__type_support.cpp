...
static const _MovementEventList_type_support_symbol_names_t _MovementEventList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, j2735_v2x_msgs, msg, MovementEventList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, MovementEventList)),
  }
};
...
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_cpp::MovementEventList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, j2735_v2x_msgs, msg, MovementEventList)() {
  return get_message_type_support_handle<j2735_v2x_msgs::msg::MovementEventList>();
}
