...
static const _LaneAttributesParking_type_support_symbol_names_t _LaneAttributesParking_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, j2735_v2x_msgs, msg, LaneAttributesParking)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, j2735_v2x_msgs, msg, LaneAttributesParking)),
  }
};
...
{
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_cpp::LaneAttributesParking_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, j2735_v2x_msgs, msg, LaneAttributesParking)() {
  return get_message_type_support_handle<j2735_v2x_msgs::msg::LaneAttributesParking>();
}
