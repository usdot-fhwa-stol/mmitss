...
#include "j2735_v2x_msgs/msg/detail/lane_attributes_striping__rosidl_typesupport_fastrtps_c.h"
...
using _LaneAttributesStriping__ros_msg_type = j2735_v2x_msgs__msg__LaneAttributesStriping;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LaneAttributesStriping__ros_msg_type * ros_message = static_cast<const _LaneAttributesStriping__ros_msg_type *>(untyped_ros_message);
  // Field name: lane_attributes_striping
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LaneAttributesStriping__ros_msg_type * ros_message = static_cast<_LaneAttributesStriping__ros_msg_type *>(untyped_ros_message);
  // Field name: lane_attributes_striping
  {
    cdr >> ros_message->lane_attributes_striping;
  }
...
static uint32_t _LaneAttributesStriping__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__LaneAttributesStriping(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__LaneAttributesStriping(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_LaneAttributesStriping = {
  "j2735_v2x_msgs::msg",
...
static rosidl_message_type_support_t _LaneAttributesStriping__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LaneAttributesStriping,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, LaneAttributesStriping)() {
  return &_LaneAttributesStriping__type_support;
}
