...
#include "j2735_v2x_msgs/msg/detail/maneuver_assist_list__rosidl_typesupport_fastrtps_c.h"
...
using _ManeuverAssistList__ros_msg_type = j2735_v2x_msgs__msg__ManeuverAssistList;

static bool _ManeuverAssistList__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ManeuverAssistList__ros_msg_type * ros_message = static_cast<const _ManeuverAssistList__ros_msg_type *>(untyped_ros_message);
...
static bool _ManeuverAssistList__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ManeuverAssistList__ros_msg_type * ros_message = static_cast<_ManeuverAssistList__ros_msg_type *>(untyped_ros_message);
  // Field name: connection_maneuver_assist_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ManeuverAssistList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__ManeuverAssistList(
...
static size_t _ManeuverAssistList__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_j2735_v2x_msgs__msg__ManeuverAssistList(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ManeuverAssistList = {
  "j2735_v2x_msgs::msg",
  "ManeuverAssistList",
  _ManeuverAssistList__cdr_serialize,
  _ManeuverAssistList__cdr_deserialize,
  _ManeuverAssistList__get_serialized_size,
  _ManeuverAssistList__max_serialized_size
};

static rosidl_message_type_support_t _ManeuverAssistList__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ManeuverAssistList,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, ManeuverAssistList)() {
  return &_ManeuverAssistList__type_support;
}
