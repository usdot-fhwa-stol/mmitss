...
#include "j2735_v2x_msgs/msg/detail/traffic_control_message__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/traffic_control_message_v01__functions.h"  // tcm_v01
...
using _TrafficControlMessage__ros_msg_type = j2735_v2x_msgs__msg__TrafficControlMessage;
  ...
  // Field name: tcm_v01
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, TrafficControlMessageV01
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__TrafficControlMessageV01(
...
static uint32_t _TrafficControlMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__TrafficControlMessage(
  ...
  size_t current_alignment)
{
  ...
  // member: tcm_v01
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__TrafficControlMessageV01(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__TrafficControlMessage(
    full_bounded, 0);
}
