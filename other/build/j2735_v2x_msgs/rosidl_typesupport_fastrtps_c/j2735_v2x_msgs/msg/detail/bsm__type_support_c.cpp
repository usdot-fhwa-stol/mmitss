...
#include "j2735_v2x_msgs/msg/detail/bsm__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/bsm_core_data__functions.h"  // core_data
#include "j2735_v2x_msgs/msg/detail/bsm_part_ii_extension__functions.h"  // part_ii
#include "j2735_v2x_msgs/msg/detail/bsm_regional_extension__functions.h"  // regional
...
using _BSM__ros_msg_type = j2735_v2x_msgs__msg__BSM;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: core_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, BSMCoreData
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: part_ii
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, BSMPartIIExtension
      )()->data);
  ...
  // Field name: regional
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, BSMRegionalExtension
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: part_ii
  {
    ...
    if (ros_message->part_ii.data) {
      j2735_v2x_msgs__msg__BSMPartIIExtension__Sequence__fini(&ros_message->part_ii);
    }
  ...
  // Field name: regional
  {
    ...
    if (ros_message->regional.data) {
      j2735_v2x_msgs__msg__BSMRegionalExtension__Sequence__fini(&ros_message->regional);
    }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__BSMCoreData(
  ...
  // field.name part_ii
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_j2735_v2x_msgs__msg__BSMPartIIExtension(
  ...
  // field.name regional
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_j2735_v2x_msgs__msg__BSMRegionalExtension(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _BSM__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__BSM(
  ...
  size_t current_alignment)
{
  ...
  // member: core_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__BSMCoreData(
        full_bounded, current_alignment);
    }
  }
  ...
  // member: part_ii
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__BSMPartIIExtension(
        full_bounded, current_alignment);
    }
  }
  // member: regional
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__BSMRegionalExtension(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__BSM(
    full_bounded, 0);
}
