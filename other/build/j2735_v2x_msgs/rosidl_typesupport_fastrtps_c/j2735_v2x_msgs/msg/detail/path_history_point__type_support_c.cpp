...
#include "j2735_v2x_msgs/msg/detail/path_history_point__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/coarse_heading__functions.h"  // heading
#include "j2735_v2x_msgs/msg/detail/offset_llb18__functions.h"  // lat_offset, lon_offset
#include "j2735_v2x_msgs/msg/detail/positional_accuracy__functions.h"  // pos_accuracy
#include "j2735_v2x_msgs/msg/detail/speed__functions.h"  // speed
#include "j2735_v2x_msgs/msg/detail/time_offset__functions.h"  // time_offset
#include "j2735_v2x_msgs/msg/detail/vert_offset_b12__functions.h"  // elevation_offset
...
using _PathHistoryPoint__ros_msg_type = j2735_v2x_msgs__msg__PathHistoryPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lat_offset
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, OffsetLLB18
      )()->data);
  ...
  // Field name: elevation_offset
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, VertOffsetB12
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: time_offset
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, TimeOffset
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: heading
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, CoarseHeading
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__OffsetLLB18(
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__VertOffsetB12(
    &(ros_message->elevation_offset), current_alignment);
  // field.name time_offset

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__TimeOffset(
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__CoarseHeading(
...
static uint32_t _PathHistoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__PathHistoryPoint(
  ...
  size_t current_alignment)
{
  ...
  // member: lat_offset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__OffsetLLB18(
  ...
  // member: elevation_offset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__VertOffsetB12(
        full_bounded, current_alignment);
    }
  }
  // member: time_offset
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__TimeOffset(
        full_bounded, current_alignment);
    }
  }
  // member: speed
  ...
  // member: heading
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__CoarseHeading(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__PathHistoryPoint(
    full_bounded, 0);
}
