...
#include "j2735_v2x_msgs/msg/detail/bumper_height__rosidl_typesupport_fastrtps_c.h"
...
using _BumperHeight__ros_msg_type = j2735_v2x_msgs__msg__BumperHeight;
...
static uint32_t _BumperHeight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__BumperHeight(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__BumperHeight(
    full_bounded, 0);
}
