...
#include "j2735_v2x_msgs/msg/detail/lane_list__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/generic_lane__functions.h"  // lane_list
...
using _LaneList__ros_msg_type = j2735_v2x_msgs__msg__LaneList;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: lane_list
  {
    ...
    if (ros_message->lane_list.data) {
      j2735_v2x_msgs__msg__GenericLane__Sequence__fini(&ros_message->lane_list);
    }
...
static uint32_t _LaneList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__LaneList(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__LaneList(
    full_bounded, 0);
}
