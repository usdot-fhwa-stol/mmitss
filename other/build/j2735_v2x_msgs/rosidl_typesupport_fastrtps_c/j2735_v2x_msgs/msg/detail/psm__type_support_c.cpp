...
#include "j2735_v2x_msgs/msg/detail/psm__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/attachment_radius__functions.h"  // attachment_radius
...
#include "j2735_v2x_msgs/msg/detail/path_history__functions.h"  // path_history
#include "j2735_v2x_msgs/msg/detail/path_prediction__functions.h"  // path_prediction
...
#include "j2735_v2x_msgs/msg/detail/position3_d__functions.h"  // position
...
#include "j2735_v2x_msgs/msg/detail/velocity__functions.h"  // speed
...
using _PSM__ros_msg_type = j2735_v2x_msgs__msg__PSM;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: speed
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, Velocity
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: path_history
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, PathHistory
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: path_prediction
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, PathPrediction
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__Velocity(
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__PathHistory(
    &(ros_message->path_history), current_alignment);
  // field.name path_prediction

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__PathPrediction(
...
static uint32_t _PSM__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__PSM(
  ...
  size_t current_alignment)
{
  ...
  // member: speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__Velocity(
        full_bounded, current_alignment);
    }
  }
  // member: heading
  ...
  // member: path_history
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__PathHistory(
        full_bounded, current_alignment);
    }
  }
  // member: path_prediction
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__PathPrediction(
        full_bounded, current_alignment);
    }
  }
  // member: propulsion
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__PSM(
    full_bounded, 0);
}
