...
#include "j2735_v2x_msgs/msg/detail/computed_lane__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/offset_xaxis__functions.h"  // offset_x_axis
#include "j2735_v2x_msgs/msg/detail/offset_yaxis__functions.h"  // offset_y_axis
...
using _ComputedLane__ros_msg_type = j2735_v2x_msgs__msg__ComputedLane;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: offset_x_axis
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, OffsetXaxis
      )()->data);
  ...
  // Field name: offset_y_axis
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, OffsetYaxis
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__OffsetXaxis(
    &(ros_message->offset_x_axis), current_alignment);
  // field.name offset_y_axis

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__OffsetYaxis(
...
static uint32_t _ComputedLane__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__ComputedLane(
  ...
  size_t current_alignment)
{
  ...
  // member: offset_x_axis
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__OffsetXaxis(
  ...
  // member: offset_y_axis
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__OffsetYaxis(
        full_bounded, current_alignment);
    }
  }
  // member: rotate_xy
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__ComputedLane(
    full_bounded, 0);
}
