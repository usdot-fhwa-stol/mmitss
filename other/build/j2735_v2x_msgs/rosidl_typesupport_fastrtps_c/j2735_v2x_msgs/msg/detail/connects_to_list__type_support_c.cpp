...
#include "j2735_v2x_msgs/msg/detail/connects_to_list__rosidl_typesupport_fastrtps_c.h"
...
using _ConnectsToList__ros_msg_type = j2735_v2x_msgs__msg__ConnectsToList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ConnectsToList__ros_msg_type * ros_message = static_cast<const _ConnectsToList__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _ConnectsToList__ros_msg_type * ros_message = static_cast<_ConnectsToList__ros_msg_type *>(untyped_ros_message);
  // Field name: connect_to_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ConnectsToList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__ConnectsToList(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__ConnectsToList(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ConnectsToList = {
  "j2735_v2x_msgs::msg",
  "ConnectsToList",
...
static rosidl_message_type_support_t _ConnectsToList__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ConnectsToList,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, ConnectsToList)() {
  return &_ConnectsToList__type_support;
}
