...
#include "j2735_v2x_msgs/msg/detail/traffic_control_request__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/traffic_control_request_v01__functions.h"  // tcr_v01
...
using _TrafficControlRequest__ros_msg_type = j2735_v2x_msgs__msg__TrafficControlRequest;
  ...
  // Field name: tcr_v01
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, TrafficControlRequestV01
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__TrafficControlRequestV01(
...
static uint32_t _TrafficControlRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__TrafficControlRequest(
  ...
  size_t current_alignment)
{
  ...
  // member: tcr_v01
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__TrafficControlRequestV01(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__TrafficControlRequest(
    full_bounded, 0);
}
