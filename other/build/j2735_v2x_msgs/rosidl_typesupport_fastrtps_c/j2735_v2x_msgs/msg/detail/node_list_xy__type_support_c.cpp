...
#include "j2735_v2x_msgs/msg/detail/node_list_xy__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/computed_lane__functions.h"  // computed
#include "j2735_v2x_msgs/msg/detail/node_set_xy__functions.h"  // nodes
...
using _NodeListXY__ros_msg_type = j2735_v2x_msgs__msg__NodeListXY;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: nodes
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, NodeSetXY
      )()->data);
  ...
  // Field name: computed
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, ComputedLane
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__NodeSetXY(
    &(ros_message->nodes), current_alignment);
  // field.name computed

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__ComputedLane(
...
static uint32_t _NodeListXY__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__NodeListXY(
  ...
  size_t current_alignment)
{
  ...
  // member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__NodeSetXY(
  ...
  // member: computed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__ComputedLane(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__NodeListXY(
    full_bounded, 0);
}
