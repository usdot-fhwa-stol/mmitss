...
#include "j2735_v2x_msgs/msg/detail/regional_extension__rosidl_typesupport_fastrtps_c.h"
...
using _RegionalExtension__ros_msg_type = j2735_v2x_msgs__msg__RegionalExtension;
...
static uint32_t _RegionalExtension__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__RegionalExtension(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__RegionalExtension(
    full_bounded, 0);
}
