...
#include "j2735_v2x_msgs/msg/detail/trailer_mass__rosidl_typesupport_fastrtps_c.h"
...
using _TrailerMass__ros_msg_type = j2735_v2x_msgs__msg__TrailerMass;
...
static uint32_t _TrailerMass__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__TrailerMass(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__TrailerMass(
    full_bounded, 0);
}
