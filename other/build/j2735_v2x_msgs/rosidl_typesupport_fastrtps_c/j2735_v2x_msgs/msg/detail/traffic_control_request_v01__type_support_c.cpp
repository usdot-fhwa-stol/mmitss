...
#include "j2735_v2x_msgs/msg/detail/traffic_control_request_v01__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/traffic_control_bounds__functions.h"  // bounds
...
using _TrafficControlRequestV01__ros_msg_type = j2735_v2x_msgs__msg__TrafficControlRequestV01;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bounds
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, TrafficControlBounds
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: bounds
  {
    ...
    if (ros_message->bounds.data) {
      j2735_v2x_msgs__msg__TrafficControlBounds__Sequence__fini(&ros_message->bounds);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name bounds
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_j2735_v2x_msgs__msg__TrafficControlBounds(
...
static uint32_t _TrafficControlRequestV01__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__TrafficControlRequestV01(
  ...
  size_t current_alignment)
{
  ...
  // member: bounds
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__TrafficControlBounds(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__TrafficControlRequestV01(
    full_bounded, 0);
}
