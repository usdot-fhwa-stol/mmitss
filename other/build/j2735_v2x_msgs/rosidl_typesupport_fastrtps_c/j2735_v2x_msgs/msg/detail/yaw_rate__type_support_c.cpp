...
#include "j2735_v2x_msgs/msg/detail/yaw_rate__rosidl_typesupport_fastrtps_c.h"
...
using _YawRate__ros_msg_type = j2735_v2x_msgs__msg__YawRate;
...
static uint32_t _YawRate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__YawRate(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__YawRate(
    full_bounded, 0);
}
