...
#include "j2735_v2x_msgs/msg/detail/traffic_control_params__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/traffic_control_detail__functions.h"  // detail
#include "j2735_v2x_msgs/msg/detail/traffic_control_schedule__functions.h"  // schedule
...
using _TrafficControlParams__ros_msg_type = j2735_v2x_msgs__msg__TrafficControlParams;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: schedule
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, TrafficControlSchedule
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: detail
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, TrafficControlDetail
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__TrafficControlSchedule(
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__TrafficControlDetail(
...
static uint32_t _TrafficControlParams__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__TrafficControlParams(
  ...
  size_t current_alignment)
{
  ...
  // member: schedule
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__TrafficControlSchedule(
        full_bounded, current_alignment);
    }
  }
  // member: regulatory
  ...
  // member: detail
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__TrafficControlDetail(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__TrafficControlParams(
    full_bounded, 0);
}
