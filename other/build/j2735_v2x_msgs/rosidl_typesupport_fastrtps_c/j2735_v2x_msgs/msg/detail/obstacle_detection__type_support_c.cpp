...
#include "j2735_v2x_msgs/msg/detail/obstacle_detection__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/obstacle_direction__functions.h"  // ob_direct
#include "j2735_v2x_msgs/msg/detail/obstacle_distance__functions.h"  // ob_dist
...
using _ObstacleDetection__ros_msg_type = j2735_v2x_msgs__msg__ObstacleDetection;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ob_dist
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, ObstacleDistance
      )()->data);
  ...
  // Field name: ob_direct
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, ObstacleDirection
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__ObstacleDistance(
    &(ros_message->ob_dist), current_alignment);
  // field.name ob_direct

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__ObstacleDirection(
...
static uint32_t _ObstacleDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__ObstacleDetection(
  ...
  size_t current_alignment)
{
  ...
  // member: ob_dist
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__ObstacleDistance(
  ...
  // member: ob_direct
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__ObstacleDirection(
        full_bounded, current_alignment);
    }
  }
  // member: date_time
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__ObstacleDetection(
    full_bounded, 0);
}
