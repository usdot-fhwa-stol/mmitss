...
#include "j2735_v2x_msgs/msg/detail/personal_crossing_in_progress__rosidl_typesupport_fastrtps_c.h"
...
using _PersonalCrossingInProgress__ros_msg_type = j2735_v2x_msgs__msg__PersonalCrossingInProgress;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PersonalCrossingInProgress__ros_msg_type * ros_message = static_cast<const _PersonalCrossingInProgress__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _PersonalCrossingInProgress__ros_msg_type * ros_message = static_cast<_PersonalCrossingInProgress__ros_msg_type *>(untyped_ros_message);
  // Field name: cross_state
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _PersonalCrossingInProgress__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__PersonalCrossingInProgress(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__PersonalCrossingInProgress(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_PersonalCrossingInProgress = {
  "j2735_v2x_msgs::msg",
...
static rosidl_message_type_support_t _PersonalCrossingInProgress__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PersonalCrossingInProgress,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, PersonalCrossingInProgress)() {
  return &_PersonalCrossingInProgress__type_support;
}
