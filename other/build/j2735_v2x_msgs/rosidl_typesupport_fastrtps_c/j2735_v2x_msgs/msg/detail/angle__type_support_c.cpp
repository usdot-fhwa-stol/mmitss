...
#include "j2735_v2x_msgs/msg/detail/angle__rosidl_typesupport_fastrtps_c.h"
...
using _Angle__ros_msg_type = j2735_v2x_msgs__msg__Angle;
...
static uint32_t _Angle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__Angle(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__Angle(
    full_bounded, 0);
}
