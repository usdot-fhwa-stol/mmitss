...
#include "j2735_v2x_msgs/msg/detail/allowed_maneuvers__rosidl_typesupport_fastrtps_c.h"
...
using _AllowedManeuvers__ros_msg_type = j2735_v2x_msgs__msg__AllowedManeuvers;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: allowed_maneuvers
  {
    cdr << ros_message->allowed_maneuvers;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name allowed_maneuvers
  {
    size_t item_size = sizeof(ros_message->allowed_maneuvers);
...
static uint32_t _AllowedManeuvers__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__AllowedManeuvers(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__AllowedManeuvers(
    full_bounded, 0);
}
