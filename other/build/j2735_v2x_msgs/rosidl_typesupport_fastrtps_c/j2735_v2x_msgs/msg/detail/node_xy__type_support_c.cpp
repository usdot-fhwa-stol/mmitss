...
#include "j2735_v2x_msgs/msg/detail/node_xy__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/node_attribute_set_xy__functions.h"  // attributes
#include "j2735_v2x_msgs/msg/detail/node_offset_point_xy__functions.h"  // delta
...
using _NodeXY__ros_msg_type = j2735_v2x_msgs__msg__NodeXY;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: delta
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, NodeOffsetPointXY
      )()->data);
  ...
  // Field name: attributes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, NodeAttributeSetXY
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__NodeOffsetPointXY(
    &(ros_message->delta), current_alignment);
  // field.name attributes

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__NodeAttributeSetXY(
...
static uint32_t _NodeXY__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__NodeXY(
  ...
  size_t current_alignment)
{
  ...
  // member: delta
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__NodeOffsetPointXY(
  ...
  // member: attributes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__NodeAttributeSetXY(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__NodeXY(
    full_bounded, 0);
}
