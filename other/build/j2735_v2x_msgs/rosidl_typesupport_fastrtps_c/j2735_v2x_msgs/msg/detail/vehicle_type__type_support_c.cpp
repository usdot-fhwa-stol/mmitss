...
#include "j2735_v2x_msgs/msg/detail/vehicle_type__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleType__ros_msg_type = j2735_v2x_msgs__msg__VehicleType;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VehicleType__ros_msg_type * ros_message = static_cast<const _VehicleType__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _VehicleType__ros_msg_type * ros_message = static_cast<_VehicleType__ros_msg_type *>(untyped_ros_message);
  // Field name: vehicle_type
  {
    cdr >> ros_message->vehicle_type;
  }
...
static uint32_t _VehicleType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__VehicleType(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__VehicleType(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_VehicleType = {
  "j2735_v2x_msgs::msg",
  "VehicleType",
...
static rosidl_message_type_support_t _VehicleType__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VehicleType,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, VehicleType)() {
  return &_VehicleType__type_support;
}
