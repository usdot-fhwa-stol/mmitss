...
#include "j2735_v2x_msgs/msg/detail/vehicle_length__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleLength__ros_msg_type = j2735_v2x_msgs__msg__VehicleLength;
...
static uint32_t _VehicleLength__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__VehicleLength(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__VehicleLength(
    full_bounded, 0);
}
