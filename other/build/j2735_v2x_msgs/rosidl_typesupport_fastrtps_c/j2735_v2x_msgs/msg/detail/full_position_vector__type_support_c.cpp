...
#include "j2735_v2x_msgs/msg/detail/full_position_vector__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/elevation__functions.h"  // elevation
#include "j2735_v2x_msgs/msg/detail/heading__functions.h"  // heading
#include "j2735_v2x_msgs/msg/detail/latitude__functions.h"  // lat
#include "j2735_v2x_msgs/msg/detail/longitude__functions.h"  // lon
...
#include "j2735_v2x_msgs/msg/detail/transmission_and_speed__functions.h"  // speed
...
using _FullPositionVector__ros_msg_type = j2735_v2x_msgs__msg__FullPositionVector;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lon
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, Longitude
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->lon, cdr))
    {
  ...
  // Field name: lat
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, Latitude
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->lat, cdr))
    {
  ...
  // Field name: elevation
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, Elevation
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: speed
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, TransmissionAndSpeed
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__Longitude(
    &(ros_message->lon), current_alignment);
  // field.name lat

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__Latitude(
    &(ros_message->lat), current_alignment);
  // field.name elevation

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__Elevation(
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__TransmissionAndSpeed(
...
static uint32_t _FullPositionVector__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__FullPositionVector(
  ...
  size_t current_alignment)
{
  ...
  // member: lon
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__Longitude(
        full_bounded, current_alignment);
    }
  }
  // member: lat
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__Latitude(
        full_bounded, current_alignment);
    }
  }
  // member: elevation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__Elevation(
        full_bounded, current_alignment);
    }
  }
  // member: heading
  ...
  // member: speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__TransmissionAndSpeed(
        full_bounded, current_alignment);
    }
  }
  // member: pos_accuracy
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__FullPositionVector(
    full_bounded, 0);
}
