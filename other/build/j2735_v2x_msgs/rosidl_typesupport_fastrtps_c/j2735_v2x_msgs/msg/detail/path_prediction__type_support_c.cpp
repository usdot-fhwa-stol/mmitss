...
#include "j2735_v2x_msgs/msg/detail/path_prediction__rosidl_typesupport_fastrtps_c.h"
...
using _PathPrediction__ros_msg_type = j2735_v2x_msgs__msg__PathPrediction;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: radius_of_curvature
  {
...
static uint32_t _PathPrediction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__PathPrediction(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__PathPrediction(
    full_bounded, 0);
}
