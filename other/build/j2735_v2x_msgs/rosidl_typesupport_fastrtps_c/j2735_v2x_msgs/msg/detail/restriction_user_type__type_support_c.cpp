...
#include "j2735_v2x_msgs/msg/detail/restriction_user_type__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/restriction_applies_to__functions.h"  // basic_type
...
using _RestrictionUserType__ros_msg_type = j2735_v2x_msgs__msg__RestrictionUserType;
  ...
  // Field name: basic_type
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, RestrictionAppliesTo
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__RestrictionAppliesTo(
...
static uint32_t _RestrictionUserType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__RestrictionUserType(
  ...
  size_t current_alignment)
{
  ...
  // member: basic_type
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__RestrictionAppliesTo(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__RestrictionUserType(
    full_bounded, 0);
}
