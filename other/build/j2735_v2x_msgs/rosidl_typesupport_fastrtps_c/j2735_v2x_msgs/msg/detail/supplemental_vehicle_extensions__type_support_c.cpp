...
#include "j2735_v2x_msgs/msg/detail/supplemental_vehicle_extensions__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/gross_speed__functions.h"  // speed_profile
#include "j2735_v2x_msgs/msg/detail/obstacle_detection__functions.h"  // obstacle
#include "j2735_v2x_msgs/msg/detail/rtcm_package__functions.h"  // the_rtcm
#include "j2735_v2x_msgs/msg/detail/vehicle_classification__functions.h"  // class_details
#include "j2735_v2x_msgs/msg/detail/vehicle_data__functions.h"  // vehicle_data
#include "j2735_v2x_msgs/msg/detail/weather_probe__functions.h"  // weather_probe
#include "j2735_v2x_msgs/msg/detail/weather_report__functions.h"  // weather_report
...
using _SupplementalVehicleExtensions__ros_msg_type = j2735_v2x_msgs__msg__SupplementalVehicleExtensions;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: vehicle_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, VehicleData
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: weather_report
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, WeatherReport
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: weather_probe
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, WeatherProbe
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: obstacle
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, ObstacleDetection
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: speed_profile
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, GrossSpeed
      )()->data);
  ...
  // Field name: the_rtcm
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, RTCMPackage
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: speed_profile
  {
    ...
    if (ros_message->speed_profile.data) {
      j2735_v2x_msgs__msg__GrossSpeed__Sequence__fini(&ros_message->speed_profile);
    }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__VehicleData(
    &(ros_message->vehicle_data), current_alignment);
  // field.name weather_report

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__WeatherReport(
    &(ros_message->weather_report), current_alignment);
  // field.name weather_probe

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__WeatherProbe(
    &(ros_message->weather_probe), current_alignment);
  // field.name obstacle

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__ObstacleDetection(
  ...
  // field.name speed_profile
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_j2735_v2x_msgs__msg__GrossSpeed(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name the_rtcm

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__RTCMPackage(
...
static uint32_t _SupplementalVehicleExtensions__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__SupplementalVehicleExtensions(
  ...
  size_t current_alignment)
{
  ...
  // member: vehicle_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__VehicleData(
        full_bounded, current_alignment);
    }
  }
  // member: weather_report
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__WeatherReport(
        full_bounded, current_alignment);
    }
  }
  // member: weather_probe
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__WeatherProbe(
        full_bounded, current_alignment);
    }
  }
  // member: obstacle
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__ObstacleDetection(
        full_bounded, current_alignment);
    }
  }
  // member: status
  ...
  // member: speed_profile
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__GrossSpeed(
        full_bounded, current_alignment);
    }
  }
  // member: the_rtcm
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__RTCMPackage(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__SupplementalVehicleExtensions(
    full_bounded, 0);
}
