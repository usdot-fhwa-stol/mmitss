...
#include "j2735_v2x_msgs/msg/detail/intersection_status_object__rosidl_typesupport_fastrtps_c.h"
...
using _IntersectionStatusObject__ros_msg_type = j2735_v2x_msgs__msg__IntersectionStatusObject;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: intersection_status_object
  {
...
static uint32_t _IntersectionStatusObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__IntersectionStatusObject(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__IntersectionStatusObject(
    full_bounded, 0);
}
