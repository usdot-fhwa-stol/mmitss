...
#include "j2735_v2x_msgs/msg/detail/intersection_state__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/enabled_lane_list__functions.h"  // enabled_lanes
...
#include "j2735_v2x_msgs/msg/detail/maneuver_assist_list__functions.h"  // maneuever_assist_list
#include "j2735_v2x_msgs/msg/detail/movement_list__functions.h"  // states
...
using _IntersectionState__ros_msg_type = j2735_v2x_msgs__msg__IntersectionState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: enabled_lanes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, EnabledLaneList
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->enabled_lanes, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: states
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, MovementList
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: maneuever_assist_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->maneuever_assist_list, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: maneuever_assist_list
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->maneuever_assist_list))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__EnabledLaneList(
    &(ros_message->enabled_lanes), current_alignment);
  // field.name enabled_lanes_exists
  {
  ...
  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__MovementList(
    &(ros_message->states), current_alignment);
  // field.name maneuever_assist_list

  current_alignment += get_serialized_size_j2735_v2x_msgs__msg__ManeuverAssistList(
    &(ros_message->maneuever_assist_list), current_alignment);
  // field.name maneuever_assist_list_exists
  {
...
static uint32_t _IntersectionState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__IntersectionState(
  ...
  size_t current_alignment)
{
  ...
  // member: enabled_lanes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__EnabledLaneList(
        full_bounded, current_alignment);
    }
  }
  ...
  // member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__MovementList(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__IntersectionState(
    full_bounded, 0);
}
