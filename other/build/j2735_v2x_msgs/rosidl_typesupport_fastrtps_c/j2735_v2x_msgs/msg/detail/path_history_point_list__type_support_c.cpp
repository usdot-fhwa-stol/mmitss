...
#include "j2735_v2x_msgs/msg/detail/path_history_point_list__rosidl_typesupport_fastrtps_c.h"
...
#include "j2735_v2x_msgs/msg/detail/path_history_point__functions.h"  // points
...
using _PathHistoryPointList__ros_msg_type = j2735_v2x_msgs__msg__PathHistoryPointList;
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, PathHistoryPoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      j2735_v2x_msgs__msg__PathHistoryPoint__Sequence__fini(&ros_message->points);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_j2735_v2x_msgs__msg__PathHistoryPoint(
...
static uint32_t _PathHistoryPointList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_j2735_v2x_msgs__msg__PathHistoryPointList(
  ...
  size_t current_alignment)
{
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_j2735_v2x_msgs__msg__PathHistoryPoint(
...
{
  return max_serialized_size_j2735_v2x_msgs__msg__PathHistoryPointList(
    full_bounded, 0);
}
