...
static const _AuxiliaryBrakeStatus_type_support_symbol_names_t _AuxiliaryBrakeStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, AuxiliaryBrakeStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j2735_v2x_msgs, msg, AuxiliaryBrakeStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, j2735_v2x_msgs, msg, AuxiliaryBrakeStatus)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_c::AuxiliaryBrakeStatus_message_type_support_handle;
}
