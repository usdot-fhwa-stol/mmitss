...
static const _SpecialVehicleExtensions_type_support_symbol_names_t _SpecialVehicleExtensions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, j2735_v2x_msgs, msg, SpecialVehicleExtensions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j2735_v2x_msgs, msg, SpecialVehicleExtensions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, j2735_v2x_msgs, msg, SpecialVehicleExtensions)() {
  return &::j2735_v2x_msgs::msg::rosidl_typesupport_c::SpecialVehicleExtensions_message_type_support_handle;
}
