...
static const _SetLightBarIndicator_Request_type_support_symbol_names_t _SetLightBarIndicator_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_driver_msgs, srv, SetLightBarIndicator_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_driver_msgs, srv, SetLightBarIndicator_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_driver_msgs, srv, SetLightBarIndicator_Request)() {
  return &::carma_driver_msgs::srv::rosidl_typesupport_c::SetLightBarIndicator_Request_message_type_support_handle;
}
...
static const _SetLightBarIndicator_Response_type_support_symbol_names_t _SetLightBarIndicator_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_driver_msgs, srv, SetLightBarIndicator_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_driver_msgs, srv, SetLightBarIndicator_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_carma_driver_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carma_driver_msgs, srv, SetLightBarIndicator_Response)() {
  return &::carma_driver_msgs::srv::rosidl_typesupport_c::SetLightBarIndicator_Response_message_type_support_handle;
}
...
static const _SetLightBarIndicator_type_support_symbol_names_t _SetLightBarIndicator_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carma_driver_msgs, srv, SetLightBarIndicator)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_driver_msgs, srv, SetLightBarIndicator)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, carma_driver_msgs, srv, SetLightBarIndicator)() {
  return &::carma_driver_msgs::srv::rosidl_typesupport_c::SetLightBarIndicator_service_type_support_handle;
}
