...
#include "carma_driver_msgs/msg/detail/byte_array__rosidl_typesupport_fastrtps_c.h"
...
using _ByteArray__ros_msg_type = carma_driver_msgs__msg__ByteArray;
...
static uint32_t _ByteArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_driver_msgs__msg__ByteArray(
...
{
  return max_serialized_size_carma_driver_msgs__msg__ByteArray(
    full_bounded, 0);
}
