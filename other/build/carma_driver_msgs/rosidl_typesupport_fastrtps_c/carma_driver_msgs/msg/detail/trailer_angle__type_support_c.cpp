...
#include "carma_driver_msgs/msg/detail/trailer_angle__rosidl_typesupport_fastrtps_c.h"
...
using _TrailerAngle__ros_msg_type = carma_driver_msgs__msg__TrailerAngle;
...
static uint32_t _TrailerAngle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_carma_driver_msgs__msg__TrailerAngle(
...
{
  return max_serialized_size_carma_driver_msgs__msg__TrailerAngle(
    full_bounded, 0);
}
