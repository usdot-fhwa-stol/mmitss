...
static const _LightBarStatus_type_support_symbol_names_t _LightBarStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carma_driver_msgs, msg, LightBarStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_driver_msgs, msg, LightBarStatus)),
  }
};
...
{
  return &::carma_driver_msgs::msg::rosidl_typesupport_cpp::LightBarStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carma_driver_msgs, msg, LightBarStatus)() {
  return get_message_type_support_handle<carma_driver_msgs::msg::LightBarStatus>();
}
