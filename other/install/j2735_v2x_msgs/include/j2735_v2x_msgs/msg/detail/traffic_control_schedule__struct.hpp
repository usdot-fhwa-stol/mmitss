...
struct TrafficControlSchedule_
{
  ...
  using _between_type =
    std::vector<j2735_v2x_msgs::msg::DailySchedule_<ContainerAllocator>, typename ContainerAllocator::template rebind<j2735_v2x_msgs::msg::DailySchedule_<ContainerAllocator>>::other>;
  ...
  Type & set__between(
    const std::vector<j2735_v2x_msgs::msg::DailySchedule_<ContainerAllocator>, typename ContainerAllocator::template rebind<j2735_v2x_msgs::msg::DailySchedule_<ContainerAllocator>>::other> & _arg)
  {
    this->between = _arg;
    return *this;
  }
