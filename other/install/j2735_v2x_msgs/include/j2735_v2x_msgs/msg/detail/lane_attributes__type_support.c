...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j2735_v2x_msgs, msg, LaneAttributes)() {
  LaneAttributes__rosidl_typesupport_introspection_c__LaneAttributes_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j2735_v2x_msgs, msg, LaneDirection)();
  LaneAttributes__rosidl_typesupport_introspection_c__LaneAttributes_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j2735_v2x_msgs, msg, LaneSharing)();
  LaneAttributes__rosidl_typesupport_introspection_c__LaneAttributes_message_member_array[2].members_ =
