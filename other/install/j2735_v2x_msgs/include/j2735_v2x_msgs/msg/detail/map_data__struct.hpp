...
struct MapData_
{
  ...
  using _intersections_type =
    std::vector<j2735_v2x_msgs::msg::IntersectionGeometry_<ContainerAllocator>, typename ContainerAllocator::template rebind<j2735_v2x_msgs::msg::IntersectionGeometry_<ContainerAllocator>>::other>;
  ...
  Type & set__intersections(
    const std::vector<j2735_v2x_msgs::msg::IntersectionGeometry_<ContainerAllocator>, typename ContainerAllocator::template rebind<j2735_v2x_msgs::msg::IntersectionGeometry_<ContainerAllocator>>::other> & _arg)
  {
