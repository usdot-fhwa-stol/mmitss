...
struct SupplementalVehicleExtensions_
{
  ...
  using _speed_profile_type =
    std::vector<j2735_v2x_msgs::msg::GrossSpeed_<ContainerAllocator>, typename ContainerAllocator::template rebind<j2735_v2x_msgs::msg::GrossSpeed_<ContainerAllocator>>::other>;
  ...
  Type & set__speed_profile(
    const std::vector<j2735_v2x_msgs::msg::GrossSpeed_<ContainerAllocator>, typename ContainerAllocator::template rebind<j2735_v2x_msgs::msg::GrossSpeed_<ContainerAllocator>>::other> & _arg)
  {
