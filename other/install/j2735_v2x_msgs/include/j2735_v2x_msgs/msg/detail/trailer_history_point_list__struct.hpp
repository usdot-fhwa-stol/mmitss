...
struct TrailerHistoryPointList_
{
  ...
  using _trailer_history_points_type =
    std::vector<j2735_v2x_msgs::msg::TrailerHistoryPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<j2735_v2x_msgs::msg::TrailerHistoryPoint_<ContainerAllocator>>::other>;
  _trailer_history_points_type trailer_history_points;

  // setters for named parameter idiom
  Type & set__trailer_history_points(
    const std::vector<j2735_v2x_msgs::msg::TrailerHistoryPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<j2735_v2x_msgs::msg::TrailerHistoryPoint_<ContainerAllocator>>::other> & _arg)
  {
