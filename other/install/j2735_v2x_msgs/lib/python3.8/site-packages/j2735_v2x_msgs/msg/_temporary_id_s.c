...
bool j2735_v2x_msgs__msg__temporary_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._temporary_id.TemporaryID", full_classname_dest, 44) == 0);
  }
  j2735_v2x_msgs__msg__TemporaryID * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of TemporaryID */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._temporary_id");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TemporaryID");
  ...
  j2735_v2x_msgs__msg__TemporaryID * ros_message = (j2735_v2x_msgs__msg__TemporaryID *)raw_ros_message;
  {  // id
    PyObject * field = NULL;
