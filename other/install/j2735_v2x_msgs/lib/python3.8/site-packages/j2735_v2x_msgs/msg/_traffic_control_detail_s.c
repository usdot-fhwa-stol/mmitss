...
bool j2735_v2x_msgs__msg__traffic_control_detail__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._traffic_control_detail.TrafficControlDetail", full_classname_dest, 63) == 0);
  }
  j2735_v2x_msgs__msg__TrafficControlDetail * ros_message = _ros_message;
  {  // choice
  ...
  {  // minspeed
    ...
    assert(PyLong_Check(field));
    ros_message->minspeed = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // maxspeed
    ...
    assert(PyLong_Check(field));
    ros_message->maxspeed = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // minhdwy
    ...
    assert(PyLong_Check(field));
    ros_message->minhdwy = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // maxvehmass
    ...
    assert(PyLong_Check(field));
    ros_message->maxvehmass = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // maxvehheight
    ...
    assert(PyLong_Check(field));
    ros_message->maxvehheight = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // maxvehwidth
    ...
    assert(PyLong_Check(field));
    ros_message->maxvehwidth = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // maxvehlength
    ...
    assert(PyLong_Check(field));
    ros_message->maxvehlength = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // maxvehaxles
  ...
  {  // minplatoonhdwy
    ...
    assert(PyLong_Check(field));
    ros_message->minplatoonhdwy = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * j2735_v2x_msgs__msg__traffic_control_detail__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._traffic_control_detail");
  ...
  j2735_v2x_msgs__msg__TrafficControlDetail * ros_message = (j2735_v2x_msgs__msg__TrafficControlDetail *)raw_ros_message;
  {  // choice
    PyObject * field = NULL;
  ...
  {  // minspeed
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->minspeed);
    {
  ...
  {  // maxspeed
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->maxspeed);
    {
  ...
  {  // minhdwy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->minhdwy);
    {
  ...
  {  // maxvehmass
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->maxvehmass);
    {
  ...
  {  // maxvehheight
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->maxvehheight);
    {
  ...
  {  // maxvehwidth
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->maxvehwidth);
    {
  ...
  {  // maxvehlength
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->maxvehlength);
    {
  ...
  {  // minplatoonhdwy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->minplatoonhdwy);
    {
