...
bool j2735_v2x_msgs__msg__vehicle_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._vehicle_type.VehicleType", full_classname_dest, 44) == 0);
  }
  j2735_v2x_msgs__msg__VehicleType * ros_message = _ros_message;
  {  // vehicle_type
...
{
  /* NOTE(esteve): Call constructor of VehicleType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._vehicle_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleType");
  ...
  j2735_v2x_msgs__msg__VehicleType * ros_message = (j2735_v2x_msgs__msg__VehicleType *)raw_ros_message;
  {  // vehicle_type
    PyObject * field = NULL;
