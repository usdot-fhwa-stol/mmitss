...
bool j2735_v2x_msgs__msg__vehicle_size__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._vehicle_size.VehicleSize", full_classname_dest, 44) == 0);
  }
  j2735_v2x_msgs__msg__VehicleSize * ros_message = _ros_message;
  {  // vehicle_width
    ...
    ros_message->vehicle_width = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // vehicle_length
...
PyObject * j2735_v2x_msgs__msg__vehicle_size__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._vehicle_size");
  ...
  j2735_v2x_msgs__msg__VehicleSize * ros_message = (j2735_v2x_msgs__msg__VehicleSize *)raw_ros_message;
  {  // vehicle_width
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->vehicle_width);
    {
