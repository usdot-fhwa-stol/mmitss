...
class Metaclass_TrafficControlSchedule(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import DailySchedule
            ...
            from j2735_v2x_msgs.msg import RepeatParams
...
class TrafficControlSchedule(metaclass=Metaclass_TrafficControlSchedule):
    ...
    _fields_and_field_types = {
        ...
        'dow_exists': 'boolean',
        'between': 'sequence<j2735_v2x_msgs/DailySchedule>',
        'between_exists': 'boolean',
        'repeat': 'j2735_v2x_msgs/RepeatParams',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'DailySchedule')),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'RepeatParams'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
    )
    ...
    def start(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 18446744073709551616, \
                "The 'start' field must be an unsigned integer in [0, 18446744073709551615]"
        self._start = value
    ...
    def end(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 18446744073709551616, \
                "The 'end' field must be an unsigned integer in [0, 18446744073709551615]"
        self._end = value
