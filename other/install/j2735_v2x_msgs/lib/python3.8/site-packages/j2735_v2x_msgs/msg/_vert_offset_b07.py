...
class Metaclass_VertOffsetB07(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'OFFSET_UNAVAILABLE': cls.__constants['OFFSET_UNAVAILABLE'],
        }
    ...
    @property
    def OFFSET_UNAVAILABLE(self):
        """Message constant 'OFFSET_UNAVAILABLE'."""
        return Metaclass_VertOffsetB07.__constants['OFFSET_UNAVAILABLE']
    ...
    def offset(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'offset' field must be an integer in [-128, 127]"
        self._offset = value
