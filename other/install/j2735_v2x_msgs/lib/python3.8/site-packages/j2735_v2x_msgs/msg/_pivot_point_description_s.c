...
bool j2735_v2x_msgs__msg__offset_b11__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__offset_b11__convert_to_py(void * raw_ros_message);
bool j2735_v2x_msgs__msg__angle__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__angle__convert_to_py(void * raw_ros_message);
...
bool j2735_v2x_msgs__msg__pivot_point_description__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._pivot_point_description.PivotPointDescription", full_classname_dest, 65) == 0);
  }
  j2735_v2x_msgs__msg__PivotPointDescription * ros_message = _ros_message;
  {  // pivot_offset
    PyObject * field = PyObject_GetAttrString(_pymsg, "pivot_offset");
    if (!field) {
      return false;
    }
    if (!j2735_v2x_msgs__msg__offset_b11__convert_from_py(field, &ros_message->pivot_offset)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // pivot_angle
    ...
    if (!j2735_v2x_msgs__msg__angle__convert_from_py(field, &ros_message->pivot_angle)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j2735_v2x_msgs__msg__pivot_point_description__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._pivot_point_description");
  ...
  j2735_v2x_msgs__msg__PivotPointDescription * ros_message = (j2735_v2x_msgs__msg__PivotPointDescription *)raw_ros_message;
  {  // pivot_offset
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__offset_b11__convert_to_py(&ros_message->pivot_offset);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // pivot_angle
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__angle__convert_to_py(&ros_message->pivot_angle);
    if (!field) {
      return NULL;
    }
    {
