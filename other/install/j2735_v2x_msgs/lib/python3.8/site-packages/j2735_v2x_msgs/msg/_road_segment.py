...
class Metaclass_RoadSegment(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import RoadLaneSetList
            if RoadLaneSetList.__class__._TYPE_SUPPORT is None:
                RoadLaneSetList.__class__.__import_type_support__()
...
class RoadSegment(metaclass=Metaclass_RoadSegment):
    ...
    _fields_and_field_types = {
        ...
        'road_lane_set': 'j2735_v2x_msgs/RoadLaneSetList',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'RoadLaneSetList'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from j2735_v2x_msgs.msg import RoadLaneSetList
        self.road_lane_set = kwargs.get('road_lane_set', RoadLaneSetList())
    ...
    def __eq__(self, other):
        ...
        if self.speed_limits_exists != other.speed_limits_exists:
            return False
        if self.road_lane_set != other.road_lane_set:
            return False
        return True
    ...
    @property
    def road_lane_set(self):
        """Message field 'road_lane_set'."""
        return self._road_lane_set

    @road_lane_set.setter
    def road_lane_set(self, value):
        if __debug__:
            from j2735_v2x_msgs.msg import RoadLaneSetList
            assert \
                isinstance(value, RoadLaneSetList), \
                "The 'road_lane_set' field must be a sub message of type 'RoadLaneSetList'"
        self._road_lane_set = value
