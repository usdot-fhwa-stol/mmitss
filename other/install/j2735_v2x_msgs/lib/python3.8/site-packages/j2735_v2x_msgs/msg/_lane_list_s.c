...
bool j2735_v2x_msgs__msg__lane_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._lane_list.LaneList", full_classname_dest, 38) == 0);
  }
  j2735_v2x_msgs__msg__LaneList * ros_message = _ros_message;
  {  // lane_list
    ...
    if (!j2735_v2x_msgs__msg__GenericLane__Sequence__init(&(ros_message->lane_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create j2735_v2x_msgs__msg__GenericLane__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    j2735_v2x_msgs__msg__GenericLane * dest = ros_message->lane_list.data;
...
PyObject * j2735_v2x_msgs__msg__lane_list__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._lane_list");
  ...
  j2735_v2x_msgs__msg__LaneList * ros_message = (j2735_v2x_msgs__msg__LaneList *)raw_ros_message;
  {  // lane_list
    PyObject * field = NULL;
