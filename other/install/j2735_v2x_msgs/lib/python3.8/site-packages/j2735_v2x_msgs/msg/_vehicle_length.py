...
class Metaclass_VehicleLength(type):
    ...
    def VEHICLE_LENGTH_UNAVAILABLE(self):
        ...
        return Metaclass_VehicleLength.__constants['VEHICLE_LENGTH_UNAVAILABLE']

    @property
    def VEHICLE_LENGTH_MAX(self):
        """Message constant 'VEHICLE_LENGTH_MAX'."""
        return Metaclass_VehicleLength.__constants['VEHICLE_LENGTH_MAX']

    @property
    def VEHICLE_LENGTH_MIN(self):
        """Message constant 'VEHICLE_LENGTH_MIN'."""
        return Metaclass_VehicleLength.__constants['VEHICLE_LENGTH_MIN']
