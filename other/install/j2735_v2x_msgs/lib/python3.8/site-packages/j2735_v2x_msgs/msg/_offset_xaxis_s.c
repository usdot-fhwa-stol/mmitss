...
bool j2735_v2x_msgs__msg__offset_xaxis__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._offset_xaxis.OffsetXaxis", full_classname_dest, 44) == 0);
  }
  j2735_v2x_msgs__msg__OffsetXaxis * ros_message = _ros_message;
  {  // choice
...
PyObject * j2735_v2x_msgs__msg__offset_xaxis__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._offset_xaxis");
  ...
  j2735_v2x_msgs__msg__OffsetXaxis * ros_message = (j2735_v2x_msgs__msg__OffsetXaxis *)raw_ros_message;
  {  // choice
    PyObject * field = NULL;
