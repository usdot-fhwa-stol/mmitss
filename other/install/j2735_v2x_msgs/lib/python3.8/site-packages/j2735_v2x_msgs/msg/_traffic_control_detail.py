    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'j2735_v2x_msgs.msg.TrafficControlDetail')
            logger.debug(
...
class TrafficControlDetail(metaclass=Metaclass_TrafficControlDetail):
    ...
    def __init__(self, **kwargs):
        ...
        self.minspeed = kwargs.get('minspeed', int())
        self.maxspeed = kwargs.get('maxspeed', int())
        self.minhdwy = kwargs.get('minhdwy', int())
        self.maxvehmass = kwargs.get('maxvehmass', int())
        self.maxvehheight = kwargs.get('maxvehheight', int())
        self.maxvehwidth = kwargs.get('maxvehwidth', int())
        self.maxvehlength = kwargs.get('maxvehlength', int())
        ...
        self.minplatoonhdwy = kwargs.get('minplatoonhdwy', int())
    ...
    def minspeed(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'minspeed' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'minspeed' field must be an unsigned integer in [0, 65535]"
    ...
    def maxspeed(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'maxspeed' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'maxspeed' field must be an unsigned integer in [0, 65535]"
    ...
    def minhdwy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'minhdwy' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'minhdwy' field must be an unsigned integer in [0, 65535]"
        self._minhdwy = value
    ...
    def maxvehmass(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'maxvehmass' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'maxvehmass' field must be an unsigned integer in [0, 65535]"
    ...
    def maxvehheight(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'maxvehheight' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'maxvehheight' field must be an unsigned integer in [0, 255]"
    ...
    def maxvehwidth(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'maxvehwidth' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'maxvehwidth' field must be an unsigned integer in [0, 255]"
    ...
    def maxvehlength(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'maxvehlength' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'maxvehlength' field must be an unsigned integer in [0, 65535]"
    ...
    def minplatoonhdwy(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'minplatoonhdwy' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'minplatoonhdwy' field must be an unsigned integer in [0, 65535]"
