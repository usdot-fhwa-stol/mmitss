...
bool j2735_v2x_msgs__msg__position_confidence__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__position_confidence__convert_to_py(void * raw_ros_message);
...
bool j2735_v2x_msgs__msg__position_confidence_set__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._position_confidence_set.PositionConfidenceSet", full_classname_dest, 65) == 0);
  }
  j2735_v2x_msgs__msg__PositionConfidenceSet * ros_message = _ros_message;
  {  // pos
    PyObject * field = PyObject_GetAttrString(_pymsg, "pos");
    if (!field) {
      return false;
    }
    if (!j2735_v2x_msgs__msg__position_confidence__convert_from_py(field, &ros_message->pos)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // elevation
    ...
    if (!j2735_v2x_msgs__msg__elevation_confidence__convert_from_py(field, &ros_message->elevation)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j2735_v2x_msgs__msg__position_confidence_set__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._position_confidence_set");
  ...
  j2735_v2x_msgs__msg__PositionConfidenceSet * ros_message = (j2735_v2x_msgs__msg__PositionConfidenceSet *)raw_ros_message;
  {  // pos
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__position_confidence__convert_to_py(&ros_message->pos);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // elevation
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__elevation_confidence__convert_to_py(&ros_message->elevation);
    if (!field) {
      return NULL;
    }
    {
