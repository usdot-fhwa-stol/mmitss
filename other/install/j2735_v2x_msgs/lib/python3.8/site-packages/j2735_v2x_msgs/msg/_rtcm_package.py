    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'j2735_v2x_msgs.msg.RTCMPackage')
            logger.debug(
            ...
            from j2735_v2x_msgs.msg import RTCMHeader
...
class RTCMPackage(metaclass=Metaclass_RTCMPackage):
    ...
    _fields_and_field_types = {
        ...
        'rtcm_header': 'j2735_v2x_msgs/RTCMHeader',
        'messages': 'sequence<uint8>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint16'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'RTCMHeader'),  # noqa: E501
