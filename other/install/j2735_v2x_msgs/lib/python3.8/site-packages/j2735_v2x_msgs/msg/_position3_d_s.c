...
bool j2735_v2x_msgs__msg__position3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._position3_d.Position3D", full_classname_dest, 42) == 0);
  }
  j2735_v2x_msgs__msg__Position3D * ros_message = _ros_message;
  {  // latitude
  ...
  {  // elevation_exists
    PyObject * field = PyObject_GetAttrString(_pymsg, "elevation_exists");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->elevation_exists = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * j2735_v2x_msgs__msg__position3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._position3_d");
  ...
  j2735_v2x_msgs__msg__Position3D * ros_message = (j2735_v2x_msgs__msg__Position3D *)raw_ros_message;
  {  // latitude
    PyObject * field = NULL;
  ...
  {  // elevation_exists
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->elevation_exists ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "elevation_exists", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
