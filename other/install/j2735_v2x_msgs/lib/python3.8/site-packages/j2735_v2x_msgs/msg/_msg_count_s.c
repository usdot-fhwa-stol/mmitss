...
bool j2735_v2x_msgs__msg__msg_count__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._msg_count.MsgCount", full_classname_dest, 38) == 0);
  }
  j2735_v2x_msgs__msg__MsgCount * ros_message = _ros_message;
  {  // msg_cnt
...
{
  /* NOTE(esteve): Call constructor of MsgCount */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._msg_count");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MsgCount");
  ...
  j2735_v2x_msgs__msg__MsgCount * ros_message = (j2735_v2x_msgs__msg__MsgCount *)raw_ros_message;
  {  // msg_cnt
    PyObject * field = NULL;
