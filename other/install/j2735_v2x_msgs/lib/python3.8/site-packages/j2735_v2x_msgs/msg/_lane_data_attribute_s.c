...
bool j2735_v2x_msgs__msg__lane_data_attribute__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._lane_data_attribute.LaneDataAttribute", full_classname_dest, 57) == 0);
  }
  j2735_v2x_msgs__msg__LaneDataAttribute * ros_message = _ros_message;
  {  // choice
  ...
  {  // lane_crown_point_center
    ...
    assert(PyLong_Check(field));
    ros_message->lane_crown_point_center = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // lane_crown_point_right
    ...
    assert(PyLong_Check(field));
    ros_message->lane_crown_point_right = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // lane_crown_point_left
    ...
    assert(PyLong_Check(field));
    ros_message->lane_crown_point_left = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // lane_angle
    ...
    assert(PyLong_Check(field));
    ros_message->lane_angle = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // speed_limits
...
PyObject * j2735_v2x_msgs__msg__lane_data_attribute__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._lane_data_attribute");
  ...
  j2735_v2x_msgs__msg__LaneDataAttribute * ros_message = (j2735_v2x_msgs__msg__LaneDataAttribute *)raw_ros_message;
  {  // choice
    PyObject * field = NULL;
  ...
  {  // lane_crown_point_center
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->lane_crown_point_center);
    {
  ...
  {  // lane_crown_point_right
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->lane_crown_point_right);
    {
  ...
  {  // lane_crown_point_left
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->lane_crown_point_left);
    {
  ...
  {  // lane_angle
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->lane_angle);
    {
