...
bool j2735_v2x_msgs__msg__traffic_control_geometry__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__traffic_control_geometry__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool j2735_v2x_msgs__msg__traffic_control_message_v01__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._traffic_control_message_v01.TrafficControlMessageV01", full_classname_dest, 72) == 0);
  }
  j2735_v2x_msgs__msg__TrafficControlMessageV01 * ros_message = _ros_message;
  {  // reqid
  ...
  {  // updated
    ...
    assert(PyLong_Check(field));
    ros_message->updated = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // package
  ...
  {  // params
    ...
    if (!j2735_v2x_msgs__msg__traffic_control_params__convert_from_py(field, &ros_message->params)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // geometry
    ...
    if (!j2735_v2x_msgs__msg__traffic_control_geometry__convert_from_py(field, &ros_message->geometry)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * j2735_v2x_msgs__msg__traffic_control_message_v01__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of TrafficControlMessageV01 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._traffic_control_message_v01");
  ...
  j2735_v2x_msgs__msg__TrafficControlMessageV01 * ros_message = (j2735_v2x_msgs__msg__TrafficControlMessageV01 *)raw_ros_message;
  {  // reqid
    PyObject * field = NULL;
  ...
  {  // updated
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->updated);
    {
  ...
  {  // params
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__traffic_control_params__convert_to_py(&ros_message->params);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // geometry
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__traffic_control_geometry__convert_to_py(&ros_message->geometry);
    if (!field) {
      return NULL;
    }
    {
