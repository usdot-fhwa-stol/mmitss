...
class Metaclass_MapData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import IntersectionGeometry
            ...
            from j2735_v2x_msgs.msg import RestrictionClassList
            if RestrictionClassList.__class__._TYPE_SUPPORT is None:
                RestrictionClassList.__class__.__import_type_support__()

            from j2735_v2x_msgs.msg import RoadSegmentList
            if RoadSegmentList.__class__._TYPE_SUPPORT is None:
                RoadSegmentList.__class__.__import_type_support__()
...
class MapData(metaclass=Metaclass_MapData):
    ...
    _fields_and_field_types = {
        ...
        'intersections': 'sequence<j2735_v2x_msgs/IntersectionGeometry>',
        'intersections_exists': 'boolean',
        'road_segments': 'j2735_v2x_msgs/RoadSegmentList',
        'road_segments_exists': 'boolean',
        'data_parameters': 'j2735_v2x_msgs/DataParameters',
        'data_parameters_exists': 'boolean',
        'restriction_list': 'j2735_v2x_msgs/RestrictionClassList',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'IntersectionGeometry')),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'RoadSegmentList'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'DataParameters'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'RestrictionClassList'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from j2735_v2x_msgs.msg import RoadSegmentList
        self.road_segments = kwargs.get('road_segments', RoadSegmentList())
        ...
        from j2735_v2x_msgs.msg import RestrictionClassList
        self.restriction_list = kwargs.get('restriction_list', RestrictionClassList())
    ...
    def __eq__(self, other):
        ...
        if self.intersections_exists != other.intersections_exists:
            return False
        if self.road_segments != other.road_segments:
            return False
        ...
        if self.data_parameters_exists != other.data_parameters_exists:
            return False
        if self.restriction_list != other.restriction_list:
            return False
    ...
    def road_segments(self, value):
        if __debug__:
            from j2735_v2x_msgs.msg import RoadSegmentList
            assert \
                isinstance(value, RoadSegmentList), \
                "The 'road_segments' field must be a sub message of type 'RoadSegmentList'"
        self._road_segments = value
    ...
    @property
    def restriction_list(self):
        """Message field 'restriction_list'."""
        return self._restriction_list

    @restriction_list.setter
    def restriction_list(self, value):
        if __debug__:
            from j2735_v2x_msgs.msg import RestrictionClassList
            assert \
                isinstance(value, RestrictionClassList), \
                "The 'restriction_list' field must be a sub message of type 'RestrictionClassList'"
        self._restriction_list = value
