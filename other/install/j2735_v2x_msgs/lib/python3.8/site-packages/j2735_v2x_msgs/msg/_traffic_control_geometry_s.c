...
bool j2735_v2x_msgs__msg__traffic_control_geometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._traffic_control_geometry.TrafficControlGeometry", full_classname_dest, 67) == 0);
  }
  j2735_v2x_msgs__msg__TrafficControlGeometry * ros_message = _ros_message;
  {  // proj
  ...
  {  // reftime
    ...
    ros_message->reftime = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // reflon
    ...
    assert(PyLong_Check(field));
    ros_message->reflon = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // reflat
    ...
    assert(PyLong_Check(field));
    ros_message->reflat = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // refelv
    ...
    assert(PyLong_Check(field));
    ros_message->refelv = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // heading
  ...
  {  // nodes
    ...
    if (!j2735_v2x_msgs__msg__PathNode__Sequence__init(&(ros_message->nodes), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create j2735_v2x_msgs__msg__PathNode__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    j2735_v2x_msgs__msg__PathNode * dest = ros_message->nodes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!j2735_v2x_msgs__msg__path_node__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * j2735_v2x_msgs__msg__traffic_control_geometry__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._traffic_control_geometry");
  ...
  j2735_v2x_msgs__msg__TrafficControlGeometry * ros_message = (j2735_v2x_msgs__msg__TrafficControlGeometry *)raw_ros_message;
  {  // proj
    PyObject * field = NULL;
  ...
  {  // reftime
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->reftime);
    {
  ...
  {  // reflon
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->reflon);
    {
  ...
  {  // reflat
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->reflat);
    {
  ...
  {  // refelv
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->refelv);
    {
  ...
  {  // nodes
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = j2735_v2x_msgs__msg__path_node__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
