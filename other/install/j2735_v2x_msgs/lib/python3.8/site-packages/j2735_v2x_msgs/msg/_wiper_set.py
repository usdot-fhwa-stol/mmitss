...
class Metaclass_WiperSet(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import WiperRate
...
class WiperSet(metaclass=Metaclass_WiperSet):
    ...
    _fields_and_field_types = {
        ...
        'rate_front': 'j2735_v2x_msgs/WiperRate',
        'status_rear': 'j2735_v2x_msgs/WiperStatus',
        'rate_rear': 'j2735_v2x_msgs/WiperRate',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint16'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'WiperStatus'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'WiperRate'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'WiperStatus'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'WiperRate'),  # noqa: E501
    )
