...
class Metaclass_SpeedandHeadingandThrottleConfidence(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import ThrottleConfidence
            if ThrottleConfidence.__class__._TYPE_SUPPORT is None:
                ThrottleConfidence.__class__.__import_type_support__()
...
class SpeedandHeadingandThrottleConfidence(metaclass=Metaclass_SpeedandHeadingandThrottleConfidence):
    ...
    _fields_and_field_types = {
        'heading': 'j2735_v2x_msgs/HeadingConfidence',
        'speed': 'j2735_v2x_msgs/SpeedConfidence',
        'throttle': 'j2735_v2x_msgs/ThrottleConfidence',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'ThrottleConfidence'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from j2735_v2x_msgs.msg import HeadingConfidence
        self.heading = kwargs.get('heading', HeadingConfidence())
        from j2735_v2x_msgs.msg import SpeedConfidence
        self.speed = kwargs.get('speed', SpeedConfidence())
        from j2735_v2x_msgs.msg import ThrottleConfidence
        self.throttle = kwargs.get('throttle', ThrottleConfidence())
    ...
    def heading(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'heading' field must be a sub message of type 'HeadingConfidence'"
        self._heading = value
    ...
    def speed(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'speed' field must be a sub message of type 'SpeedConfidence'"
        self._speed = value
    ...
    def throttle(self, value):
        if __debug__:
            from j2735_v2x_msgs.msg import ThrottleConfidence
            assert \
                isinstance(value, ThrottleConfidence), \
                "The 'throttle' field must be a sub message of type 'ThrottleConfidence'"
