...
bool j2735_v2x_msgs__msg__acceleration_set4_way__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._acceleration_set4_way.AccelerationSet4Way", full_classname_dest, 61) == 0);
  }
  j2735_v2x_msgs__msg__AccelerationSet4Way * ros_message = _ros_message;
  {  // longitudinal
    ...
    ros_message->longitudinal = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // lateral
    ...
    assert(PyLong_Check(field));
    ros_message->lateral = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // vert
    ...
    assert(PyLong_Check(field));
    ros_message->vert = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // yaw_rate
...
PyObject * j2735_v2x_msgs__msg__acceleration_set4_way__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._acceleration_set4_way");
  ...
  j2735_v2x_msgs__msg__AccelerationSet4Way * ros_message = (j2735_v2x_msgs__msg__AccelerationSet4Way *)raw_ros_message;
  {  // longitudinal
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->longitudinal);
    {
  ...
  {  // vert
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->vert);
    {
