...
class Metaclass_BumperHeights(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j2735_v2x_msgs.msg import BumperHeight
...
class BumperHeights(metaclass=Metaclass_BumperHeights):
    ...
    _fields_and_field_types = {
        'front': 'j2735_v2x_msgs/BumperHeight',
        'rear': 'j2735_v2x_msgs/BumperHeight',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'BumperHeight'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'BumperHeight'),  # noqa: E501
    )
