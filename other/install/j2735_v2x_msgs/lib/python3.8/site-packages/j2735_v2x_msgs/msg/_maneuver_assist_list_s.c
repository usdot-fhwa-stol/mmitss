...
bool j2735_v2x_msgs__msg__maneuver_assist_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._maneuver_assist_list.ManeuverAssistList", full_classname_dest, 59) == 0);
  }
  j2735_v2x_msgs__msg__ManeuverAssistList * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of ManeuverAssistList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._maneuver_assist_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ManeuverAssistList");
  ...
  j2735_v2x_msgs__msg__ManeuverAssistList * ros_message = (j2735_v2x_msgs__msg__ManeuverAssistList *)raw_ros_message;
  {  // connection_maneuver_assist_list
    PyObject * field = NULL;
