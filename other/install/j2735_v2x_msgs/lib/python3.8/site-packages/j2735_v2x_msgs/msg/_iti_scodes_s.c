...
bool j2735_v2x_msgs__msg__iti_scodes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._iti_scodes.ITIScodes", full_classname_dest, 40) == 0);
  }
  j2735_v2x_msgs__msg__ITIScodes * ros_message = _ros_message;
  {  // code
...
{
  /* NOTE(esteve): Call constructor of ITIScodes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._iti_scodes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ITIScodes");
  ...
  j2735_v2x_msgs__msg__ITIScodes * ros_message = (j2735_v2x_msgs__msg__ITIScodes *)raw_ros_message;
  {  // code
    PyObject * field = NULL;
