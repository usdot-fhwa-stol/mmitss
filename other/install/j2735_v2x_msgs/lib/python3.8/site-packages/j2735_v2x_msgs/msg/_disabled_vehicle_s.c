...
bool j2735_v2x_msgs__msg__disabled_vehicle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._disabled_vehicle.DisabledVehicle", full_classname_dest, 52) == 0);
  }
  j2735_v2x_msgs__msg__DisabledVehicle * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // status_details
    PyObject * field = PyObject_GetAttrString(_pymsg, "status_details");
    if (!field) {
      return false;
    }
    if (!j2735_v2x_msgs__msg__iti_scodes__convert_from_py(field, &ros_message->status_details)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of DisabledVehicle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._disabled_vehicle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DisabledVehicle");
  ...
  j2735_v2x_msgs__msg__DisabledVehicle * ros_message = (j2735_v2x_msgs__msg__DisabledVehicle *)raw_ros_message;
  {  // presence_vector
    PyObject * field = NULL;
  ...
  {  // status_details
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__iti_scodes__convert_to_py(&ros_message->status_details);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "status_details", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
