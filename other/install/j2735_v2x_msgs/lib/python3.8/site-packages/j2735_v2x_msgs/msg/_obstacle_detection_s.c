...
bool j2735_v2x_msgs__msg__obstacle_distance__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__obstacle_distance__convert_to_py(void * raw_ros_message);
bool j2735_v2x_msgs__msg__obstacle_direction__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__obstacle_direction__convert_to_py(void * raw_ros_message);
...
bool j2735_v2x_msgs__msg__obstacle_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._obstacle_detection.ObstacleDetection", full_classname_dest, 56) == 0);
  }
  j2735_v2x_msgs__msg__ObstacleDetection * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // ob_dist
    ...
    if (!j2735_v2x_msgs__msg__obstacle_distance__convert_from_py(field, &ros_message->ob_dist)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // ob_direct
    ...
    if (!j2735_v2x_msgs__msg__obstacle_direction__convert_from_py(field, &ros_message->ob_direct)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j2735_v2x_msgs__msg__obstacle_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._obstacle_detection");
  ...
  j2735_v2x_msgs__msg__ObstacleDetection * ros_message = (j2735_v2x_msgs__msg__ObstacleDetection *)raw_ros_message;
  {  // presence_vector
    PyObject * field = NULL;
  ...
  {  // ob_dist
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__obstacle_distance__convert_to_py(&ros_message->ob_dist);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // ob_direct
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__obstacle_direction__convert_to_py(&ros_message->ob_direct);
    if (!field) {
      return NULL;
    }
    {
