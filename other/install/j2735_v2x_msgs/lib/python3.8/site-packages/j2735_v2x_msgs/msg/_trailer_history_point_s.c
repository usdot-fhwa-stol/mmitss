...
bool j2735_v2x_msgs__msg__trailer_history_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._trailer_history_point.TrailerHistoryPoint", full_classname_dest, 61) == 0);
  }
  j2735_v2x_msgs__msg__TrailerHistoryPoint * ros_message = _ros_message;
  {  // presence_vector
...
PyObject * j2735_v2x_msgs__msg__trailer_history_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._trailer_history_point");
  ...
  j2735_v2x_msgs__msg__TrailerHistoryPoint * ros_message = (j2735_v2x_msgs__msg__TrailerHistoryPoint *)raw_ros_message;
  {  // presence_vector
    PyObject * field = NULL;
