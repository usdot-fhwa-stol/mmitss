...
bool j2735_v2x_msgs__msg__enabled_lane_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._enabled_lane_list.EnabledLaneList", full_classname_dest, 53) == 0);
  }
  j2735_v2x_msgs__msg__EnabledLaneList * ros_message = _ros_message;
  {  // lane_id_list
...
{
  /* NOTE(esteve): Call constructor of EnabledLaneList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._enabled_lane_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EnabledLaneList");
  ...
  j2735_v2x_msgs__msg__EnabledLaneList * ros_message = (j2735_v2x_msgs__msg__EnabledLaneList *)raw_ros_message;
  {  // lane_id_list
    PyObject * field = NULL;
