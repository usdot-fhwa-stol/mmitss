...
bool j2735_v2x_msgs__msg__gross_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._gross_speed.GrossSpeed", full_classname_dest, 42) == 0);
  }
  j2735_v2x_msgs__msg__GrossSpeed * ros_message = _ros_message;
  {  // speed
...
PyObject * j2735_v2x_msgs__msg__gross_speed__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._gross_speed");
  ...
  j2735_v2x_msgs__msg__GrossSpeed * ros_message = (j2735_v2x_msgs__msg__GrossSpeed *)raw_ros_message;
  {  // speed
    PyObject * field = NULL;
