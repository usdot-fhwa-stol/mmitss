...
bool j2735_v2x_msgs__msg__ntcip_ess_precip_rate__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__ntcip_ess_precip_rate__convert_to_py(void * raw_ros_message);
...
bool j2735_v2x_msgs__msg__coefficient_of_friction__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * j2735_v2x_msgs__msg__coefficient_of_friction__convert_to_py(void * raw_ros_message);
...
bool j2735_v2x_msgs__msg__weather_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j2735_v2x_msgs.msg._weather_report.WeatherReport", full_classname_dest, 48) == 0);
  }
  j2735_v2x_msgs__msg__WeatherReport * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // rain_rate
    ...
    if (!j2735_v2x_msgs__msg__ntcip_ess_precip_rate__convert_from_py(field, &ros_message->rain_rate)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // road_friction
    ...
    if (!j2735_v2x_msgs__msg__coefficient_of_friction__convert_from_py(field, &ros_message->road_friction)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j2735_v2x_msgs__msg__weather_report__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j2735_v2x_msgs.msg._weather_report");
  ...
  j2735_v2x_msgs__msg__WeatherReport * ros_message = (j2735_v2x_msgs__msg__WeatherReport *)raw_ros_message;
  {  // presence_vector
    PyObject * field = NULL;
  ...
  {  // rain_rate
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__ntcip_ess_precip_rate__convert_to_py(&ros_message->rain_rate);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // road_friction
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__coefficient_of_friction__convert_to_py(&ros_message->road_friction);
    if (!field) {
      return NULL;
    }
    {
