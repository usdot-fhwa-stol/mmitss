    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'j2735_v2x_msgs.msg.BSMPartIIExtension')
            logger.debug(
            ...
            from j2735_v2x_msgs.msg import VehicleSafetyExtensions
...
class BSMPartIIExtension(metaclass=Metaclass_BSMPartIIExtension):
    ...
    _fields_and_field_types = {
        'part_ii_id': 'uint8',
        'vehicle_safety_extensions': 'j2735_v2x_msgs/VehicleSafetyExtensions',
        'special_vehicle_extensions': 'j2735_v2x_msgs/SpecialVehicleExtensions',
        'supplemental_vehicle_extensions': 'j2735_v2x_msgs/SupplementalVehicleExtensions',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'VehicleSafetyExtensions'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'SpecialVehicleExtensions'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'SupplementalVehicleExtensions'),  # noqa: E501
    )
