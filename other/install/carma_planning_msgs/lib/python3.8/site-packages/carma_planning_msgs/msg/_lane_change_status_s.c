...
bool carma_planning_msgs__msg__lane_change_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_planning_msgs.msg._lane_change_status.LaneChangeStatus", full_classname_dest, 60) == 0);
  }
  carma_planning_msgs__msg__LaneChangeStatus * ros_message = _ros_message;
  {  // status
...
PyObject * carma_planning_msgs__msg__lane_change_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_planning_msgs.msg._lane_change_status");
