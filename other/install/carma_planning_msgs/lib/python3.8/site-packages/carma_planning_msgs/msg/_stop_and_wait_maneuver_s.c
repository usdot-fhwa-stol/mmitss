...
bool carma_planning_msgs__msg__stop_and_wait_maneuver__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_planning_msgs.msg._stop_and_wait_maneuver.StopAndWaitManeuver", full_classname_dest, 67) == 0);
  }
  carma_planning_msgs__msg__StopAndWaitManeuver * ros_message = _ros_message;
  {  // parameters
...
{
  /* NOTE(esteve): Call constructor of StopAndWaitManeuver */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_planning_msgs.msg._stop_and_wait_maneuver");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StopAndWaitManeuver");
