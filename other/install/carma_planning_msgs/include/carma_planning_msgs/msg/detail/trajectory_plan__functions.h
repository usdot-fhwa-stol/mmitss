...
#ifndef CARMA_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_PLAN__FUNCTIONS_H_
#define CARMA_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_PLAN__FUNCTIONS_H_
 ...
 * calls
 * carma_planning_msgs__msg__TrajectoryPlan__init().
...
/**
 * It calls
 * carma_planning_msgs__msg__TrajectoryPlan__fini()
 ...
 * carma_planning_msgs__msg__TrajectoryPlan__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * carma_planning_msgs__msg__TrajectoryPlan__Sequence__fini()
 * on the array,
...
#endif  // CARMA_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_PLAN__FUNCTIONS_H_
