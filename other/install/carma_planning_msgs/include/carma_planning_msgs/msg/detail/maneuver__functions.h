...
#ifndef CARMA_PLANNING_MSGS__MSG__DETAIL__MANEUVER__FUNCTIONS_H_
#define CARMA_PLANNING_MSGS__MSG__DETAIL__MANEUVER__FUNCTIONS_H_
 ...
 * calls
 * carma_planning_msgs__msg__Maneuver__init().
...
/**
 * It calls
 * carma_planning_msgs__msg__Maneuver__fini()
 ...
 * carma_planning_msgs__msg__Maneuver__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * carma_planning_msgs__msg__Maneuver__Sequence__fini()
 * on the array,
...
#endif  // CARMA_PLANNING_MSGS__MSG__DETAIL__MANEUVER__FUNCTIONS_H_
