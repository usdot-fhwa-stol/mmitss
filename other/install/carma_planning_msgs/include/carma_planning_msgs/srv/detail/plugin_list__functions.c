...
carma_planning_msgs__srv__PluginList_Request__create()
{
  ...
  carma_planning_msgs__srv__PluginList_Request * msg = (carma_planning_msgs__srv__PluginList_Request *)allocator.allocate(sizeof(carma_planning_msgs__srv__PluginList_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(carma_planning_msgs__srv__PluginList_Request));
  bool success = carma_planning_msgs__srv__PluginList_Request__init(msg);
  if (!success) {
...
carma_planning_msgs__srv__PluginList_Request__destroy(carma_planning_msgs__srv__PluginList_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    carma_planning_msgs__srv__PluginList_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
carma_planning_msgs__srv__PluginList_Request__Sequence__init(carma_planning_msgs__srv__PluginList_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_planning_msgs__srv__PluginList_Request * data = NULL;

  if (size) {
    data = (carma_planning_msgs__srv__PluginList_Request *)allocator.zero_allocate(size, sizeof(carma_planning_msgs__srv__PluginList_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = carma_planning_msgs__srv__PluginList_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        carma_planning_msgs__srv__PluginList_Request__fini(&data[i - 1]);
      }
...
carma_planning_msgs__srv__PluginList_Request__Sequence__fini(carma_planning_msgs__srv__PluginList_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      carma_planning_msgs__srv__PluginList_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_planning_msgs__srv__PluginList_Request__Sequence * array = (carma_planning_msgs__srv__PluginList_Request__Sequence *)allocator.allocate(sizeof(carma_planning_msgs__srv__PluginList_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = carma_planning_msgs__srv__PluginList_Request__Sequence__init(array, size);
  if (!success) {
...
carma_planning_msgs__srv__PluginList_Request__Sequence__destroy(carma_planning_msgs__srv__PluginList_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    carma_planning_msgs__srv__PluginList_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
carma_planning_msgs__srv__PluginList_Request__Sequence__are_equal(const carma_planning_msgs__srv__PluginList_Request__Sequence * lhs, const carma_planning_msgs__srv__PluginList_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!carma_planning_msgs__srv__PluginList_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  carma_planning_msgs__srv__PluginList_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(carma_planning_msgs__srv__PluginList_Request);
    carma_planning_msgs__srv__PluginList_Request * data =
      (carma_planning_msgs__srv__PluginList_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carma_planning_msgs__srv__PluginList_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          carma_planning_msgs__srv__PluginList_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!carma_planning_msgs__srv__PluginList_Request__copy(
...
carma_planning_msgs__srv__PluginList_Response__init(carma_planning_msgs__srv__PluginList_Response * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    carma_planning_msgs__srv__PluginList_Response__fini(msg);
    return false;
  }
  // plugins
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_planning_msgs__srv__PluginList_Response * msg = (carma_planning_msgs__srv__PluginList_Response *)allocator.allocate(sizeof(carma_planning_msgs__srv__PluginList_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(carma_planning_msgs__srv__PluginList_Response));
  bool success = carma_planning_msgs__srv__PluginList_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
carma_planning_msgs__srv__PluginList_Response__Sequence__init(carma_planning_msgs__srv__PluginList_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_planning_msgs__srv__PluginList_Response * data = NULL;

  if (size) {
    data = (carma_planning_msgs__srv__PluginList_Response *)allocator.zero_allocate(size, sizeof(carma_planning_msgs__srv__PluginList_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = carma_planning_msgs__srv__PluginList_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        carma_planning_msgs__srv__PluginList_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
carma_planning_msgs__srv__PluginList_Response__Sequence__fini(carma_planning_msgs__srv__PluginList_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      carma_planning_msgs__srv__PluginList_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_planning_msgs__srv__PluginList_Response__Sequence * array = (carma_planning_msgs__srv__PluginList_Response__Sequence *)allocator.allocate(sizeof(carma_planning_msgs__srv__PluginList_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = carma_planning_msgs__srv__PluginList_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
carma_planning_msgs__srv__PluginList_Response__Sequence__destroy(carma_planning_msgs__srv__PluginList_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    carma_planning_msgs__srv__PluginList_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
carma_planning_msgs__srv__PluginList_Response__Sequence__are_equal(const carma_planning_msgs__srv__PluginList_Response__Sequence * lhs, const carma_planning_msgs__srv__PluginList_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!carma_planning_msgs__srv__PluginList_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  carma_planning_msgs__srv__PluginList_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(carma_planning_msgs__srv__PluginList_Response);
    carma_planning_msgs__srv__PluginList_Response * data =
      (carma_planning_msgs__srv__PluginList_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carma_planning_msgs__srv__PluginList_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          carma_planning_msgs__srv__PluginList_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!carma_planning_msgs__srv__PluginList_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
