...
bool carma_msgs__srv__request_indicator_control__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_msgs.srv._request_indicator_control.RequestIndicatorControl_Request", full_classname_dest, 73) == 0);
  }
  carma_msgs__srv__RequestIndicatorControl_Request * ros_message = _ros_message;
  {  // ind_list
...
{
  /* NOTE(esteve): Call constructor of RequestIndicatorControl_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_msgs.srv._request_indicator_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RequestIndicatorControl_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool carma_msgs__srv__request_indicator_control__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_msgs.srv._request_indicator_control.RequestIndicatorControl_Response", full_classname_dest, 74) == 0);
  }
  carma_msgs__srv__RequestIndicatorControl_Response * ros_message = _ros_message;
  {  // ind_list
    PyObject * field = PyObject_GetAttrString(_pymsg, "ind_list");
    if (!field) {
      return false;
...
{
  /* NOTE(esteve): Call constructor of RequestIndicatorControl_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_msgs.srv._request_indicator_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RequestIndicatorControl_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
