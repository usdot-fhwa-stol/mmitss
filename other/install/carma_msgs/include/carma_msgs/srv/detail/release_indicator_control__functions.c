  ...
  carma_msgs__srv__ReleaseIndicatorControl_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    carma_msgs__srv__ReleaseIndicatorControl_Request * data =
      (carma_msgs__srv__ReleaseIndicatorControl_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carma_msgs__srv__ReleaseIndicatorControl_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          carma_msgs__srv__ReleaseIndicatorControl_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  carma_msgs__srv__ReleaseIndicatorControl_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    carma_msgs__srv__ReleaseIndicatorControl_Response * data =
      (carma_msgs__srv__ReleaseIndicatorControl_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carma_msgs__srv__ReleaseIndicatorControl_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          carma_msgs__srv__ReleaseIndicatorControl_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
