...
bool j3224_v2x_msgs__msg__detected_vehicle_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j3224_v2x_msgs.msg._detected_vehicle_data.DetectedVehicleData", full_classname_dest, 61) == 0);
  }
  j3224_v2x_msgs__msg__DetectedVehicleData * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // veh_attitude
    ...
    if (!j3224_v2x_msgs__msg__attitude__convert_from_py(field, &ros_message->veh_attitude)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // veh_ang_vel
    ...
    if (!j3224_v2x_msgs__msg__angular_velocity__convert_from_py(field, &ros_message->veh_ang_vel)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j3224_v2x_msgs__msg__detected_vehicle_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j3224_v2x_msgs.msg._detected_vehicle_data");
  ...
  {  // veh_attitude
    PyObject * field = NULL;
    field = j3224_v2x_msgs__msg__attitude__convert_to_py(&ros_message->veh_attitude);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // veh_ang_vel
    PyObject * field = NULL;
    field = j3224_v2x_msgs__msg__angular_velocity__convert_to_py(&ros_message->veh_ang_vel);
    if (!field) {
      return NULL;
    }
    {
