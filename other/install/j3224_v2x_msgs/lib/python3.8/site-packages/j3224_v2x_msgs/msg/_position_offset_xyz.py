...
class Metaclass_PositionOffsetXYZ(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j3224_v2x_msgs.msg import ObjectDistance
...
class PositionOffsetXYZ(metaclass=Metaclass_PositionOffsetXYZ):
    ...
    _fields_and_field_types = {
        'offset_x': 'j3224_v2x_msgs/ObjectDistance',
        'offset_y': 'j3224_v2x_msgs/ObjectDistance',
        'presence_vector': 'uint8',
        'offset_z': 'j3224_v2x_msgs/ObjectDistance',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'ObjectDistance'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'ObjectDistance'),  # noqa: E501
