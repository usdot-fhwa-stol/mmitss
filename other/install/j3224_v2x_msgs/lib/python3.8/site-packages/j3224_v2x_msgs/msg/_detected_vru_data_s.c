...
bool j3224_v2x_msgs__msg__detected_vru_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j3224_v2x_msgs.msg._detected_vru_data.DetectedVRUData", full_classname_dest, 53) == 0);
  }
  j3224_v2x_msgs__msg__DetectedVRUData * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // radius
    ...
    if (!j2735_v2x_msgs__msg__attachment_radius__convert_from_py(field, &ros_message->radius)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j3224_v2x_msgs__msg__detected_vru_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j3224_v2x_msgs.msg._detected_vru_data");
  ...
  {  // radius
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__attachment_radius__convert_to_py(&ros_message->radius);
    if (!field) {
      return NULL;
    }
    {
