...
class Metaclass_DetectedObstacleData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from j3224_v2x_msgs.msg import ObstacleSize
...
class DetectedObstacleData(metaclass=Metaclass_DetectedObstacleData):
    ...
    _fields_and_field_types = {
        'obst_size': 'j3224_v2x_msgs/ObstacleSize',
        'obst_size_confidence': 'j3224_v2x_msgs/ObstacleSizeConfidence',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'ObstacleSize'),  # noqa: E501
