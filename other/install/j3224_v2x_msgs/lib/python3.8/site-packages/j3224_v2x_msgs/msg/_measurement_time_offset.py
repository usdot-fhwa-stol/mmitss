...
class Metaclass_MeasurementTimeOffset(type):
    ...
    __constants = {
        'MIN_MEASUREMENT_TIME_OFFSET': -1500,
        'MAX_MEASUREMENT_TIME_OFFSET': 1500,
    }
...
class MeasurementTimeOffset(metaclass=Metaclass_MeasurementTimeOffset):
    ...
    def __init__(self, **kwargs):
        ...
        self.measurement_time_offset = kwargs.get('measurement_time_offset', int())
    ...
    def measurement_time_offset(self, value):
        if __debug__:
            assert \
                ...
                "The 'measurement_time_offset' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'measurement_time_offset' field must be an integer in [-32768, 32767]"
