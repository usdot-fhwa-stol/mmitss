...
bool j3224_v2x_msgs__msg__sensor_data_sharing_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j3224_v2x_msgs.msg._sensor_data_sharing_message.SensorDataSharingMessage", full_classname_dest, 72) == 0);
  }
  j3224_v2x_msgs__msg__SensorDataSharingMessage * ros_message = _ros_message;
  {  // msg_cnt
  ...
  {  // ref_pos
    ...
    if (!j2735_v2x_msgs__msg__position3_d__convert_from_py(field, &ros_message->ref_pos)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // ref_pos_xy_conf
    ...
    if (!j2735_v2x_msgs__msg__positional_accuracy__convert_from_py(field, &ros_message->ref_pos_xy_conf)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // objects
    ...
    if (!j3224_v2x_msgs__msg__detected_object_list__convert_from_py(field, &ros_message->objects)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * j3224_v2x_msgs__msg__sensor_data_sharing_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j3224_v2x_msgs.msg._sensor_data_sharing_message");
  ...
  {  // ref_pos
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__position3_d__convert_to_py(&ros_message->ref_pos);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // ref_pos_xy_conf
    PyObject * field = NULL;
    field = j2735_v2x_msgs__msg__positional_accuracy__convert_to_py(&ros_message->ref_pos_xy_conf);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // objects
    PyObject * field = NULL;
    field = j3224_v2x_msgs__msg__detected_object_list__convert_to_py(&ros_message->objects);
    if (!field) {
      return NULL;
    }
    {
