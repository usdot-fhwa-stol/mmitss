...
bool j3224_v2x_msgs__msg__object_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("j3224_v2x_msgs.msg._object_type.ObjectType", full_classname_dest, 42) == 0);
  }
  j3224_v2x_msgs__msg__ObjectType * ros_message = _ros_message;
  {  // object_type
...
PyObject * j3224_v2x_msgs__msg__object_type__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("j3224_v2x_msgs.msg._object_type");
