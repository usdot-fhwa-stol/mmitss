...
class DetectedObjectOptionalData(metaclass=Metaclass_DetectedObjectOptionalData):
    ...
    _fields_and_field_types = {
        'choice': 'uint8',
        'det_veh': 'j3224_v2x_msgs/DetectedVehicleData',
        'det_vru': 'j3224_v2x_msgs/DetectedVRUData',
        'det_obst': 'j3224_v2x_msgs/DetectedObstacleData',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'DetectedVehicleData'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'DetectedVRUData'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['j3224_v2x_msgs', 'msg'], 'DetectedObstacleData'),  # noqa: E501
    )
