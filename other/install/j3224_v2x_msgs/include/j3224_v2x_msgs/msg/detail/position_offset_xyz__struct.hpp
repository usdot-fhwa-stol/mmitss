...
#ifndef J3224_V2X_MSGS__MSG__DETAIL__POSITION_OFFSET_XYZ__STRUCT_HPP_
#define J3224_V2X_MSGS__MSG__DETAIL__POSITION_OFFSET_XYZ__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__j3224_v2x_msgs__msg__PositionOffsetXYZ __attribute__((deprecated))
#else
# define DEPRECATED__j3224_v2x_msgs__msg__PositionOffsetXYZ __declspec(deprecated)
#endif
...
struct PositionOffsetXYZ_
{
  ...
  Type & set__offset_x(
    const j3224_v2x_msgs::msg::ObjectDistance_<ContainerAllocator> & _arg)
  {
    this->offset_x = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__j3224_v2x_msgs__msg__PositionOffsetXYZ
    std::shared_ptr<j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__j3224_v2x_msgs__msg__PositionOffsetXYZ
    std::shared_ptr<j3224_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator> const>
...
using PositionOffsetXYZ =
  j3224_v2x_msgs::msg::PositionOffsetXYZ_<std::allocator<void>>;
...
#endif  // J3224_V2X_MSGS__MSG__DETAIL__POSITION_OFFSET_XYZ__STRUCT_HPP_
