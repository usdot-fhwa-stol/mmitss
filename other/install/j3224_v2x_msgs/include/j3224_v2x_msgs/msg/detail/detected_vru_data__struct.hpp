...
#ifndef J3224_V2X_MSGS__MSG__DETAIL__DETECTED_VRU_DATA__STRUCT_HPP_
#define J3224_V2X_MSGS__MSG__DETAIL__DETECTED_VRU_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__j3224_v2x_msgs__msg__DetectedVRUData __attribute__((deprecated))
#else
# define DEPRECATED__j3224_v2x_msgs__msg__DetectedVRUData __declspec(deprecated)
#endif
...
struct DetectedVRUData_
{
  ...
  using ConstRawPtr =
    const j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__j3224_v2x_msgs__msg__DetectedVRUData
    std::shared_ptr<j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__j3224_v2x_msgs__msg__DetectedVRUData
    std::shared_ptr<j3224_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator> const>
...
using DetectedVRUData =
  j3224_v2x_msgs::msg::DetectedVRUData_<std::allocator<void>>;
...
#endif  // J3224_V2X_MSGS__MSG__DETAIL__DETECTED_VRU_DATA__STRUCT_HPP_
