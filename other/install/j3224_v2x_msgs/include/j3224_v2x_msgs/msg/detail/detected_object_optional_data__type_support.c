...
#include <stddef.h>
#include "j3224_v2x_msgs/msg/detail/detected_object_optional_data__rosidl_typesupport_introspection_c.h"
...
// Member `det_veh`
#include "j3224_v2x_msgs/msg/detected_vehicle_data.h"
// Member `det_veh`
#include "j3224_v2x_msgs/msg/detail/detected_vehicle_data__rosidl_typesupport_introspection_c.h"
// Member `det_vru`
#include "j3224_v2x_msgs/msg/detected_vru_data.h"
// Member `det_vru`
#include "j3224_v2x_msgs/msg/detail/detected_vru_data__rosidl_typesupport_introspection_c.h"
// Member `det_obst`
#include "j3224_v2x_msgs/msg/detected_obstacle_data.h"
// Member `det_obst`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  j3224_v2x_msgs__msg__DetectedObjectOptionalData__init(message_memory);
}
...
{
  j3224_v2x_msgs__msg__DetectedObjectOptionalData__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember DetectedObjectOptionalData__rosidl_typesupport_introspection_c__DetectedObjectOptionalData_message_member_array[4] = {
  {
    ...
    offsetof(j3224_v2x_msgs__msg__DetectedObjectOptionalData, choice),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedObjectOptionalData, det_veh),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedObjectOptionalData, det_vru),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedObjectOptionalData, det_obst),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectedObjectOptionalData__rosidl_typesupport_introspection_c__DetectedObjectOptionalData_message_members = {
  ...
  4,  // number of fields
  sizeof(j3224_v2x_msgs__msg__DetectedObjectOptionalData),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j3224_v2x_msgs, msg, DetectedObjectOptionalData)() {
  ...
  DetectedObjectOptionalData__rosidl_typesupport_introspection_c__DetectedObjectOptionalData_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j3224_v2x_msgs, msg, DetectedVRUData)();
