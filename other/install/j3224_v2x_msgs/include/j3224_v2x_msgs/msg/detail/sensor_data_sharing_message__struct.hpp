...
#ifndef J3224_V2X_MSGS__MSG__DETAIL__SENSOR_DATA_SHARING_MESSAGE__STRUCT_HPP_
#define J3224_V2X_MSGS__MSG__DETAIL__SENSOR_DATA_SHARING_MESSAGE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__j3224_v2x_msgs__msg__SensorDataSharingMessage __attribute__((deprecated))
#else
# define DEPRECATED__j3224_v2x_msgs__msg__SensorDataSharingMessage __declspec(deprecated)
#endif
...
struct SensorDataSharingMessage_
{
  ...
  Type & set__objects(
    const j3224_v2x_msgs::msg::DetectedObjectList_<ContainerAllocator> & _arg)
  {
    this->objects = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator> *;
  using ConstRawPtr =
    const j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__j3224_v2x_msgs__msg__SensorDataSharingMessage
    std::shared_ptr<j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__j3224_v2x_msgs__msg__SensorDataSharingMessage
    std::shared_ptr<j3224_v2x_msgs::msg::SensorDataSharingMessage_<ContainerAllocator> const>
...
using SensorDataSharingMessage =
  j3224_v2x_msgs::msg::SensorDataSharingMessage_<std::allocator<void>>;
...
#endif  // J3224_V2X_MSGS__MSG__DETAIL__SENSOR_DATA_SHARING_MESSAGE__STRUCT_HPP_
