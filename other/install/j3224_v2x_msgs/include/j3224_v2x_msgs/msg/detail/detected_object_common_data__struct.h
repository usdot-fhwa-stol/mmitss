...
#ifndef J3224_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_COMMON_DATA__STRUCT_H_
#define J3224_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_COMMON_DATA__STRUCT_H_
...
enum
{
  j3224_v2x_msgs__msg__DetectedObjectCommonData__HAS_SPEED_Z = 1
};

/// Constant 'HAS_SPEED_CONFIDENCE_Z'.
enum
{
  j3224_v2x_msgs__msg__DetectedObjectCommonData__HAS_SPEED_CONFIDENCE_Z = 2
};

/// Constant 'HAS_ACCEL_4_WAY'.
enum
{
  j3224_v2x_msgs__msg__DetectedObjectCommonData__HAS_ACCEL_4_WAY = 4
};

/// Constant 'HAS_ACC_CFD_X'.
enum
{
  j3224_v2x_msgs__msg__DetectedObjectCommonData__HAS_ACC_CFD_X = 8
};

/// Constant 'HAS_ACC_CFD_Y'.
enum
{
  j3224_v2x_msgs__msg__DetectedObjectCommonData__HAS_ACC_CFD_Y = 16
};

/// Constant 'HAS_ACC_CFD_Z'.
enum
{
  j3224_v2x_msgs__msg__DetectedObjectCommonData__HAS_ACC_CFD_Z = 32
};

/// Constant 'HAS_ACC_CFD_YAW'.
enum
{
  j3224_v2x_msgs__msg__DetectedObjectCommonData__HAS_ACC_CFD_YAW = 64
};
...
// Struct defined in msg/DetectedObjectCommonData in the package j3224_v2x_msgs.
typedef struct j3224_v2x_msgs__msg__DetectedObjectCommonData
{
  ...
  j3224_v2x_msgs__msg__MeasurementTimeOffset measurement_time;
  j2735_v2x_msgs__msg__TimeConfidence time_confidence;
  j3224_v2x_msgs__msg__PositionOffsetXYZ pos;
  ...
  j2735_v2x_msgs__msg__Speed speed_z;
  j2735_v2x_msgs__msg__SpeedConfidence speed_confidence_z;
  j2735_v2x_msgs__msg__AccelerationSet4Way accel_4_way;
...
// Struct for a sequence of j3224_v2x_msgs__msg__DetectedObjectCommonData.
typedef struct j3224_v2x_msgs__msg__DetectedObjectCommonData__Sequence
{
...
#endif  // J3224_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_COMMON_DATA__STRUCT_H_
