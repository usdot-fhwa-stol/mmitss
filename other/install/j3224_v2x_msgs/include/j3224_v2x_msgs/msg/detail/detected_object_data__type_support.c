...
#include <stddef.h>
#include "j3224_v2x_msgs/msg/detail/detected_object_data__rosidl_typesupport_introspection_c.h"
...
#include "j3224_v2x_msgs/msg/detected_object_common_data.h"
// Member `detected_object_common_data`
...
#include "j3224_v2x_msgs/msg/detected_object_optional_data.h"
// Member `detected_object_optional_data`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  j3224_v2x_msgs__msg__DetectedObjectData__init(message_memory);
}

void DetectedObjectData__rosidl_typesupport_introspection_c__DetectedObjectData_fini_function(void * message_memory)
{
  j3224_v2x_msgs__msg__DetectedObjectData__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember DetectedObjectData__rosidl_typesupport_introspection_c__DetectedObjectData_message_member_array[3] = {
  {
    ...
    offsetof(j3224_v2x_msgs__msg__DetectedObjectData, detected_object_common_data),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedObjectData, presence_vector),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__DetectedObjectData, detected_object_optional_data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectedObjectData__rosidl_typesupport_introspection_c__DetectedObjectData_message_members = {
  ...
  3,  // number of fields
  sizeof(j3224_v2x_msgs__msg__DetectedObjectData),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j3224_v2x_msgs, msg, DetectedObjectData)() {
