...
// Member `pitch`
#include "j3224_v2x_msgs/msg/pitch_detected.h"
// Member `pitch`
#include "j3224_v2x_msgs/msg/detail/pitch_detected__rosidl_typesupport_introspection_c.h"
// Member `roll`
#include "j3224_v2x_msgs/msg/roll_detected.h"
// Member `roll`
#include "j3224_v2x_msgs/msg/detail/roll_detected__rosidl_typesupport_introspection_c.h"
// Member `yaw`
#include "j3224_v2x_msgs/msg/yaw_detected.h"
// Member `yaw`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  j3224_v2x_msgs__msg__Attitude__init(message_memory);
}

void Attitude__rosidl_typesupport_introspection_c__Attitude_fini_function(void * message_memory)
{
  j3224_v2x_msgs__msg__Attitude__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Attitude__rosidl_typesupport_introspection_c__Attitude_message_member_array[3] = {
  {
    ...
    offsetof(j3224_v2x_msgs__msg__Attitude, pitch),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__Attitude, roll),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(j3224_v2x_msgs__msg__Attitude, yaw),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Attitude__rosidl_typesupport_introspection_c__Attitude_message_members = {
  ...
  3,  // number of fields
  sizeof(j3224_v2x_msgs__msg__Attitude),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j3224_v2x_msgs, msg, Attitude)() {
  Attitude__rosidl_typesupport_introspection_c__Attitude_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, j3224_v2x_msgs, msg, PitchDetected)();
