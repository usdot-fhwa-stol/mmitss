...
#include <stddef.h>
#include "carma_v2x_msgs/msg/detail/node_offset_point_xy__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__NodeOffsetPointXY__init(message_memory);
}

void NodeOffsetPointXY__rosidl_typesupport_introspection_c__NodeOffsetPointXY_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__NodeOffsetPointXY__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember NodeOffsetPointXY__rosidl_typesupport_introspection_c__NodeOffsetPointXY_message_member_array[5] = {
  {
    "choice",  // name
    ...
    offsetof(carma_v2x_msgs__msg__NodeOffsetPointXY, choice),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__NodeOffsetPointXY, x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__NodeOffsetPointXY, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__NodeOffsetPointXY, longitude),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__NodeOffsetPointXY, latitude),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers NodeOffsetPointXY__rosidl_typesupport_introspection_c__NodeOffsetPointXY_message_members = {
  ...
  5,  // number of fields
  sizeof(carma_v2x_msgs__msg__NodeOffsetPointXY),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, NodeOffsetPointXY)() {
