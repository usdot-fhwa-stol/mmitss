...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_COMMON_DATA__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_COMMON_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__DetectedObjectCommonData __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__DetectedObjectCommonData __declspec(deprecated)
#endif
...
struct DetectedObjectCommonData_
{
  ...
  Type & set__measurement_time(
    const carma_v2x_msgs::msg::MeasurementTimeOffset_<ContainerAllocator> & _arg)
  {
  ...
  Type & set__pos(
    const carma_v2x_msgs::msg::PositionOffsetXYZ_<ContainerAllocator> & _arg)
  {
    this->pos = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__DetectedObjectCommonData
    std::shared_ptr<carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__DetectedObjectCommonData
    std::shared_ptr<carma_v2x_msgs::msg::DetectedObjectCommonData_<ContainerAllocator> const>
...
using DetectedObjectCommonData =
  carma_v2x_msgs::msg::DetectedObjectCommonData_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_COMMON_DATA__STRUCT_HPP_
