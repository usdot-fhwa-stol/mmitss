...
#include <stddef.h>
#include "carma_v2x_msgs/msg/detail/traffic_control_request__rosidl_typesupport_introspection_c.h"
...
// Member `tcr_v01`
#include "carma_v2x_msgs/msg/traffic_control_request_v01.h"
// Member `tcr_v01`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__TrafficControlRequest__init(message_memory);
}

void TrafficControlRequest__rosidl_typesupport_introspection_c__TrafficControlRequest_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__TrafficControlRequest__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrafficControlRequest__rosidl_typesupport_introspection_c__TrafficControlRequest_message_member_array[2] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__TrafficControlRequest, choice),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlRequest, tcr_v01),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrafficControlRequest__rosidl_typesupport_introspection_c__TrafficControlRequest_message_members = {
  ...
  2,  // number of fields
  sizeof(carma_v2x_msgs__msg__TrafficControlRequest),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, TrafficControlRequest)() {
