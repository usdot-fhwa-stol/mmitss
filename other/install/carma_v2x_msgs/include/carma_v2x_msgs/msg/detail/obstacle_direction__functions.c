...
carma_v2x_msgs__msg__ObstacleDirection__init(carma_v2x_msgs__msg__ObstacleDirection * msg)
{
  ...
  // direction
  if (!carma_v2x_msgs__msg__Angle__init(&msg->direction)) {
    carma_v2x_msgs__msg__ObstacleDirection__fini(msg);
    return false;
  }
  return true;
}
...
carma_v2x_msgs__msg__ObstacleDirection__fini(carma_v2x_msgs__msg__ObstacleDirection * msg)
{
  ...
  // direction
  carma_v2x_msgs__msg__Angle__fini(&msg->direction);
}
...
carma_v2x_msgs__msg__ObstacleDirection__create()
{
  ...
  carma_v2x_msgs__msg__ObstacleDirection * msg = (carma_v2x_msgs__msg__ObstacleDirection *)allocator.allocate(sizeof(carma_v2x_msgs__msg__ObstacleDirection), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(carma_v2x_msgs__msg__ObstacleDirection));
  bool success = carma_v2x_msgs__msg__ObstacleDirection__init(msg);
  if (!success) {
...
carma_v2x_msgs__msg__ObstacleDirection__Sequence__init(carma_v2x_msgs__msg__ObstacleDirection__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_v2x_msgs__msg__ObstacleDirection * data = NULL;

  if (size) {
    data = (carma_v2x_msgs__msg__ObstacleDirection *)allocator.zero_allocate(size, sizeof(carma_v2x_msgs__msg__ObstacleDirection), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = carma_v2x_msgs__msg__ObstacleDirection__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        carma_v2x_msgs__msg__ObstacleDirection__fini(&data[i - 1]);
      }
...
carma_v2x_msgs__msg__ObstacleDirection__Sequence__fini(carma_v2x_msgs__msg__ObstacleDirection__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      carma_v2x_msgs__msg__ObstacleDirection__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_v2x_msgs__msg__ObstacleDirection__Sequence * array = (carma_v2x_msgs__msg__ObstacleDirection__Sequence *)allocator.allocate(sizeof(carma_v2x_msgs__msg__ObstacleDirection__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = carma_v2x_msgs__msg__ObstacleDirection__Sequence__init(array, size);
  if (!success) {
...
carma_v2x_msgs__msg__ObstacleDirection__Sequence__destroy(carma_v2x_msgs__msg__ObstacleDirection__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    carma_v2x_msgs__msg__ObstacleDirection__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
carma_v2x_msgs__msg__ObstacleDirection__Sequence__are_equal(const carma_v2x_msgs__msg__ObstacleDirection__Sequence * lhs, const carma_v2x_msgs__msg__ObstacleDirection__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!carma_v2x_msgs__msg__ObstacleDirection__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  carma_v2x_msgs__msg__ObstacleDirection__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(carma_v2x_msgs__msg__ObstacleDirection);
    carma_v2x_msgs__msg__ObstacleDirection * data =
      (carma_v2x_msgs__msg__ObstacleDirection *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carma_v2x_msgs__msg__ObstacleDirection__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          carma_v2x_msgs__msg__ObstacleDirection__fini(&data[i]);
        }
        free(data);
        return false;
      }
