...
{
  new (message_memory) carma_v2x_msgs::msg::VehicleLength(_init);
}

void VehicleLength_fini_function(void * message_memory)
{
  auto typed_message = static_cast<carma_v2x_msgs::msg::VehicleLength *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleLength_message_member_array[2] = {
  {
    ...
    offsetof(carma_v2x_msgs::msg::VehicleLength, vehicle_length),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::VehicleLength, unavailable),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleLength_message_members = {
  ...
  2,  // number of fields
  sizeof(carma_v2x_msgs::msg::VehicleLength),
...
get_message_type_support_handle<carma_v2x_msgs::msg::VehicleLength>()
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleLength_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, VehicleLength)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleLength_message_type_support_handle;
}
