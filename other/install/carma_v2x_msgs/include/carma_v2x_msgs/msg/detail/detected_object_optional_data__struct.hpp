...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_OPTIONAL_DATA__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_OPTIONAL_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__DetectedObjectOptionalData __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__DetectedObjectOptionalData __declspec(deprecated)
#endif
...
struct DetectedObjectOptionalData_
{
  ...
  _choice_type choice;
  using _det_veh_type =
    carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator>;
  ...
  Type & set__det_veh(
    const carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator> & _arg)
  {
    this->det_veh = _arg;
    return *this;
  }
  Type & set__det_vru(
    const carma_v2x_msgs::msg::DetectedVRUData_<ContainerAllocator> & _arg)
  {
    this->det_vru = _arg;
    return *this;
  }
  Type & set__det_obst(
    const carma_v2x_msgs::msg::DetectedObstacleData_<ContainerAllocator> & _arg)
  {
    this->det_obst = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__DetectedObjectOptionalData
    std::shared_ptr<carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__DetectedObjectOptionalData
    std::shared_ptr<carma_v2x_msgs::msg::DetectedObjectOptionalData_<ContainerAllocator> const>
...
using DetectedObjectOptionalData =
  carma_v2x_msgs::msg::DetectedObjectOptionalData_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_OBJECT_OPTIONAL_DATA__STRUCT_HPP_
