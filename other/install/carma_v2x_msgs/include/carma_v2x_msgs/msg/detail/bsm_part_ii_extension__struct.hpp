...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__BSM_PART_II_EXTENSION__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__BSM_PART_II_EXTENSION__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__BSMPartIIExtension __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__BSMPartIIExtension __declspec(deprecated)
#endif
...
struct BSMPartIIExtension_
{
  ...
  using _special_vehicle_extensions_type =
    carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator>;
  ...
  Type & set__vehicle_safety_extensions(
    const carma_v2x_msgs::msg::VehicleSafetyExtensions_<ContainerAllocator> & _arg)
  {
    this->vehicle_safety_extensions = _arg;
    return *this;
  }
  Type & set__special_vehicle_extensions(
    const carma_v2x_msgs::msg::SpecialVehicleExtensions_<ContainerAllocator> & _arg)
  {
    this->special_vehicle_extensions = _arg;
    return *this;
  }
  Type & set__supplemental_vehicle_extensions(
    const carma_v2x_msgs::msg::SupplementalVehicleExtensions_<ContainerAllocator> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator> *;
  using ConstRawPtr =
    const carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__BSMPartIIExtension
    std::shared_ptr<carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__BSMPartIIExtension
    std::shared_ptr<carma_v2x_msgs::msg::BSMPartIIExtension_<ContainerAllocator> const>
...
using BSMPartIIExtension =
  carma_v2x_msgs::msg::BSMPartIIExtension_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__BSM_PART_II_EXTENSION__STRUCT_HPP_
