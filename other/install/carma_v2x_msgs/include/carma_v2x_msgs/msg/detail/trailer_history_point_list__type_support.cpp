...
{
  new (message_memory) carma_v2x_msgs::msg::TrailerHistoryPointList(_init);
}

void TrailerHistoryPointList_fini_function(void * message_memory)
{
  auto typed_message = static_cast<carma_v2x_msgs::msg::TrailerHistoryPointList *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<carma_v2x_msgs::msg::TrailerHistoryPoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<carma_v2x_msgs::msg::TrailerHistoryPoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<carma_v2x_msgs::msg::TrailerHistoryPoint> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrailerHistoryPointList_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<carma_v2x_msgs::msg::TrailerHistoryPoint>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::TrailerHistoryPointList, trailer_history_points),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrailerHistoryPointList_message_members = {
  ...
  1,  // number of fields
  sizeof(carma_v2x_msgs::msg::TrailerHistoryPointList),
...
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::TrailerHistoryPointList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, TrailerHistoryPointList)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::TrailerHistoryPointList_message_type_support_handle;
}
