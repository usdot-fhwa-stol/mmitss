...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__TRAFFIC_CONTROL_MESSAGE_V01__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__TRAFFIC_CONTROL_MESSAGE_V01__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__TrafficControlMessageV01 __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__TrafficControlMessageV01 __declspec(deprecated)
#endif
...
struct TrafficControlMessageV01_
{
  ...
  using _params_type =
    carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator>;
  _params_type params;
  ...
  Type & set__params(
    const carma_v2x_msgs::msg::TrafficControlParams_<ContainerAllocator> & _arg)
  {
    this->params = _arg;
    return *this;
  }
  ...
  Type & set__geometry(
    const carma_v2x_msgs::msg::TrafficControlGeometry_<ContainerAllocator> & _arg)
  {
    this->geometry = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator> *;
  using ConstRawPtr =
    const carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__TrafficControlMessageV01
    std::shared_ptr<carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__TrafficControlMessageV01
    std::shared_ptr<carma_v2x_msgs::msg::TrafficControlMessageV01_<ContainerAllocator> const>
...
using TrafficControlMessageV01 =
  carma_v2x_msgs::msg::TrafficControlMessageV01_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__TRAFFIC_CONTROL_MESSAGE_V01__STRUCT_HPP_
