...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_VEHICLE_DATA__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_VEHICLE_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__DetectedVehicleData __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__DetectedVehicleData __declspec(deprecated)
#endif
...
struct DetectedVehicleData_
{
  ...
  using _veh_ang_vel_type =
    carma_v2x_msgs::msg::AngularVelocity_<ContainerAllocator>;
  ...
  Type & set__veh_attitude(
    const carma_v2x_msgs::msg::Attitude_<ContainerAllocator> & _arg)
  {
  ...
  Type & set__veh_ang_vel(
    const carma_v2x_msgs::msg::AngularVelocity_<ContainerAllocator> & _arg)
  {
  ...
  using ConstRawPtr =
    const carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__DetectedVehicleData
    std::shared_ptr<carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__DetectedVehicleData
    std::shared_ptr<carma_v2x_msgs::msg::DetectedVehicleData_<ContainerAllocator> const>
...
using DetectedVehicleData =
  carma_v2x_msgs::msg::DetectedVehicleData_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__DETECTED_VEHICLE_DATA__STRUCT_HPP_
