...
#ifndef CARMA_V2X_MSGS__MSG__DETAIL__TRANSMISSION_AND_SPEED__STRUCT_HPP_
#define CARMA_V2X_MSGS__MSG__DETAIL__TRANSMISSION_AND_SPEED__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__carma_v2x_msgs__msg__TransmissionAndSpeed __attribute__((deprecated))
#else
# define DEPRECATED__carma_v2x_msgs__msg__TransmissionAndSpeed __declspec(deprecated)
#endif
...
struct TransmissionAndSpeed_
{
  ...
  using ConstRawPtr =
    const carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__carma_v2x_msgs__msg__TransmissionAndSpeed
    std::shared_ptr<carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__carma_v2x_msgs__msg__TransmissionAndSpeed
    std::shared_ptr<carma_v2x_msgs::msg::TransmissionAndSpeed_<ContainerAllocator> const>
...
using TransmissionAndSpeed =
  carma_v2x_msgs::msg::TransmissionAndSpeed_<std::allocator<void>>;
...
#endif  // CARMA_V2X_MSGS__MSG__DETAIL__TRANSMISSION_AND_SPEED__STRUCT_HPP_
