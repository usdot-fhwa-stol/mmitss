...
// Member `ob_dist`
#include "carma_v2x_msgs/msg/obstacle_distance.h"
// Member `ob_dist`
#include "carma_v2x_msgs/msg/detail/obstacle_distance__rosidl_typesupport_introspection_c.h"
// Member `ob_direct`
#include "carma_v2x_msgs/msg/obstacle_direction.h"
// Member `ob_direct`
#include "carma_v2x_msgs/msg/detail/obstacle_direction__rosidl_typesupport_introspection_c.h"
// Member `date_time`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__ObstacleDetection__init(message_memory);
}

void ObstacleDetection__rosidl_typesupport_introspection_c__ObstacleDetection_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__ObstacleDetection__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ObstacleDetection__rosidl_typesupport_introspection_c__ObstacleDetection_message_member_array[7] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__ObstacleDetection, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__ObstacleDetection, ob_dist),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__ObstacleDetection, ob_direct),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__ObstacleDetection, date_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__ObstacleDetection, description),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__ObstacleDetection, location_details),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__ObstacleDetection, vert_event),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ObstacleDetection__rosidl_typesupport_introspection_c__ObstacleDetection_message_members = {
  ...
  7,  // number of fields
  sizeof(carma_v2x_msgs__msg__ObstacleDetection),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, ObstacleDetection)() {
  ObstacleDetection__rosidl_typesupport_introspection_c__ObstacleDetection_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, ObstacleDistance)();
  ObstacleDetection__rosidl_typesupport_introspection_c__ObstacleDetection_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, ObstacleDirection)();
