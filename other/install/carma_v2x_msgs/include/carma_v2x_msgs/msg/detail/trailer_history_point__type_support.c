...
// Member `time_offset`
#include "carma_v2x_msgs/msg/time_offset.h"
// Member `time_offset`
#include "carma_v2x_msgs/msg/detail/time_offset__rosidl_typesupport_introspection_c.h"
...
// Member `heading`
#include "carma_v2x_msgs/msg/coarse_heading.h"
// Member `heading`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__TrailerHistoryPoint__init(message_memory);
}

void TrailerHistoryPoint__rosidl_typesupport_introspection_c__TrailerHistoryPoint_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__TrailerHistoryPoint__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrailerHistoryPoint__rosidl_typesupport_introspection_c__TrailerHistoryPoint_message_member_array[6] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__TrailerHistoryPoint, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrailerHistoryPoint, pivot_angle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrailerHistoryPoint, time_offset),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrailerHistoryPoint, position_offset),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrailerHistoryPoint, elevation_offset),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrailerHistoryPoint, heading),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrailerHistoryPoint__rosidl_typesupport_introspection_c__TrailerHistoryPoint_message_members = {
  ...
  6,  // number of fields
  sizeof(carma_v2x_msgs__msg__TrailerHistoryPoint),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, TrailerHistoryPoint)() {
  ...
  TrailerHistoryPoint__rosidl_typesupport_introspection_c__TrailerHistoryPoint_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, TimeOffset)();
