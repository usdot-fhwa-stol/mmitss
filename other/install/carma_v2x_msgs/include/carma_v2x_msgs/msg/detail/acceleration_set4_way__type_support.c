  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__AccelerationSet4Way__init(message_memory);
}

void AccelerationSet4Way__rosidl_typesupport_introspection_c__AccelerationSet4Way_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__AccelerationSet4Way__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AccelerationSet4Way__rosidl_typesupport_introspection_c__AccelerationSet4Way_message_member_array[5] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__AccelerationSet4Way, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__AccelerationSet4Way, longitudinal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__AccelerationSet4Way, lateral),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__AccelerationSet4Way, vert),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__AccelerationSet4Way, yaw_rate),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers AccelerationSet4Way__rosidl_typesupport_introspection_c__AccelerationSet4Way_message_members = {
  ...
  5,  // number of fields
  sizeof(carma_v2x_msgs__msg__AccelerationSet4Way),
