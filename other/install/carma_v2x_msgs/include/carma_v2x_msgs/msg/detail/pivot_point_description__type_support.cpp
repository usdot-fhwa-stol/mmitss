...
{
  new (message_memory) carma_v2x_msgs::msg::PivotPointDescription(_init);
}

void PivotPointDescription_fini_function(void * message_memory)
{
  auto typed_message = static_cast<carma_v2x_msgs::msg::PivotPointDescription *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PivotPointDescription_message_member_array[3] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<carma_v2x_msgs::msg::OffsetB11>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::PivotPointDescription, pivot_offset),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::PivotPointDescription, pivot_angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs::msg::PivotPointDescription, pivots),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PivotPointDescription_message_members = {
  ...
  3,  // number of fields
  sizeof(carma_v2x_msgs::msg::PivotPointDescription),
...
{
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::PivotPointDescription_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carma_v2x_msgs, msg, PivotPointDescription)() {
  return &::carma_v2x_msgs::msg::rosidl_typesupport_introspection_cpp::PivotPointDescription_message_type_support_handle;
}
