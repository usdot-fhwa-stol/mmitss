...
#include <stddef.h>
#include "carma_v2x_msgs/msg/detail/map_data__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__MapData__init(message_memory);
}

void MapData__rosidl_typesupport_introspection_c__MapData_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__MapData__fini(message_memory);
}

size_t MapData__rosidl_typesupport_introspection_c__size_function__IntersectionGeometry__intersections(
  const void * untyped_member)
{
  const carma_v2x_msgs__msg__IntersectionGeometry__Sequence * member =
    (const carma_v2x_msgs__msg__IntersectionGeometry__Sequence *)(untyped_member);
  return member->size;
}
...
{
  carma_v2x_msgs__msg__IntersectionGeometry__Sequence * member =
    (carma_v2x_msgs__msg__IntersectionGeometry__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  carma_v2x_msgs__msg__IntersectionGeometry__Sequence * member =
    (carma_v2x_msgs__msg__IntersectionGeometry__Sequence *)(untyped_member);
  carma_v2x_msgs__msg__IntersectionGeometry__Sequence__fini(member);
  return carma_v2x_msgs__msg__IntersectionGeometry__Sequence__init(member, size);
}

size_t MapData__rosidl_typesupport_introspection_c__size_function__RoadSegment__road_segment_list(
  const void * untyped_member)
{
  const carma_v2x_msgs__msg__RoadSegment__Sequence * member =
    (const carma_v2x_msgs__msg__RoadSegment__Sequence *)(untyped_member);
  return member->size;
}

const void * MapData__rosidl_typesupport_introspection_c__get_const_function__RoadSegment__road_segment_list(
  const void * untyped_member, size_t index)
{
  const carma_v2x_msgs__msg__RoadSegment__Sequence * member =
    (const carma_v2x_msgs__msg__RoadSegment__Sequence *)(untyped_member);
...
void * MapData__rosidl_typesupport_introspection_c__get_function__RoadSegment__road_segment_list(
  void * untyped_member, size_t index)
{
  carma_v2x_msgs__msg__RoadSegment__Sequence * member =
    (carma_v2x_msgs__msg__RoadSegment__Sequence *)(untyped_member);
  return &member->data[index];
}

bool MapData__rosidl_typesupport_introspection_c__resize_function__RoadSegment__road_segment_list(
  void * untyped_member, size_t size)
{
  carma_v2x_msgs__msg__RoadSegment__Sequence * member =
    (carma_v2x_msgs__msg__RoadSegment__Sequence *)(untyped_member);
  carma_v2x_msgs__msg__RoadSegment__Sequence__fini(member);
  return carma_v2x_msgs__msg__RoadSegment__Sequence__init(member, size);
}

size_t MapData__rosidl_typesupport_introspection_c__size_function__RestrictionClassAssignment__restriction_class_list(
  const void * untyped_member)
{
...
const void * MapData__rosidl_typesupport_introspection_c__get_const_function__RestrictionClassAssignment__restriction_class_list(
  const void * untyped_member, size_t index)
{
  const j2735_v2x_msgs__msg__RestrictionClassAssignment__Sequence * member =
    (const j2735_v2x_msgs__msg__RestrictionClassAssignment__Sequence *)(untyped_member);
...
void * MapData__rosidl_typesupport_introspection_c__get_function__RestrictionClassAssignment__restriction_class_list(
  void * untyped_member, size_t index)
{
...
bool MapData__rosidl_typesupport_introspection_c__resize_function__RestrictionClassAssignment__restriction_class_list(
  void * untyped_member, size_t size)
{
  j2735_v2x_msgs__msg__RestrictionClassAssignment__Sequence * member =
    (j2735_v2x_msgs__msg__RestrictionClassAssignment__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember MapData__rosidl_typesupport_introspection_c__MapData_message_member_array[15] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__MapData, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, time_stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, time_stamp_exists),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, msg_issue_revision),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, layer_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, layer_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, layer_id_exists),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, intersections),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, intersections_exists),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, road_segment_list),  // bytes offset in struct
    NULL,  // default value
    MapData__rosidl_typesupport_introspection_c__size_function__RoadSegment__road_segment_list,  // size() function pointer
    MapData__rosidl_typesupport_introspection_c__get_const_function__RoadSegment__road_segment_list,  // get_const(index) function pointer
    MapData__rosidl_typesupport_introspection_c__get_function__RoadSegment__road_segment_list,  // get(index) function pointer
    MapData__rosidl_typesupport_introspection_c__resize_function__RoadSegment__road_segment_list  // resize(index) function pointer
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, road_segments_exists),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, data_parameters),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, data_parameters_exists),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, restriction_class_list),  // bytes offset in struct
    NULL,  // default value
    MapData__rosidl_typesupport_introspection_c__size_function__RestrictionClassAssignment__restriction_class_list,  // size() function pointer
    MapData__rosidl_typesupport_introspection_c__get_const_function__RestrictionClassAssignment__restriction_class_list,  // get_const(index) function pointer
    MapData__rosidl_typesupport_introspection_c__get_function__RestrictionClassAssignment__restriction_class_list,  // get(index) function pointer
    MapData__rosidl_typesupport_introspection_c__resize_function__RestrictionClassAssignment__restriction_class_list  // resize(index) function pointer
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__MapData, restriction_list_exists),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MapData__rosidl_typesupport_introspection_c__MapData_message_members = {
  ...
  15,  // number of fields
  sizeof(carma_v2x_msgs__msg__MapData),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, MapData)() {
