...
#include <stddef.h>
#include "carma_v2x_msgs/msg/detail/traffic_control_request_v01__rosidl_typesupport_introspection_c.h"
...
// Member `bounds`
#include "carma_v2x_msgs/msg/traffic_control_bounds.h"
// Member `bounds`
#include "carma_v2x_msgs/msg/detail/traffic_control_bounds__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__TrafficControlRequestV01__init(message_memory);
}
...
{
  carma_v2x_msgs__msg__TrafficControlRequestV01__fini(message_memory);
}

size_t TrafficControlRequestV01__rosidl_typesupport_introspection_c__size_function__TrafficControlBounds__bounds(
  const void * untyped_member)
{
  const carma_v2x_msgs__msg__TrafficControlBounds__Sequence * member =
    (const carma_v2x_msgs__msg__TrafficControlBounds__Sequence *)(untyped_member);
  return member->size;
}
...
{
  carma_v2x_msgs__msg__TrafficControlBounds__Sequence * member =
    (carma_v2x_msgs__msg__TrafficControlBounds__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  carma_v2x_msgs__msg__TrafficControlBounds__Sequence * member =
    (carma_v2x_msgs__msg__TrafficControlBounds__Sequence *)(untyped_member);
  carma_v2x_msgs__msg__TrafficControlBounds__Sequence__fini(member);
  return carma_v2x_msgs__msg__TrafficControlBounds__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember TrafficControlRequestV01__rosidl_typesupport_introspection_c__TrafficControlRequestV01_message_member_array[3] = {
  {
    "reqid",  // name
    ...
    offsetof(carma_v2x_msgs__msg__TrafficControlRequestV01, reqid),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlRequestV01, reqseq),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__TrafficControlRequestV01, bounds),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers TrafficControlRequestV01__rosidl_typesupport_introspection_c__TrafficControlRequestV01_message_members = {
  ...
  3,  // number of fields
  sizeof(carma_v2x_msgs__msg__TrafficControlRequestV01),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, TrafficControlRequestV01)() {
  ...
  TrafficControlRequestV01__rosidl_typesupport_introspection_c__TrafficControlRequestV01_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carma_v2x_msgs, msg, TrafficControlBounds)();
