...
carma_v2x_msgs__msg__EmergencyVehicleAck__init(carma_v2x_msgs__msg__EmergencyVehicleAck * msg)
{
  ...
  if (!carma_v2x_msgs__msg__MobilityHeader__init(&msg->m_header)) {
    carma_v2x_msgs__msg__EmergencyVehicleAck__fini(msg);
    return false;
  }
  // acknowledgement
  return true;
...
carma_v2x_msgs__msg__EmergencyVehicleAck__are_equal(const carma_v2x_msgs__msg__EmergencyVehicleAck * lhs, const carma_v2x_msgs__msg__EmergencyVehicleAck * rhs)
{
  ...
  // acknowledgement
  if (lhs->acknowledgement != rhs->acknowledgement) {
    return false;
  }
  return true;
}
...
carma_v2x_msgs__msg__EmergencyVehicleAck__create()
{
  ...
  carma_v2x_msgs__msg__EmergencyVehicleAck * msg = (carma_v2x_msgs__msg__EmergencyVehicleAck *)allocator.allocate(sizeof(carma_v2x_msgs__msg__EmergencyVehicleAck), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(carma_v2x_msgs__msg__EmergencyVehicleAck));
  bool success = carma_v2x_msgs__msg__EmergencyVehicleAck__init(msg);
  if (!success) {
...
carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence__init(carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_v2x_msgs__msg__EmergencyVehicleAck * data = NULL;

  if (size) {
    data = (carma_v2x_msgs__msg__EmergencyVehicleAck *)allocator.zero_allocate(size, sizeof(carma_v2x_msgs__msg__EmergencyVehicleAck), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = carma_v2x_msgs__msg__EmergencyVehicleAck__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        carma_v2x_msgs__msg__EmergencyVehicleAck__fini(&data[i - 1]);
      }
...
carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence__fini(carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      carma_v2x_msgs__msg__EmergencyVehicleAck__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence * array = (carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence *)allocator.allocate(sizeof(carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence__init(array, size);
  if (!success) {
...
carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence__destroy(carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence__are_equal(const carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence * lhs, const carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!carma_v2x_msgs__msg__EmergencyVehicleAck__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  carma_v2x_msgs__msg__EmergencyVehicleAck__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(carma_v2x_msgs__msg__EmergencyVehicleAck);
    carma_v2x_msgs__msg__EmergencyVehicleAck * data =
      (carma_v2x_msgs__msg__EmergencyVehicleAck *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carma_v2x_msgs__msg__EmergencyVehicleAck__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          carma_v2x_msgs__msg__EmergencyVehicleAck__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!carma_v2x_msgs__msg__EmergencyVehicleAck__copy(
