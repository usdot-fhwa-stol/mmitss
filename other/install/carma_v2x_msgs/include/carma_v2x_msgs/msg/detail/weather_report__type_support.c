...
// Member `rain_rate`
#include "carma_v2x_msgs/msg/ntcip_ess_precip_rate.h"
// Member `rain_rate`
...
#include "carma_v2x_msgs/msg/coefficient_of_friction.h"
// Member `road_friction`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  carma_v2x_msgs__msg__WeatherReport__init(message_memory);
}

void WeatherReport__rosidl_typesupport_introspection_c__WeatherReport_fini_function(void * message_memory)
{
  carma_v2x_msgs__msg__WeatherReport__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember WeatherReport__rosidl_typesupport_introspection_c__WeatherReport_message_member_array[7] = {
  {
    ...
    offsetof(carma_v2x_msgs__msg__WeatherReport, presence_vector),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__WeatherReport, is_raining),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__WeatherReport, rain_rate),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__WeatherReport, precip_situation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__WeatherReport, solar_radiation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__WeatherReport, friction),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carma_v2x_msgs__msg__WeatherReport, road_friction),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers WeatherReport__rosidl_typesupport_introspection_c__WeatherReport_message_members = {
  ...
  7,  // number of fields
  sizeof(carma_v2x_msgs__msg__WeatherReport),
