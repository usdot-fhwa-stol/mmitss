...
bool carma_v2x_msgs__msg__regulatory_speed_limit__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._regulatory_speed_limit.RegulatorySpeedLimit", full_classname_dest, 63) == 0);
  }
  carma_v2x_msgs__msg__RegulatorySpeedLimit * ros_message = _ros_message;
  {  // type
...
PyObject * carma_v2x_msgs__msg__regulatory_speed_limit__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._regulatory_speed_limit");
