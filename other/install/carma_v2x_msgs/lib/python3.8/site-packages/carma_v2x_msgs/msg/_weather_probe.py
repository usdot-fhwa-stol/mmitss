...
class WeatherProbe(metaclass=Metaclass_WeatherProbe):
    ...
    _fields_and_field_types = {
        ...
        'air_temp': 'carma_v2x_msgs/AmbientAirTemperature',
        'air_pressure': 'carma_v2x_msgs/AmbientAirPressure',
        'rain_rates': 'carma_v2x_msgs/WiperSet',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'AmbientAirTemperature'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'AmbientAirPressure'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'WiperSet'),  # noqa: E501
    )
