...
class Metaclass_NodeSetXY(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import NodeXY
...
class NodeSetXY(metaclass=Metaclass_NodeSetXY):
    ...
    _fields_and_field_types = {
        'node_set_xy': 'sequence<carma_v2x_msgs/NodeXY>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'NodeXY')),  # noqa: E501
    )
