...
bool carma_v2x_msgs__msg__vehicle_data__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool carma_v2x_msgs__msg__weather_probe__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool carma_v2x_msgs__msg__gross_speed__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * carma_v2x_msgs__msg__gross_speed__convert_to_py(void * raw_ros_message);
bool carma_v2x_msgs__msg__rtcm_package__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool carma_v2x_msgs__msg__supplemental_vehicle_extensions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._supplemental_vehicle_extensions.SupplementalVehicleExtensions", full_classname_dest, 81) == 0);
  }
  carma_v2x_msgs__msg__SupplementalVehicleExtensions * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // vehicle_data
    ...
    if (!carma_v2x_msgs__msg__vehicle_data__convert_from_py(field, &ros_message->vehicle_data)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // weather_report
    ...
    if (!carma_v2x_msgs__msg__weather_report__convert_from_py(field, &ros_message->weather_report)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // weather_probe
    ...
    if (!carma_v2x_msgs__msg__weather_probe__convert_from_py(field, &ros_message->weather_probe)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // obstacle
    ...
    if (!carma_v2x_msgs__msg__obstacle_detection__convert_from_py(field, &ros_message->obstacle)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // speed_profile
    ...
    if (!carma_v2x_msgs__msg__GrossSpeed__Sequence__init(&(ros_message->speed_profile), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create carma_v2x_msgs__msg__GrossSpeed__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    carma_v2x_msgs__msg__GrossSpeed * dest = ros_message->speed_profile.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!carma_v2x_msgs__msg__gross_speed__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // the_rtcm
    ...
    if (!carma_v2x_msgs__msg__rtcm_package__convert_from_py(field, &ros_message->the_rtcm)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__supplemental_vehicle_extensions__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._supplemental_vehicle_extensions");
  ...
  {  // vehicle_data
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__vehicle_data__convert_to_py(&ros_message->vehicle_data);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // weather_report
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__weather_report__convert_to_py(&ros_message->weather_report);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // weather_probe
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__weather_probe__convert_to_py(&ros_message->weather_probe);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // obstacle
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__obstacle_detection__convert_to_py(&ros_message->obstacle);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // speed_profile
    ...
    carma_v2x_msgs__msg__GrossSpeed * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->speed_profile.data[i]);
      PyObject * pyitem = carma_v2x_msgs__msg__gross_speed__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // the_rtcm
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__rtcm_package__convert_to_py(&ros_message->the_rtcm);
    if (!field) {
      return NULL;
    }
    {
