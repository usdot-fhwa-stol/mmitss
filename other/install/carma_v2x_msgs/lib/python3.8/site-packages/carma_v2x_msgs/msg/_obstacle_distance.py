...
class Metaclass_ObstacleDistance(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'DISTANCE_MIN': cls.__constants['DISTANCE_MIN'],
            'DISTANCE_MAX': cls.__constants['DISTANCE_MAX'],
        }

    @property
    def DISTANCE_MIN(self):
        """Message constant 'DISTANCE_MIN'."""
        return Metaclass_ObstacleDistance.__constants['DISTANCE_MIN']

    @property
    def DISTANCE_MAX(self):
        """Message constant 'DISTANCE_MAX'."""
        return Metaclass_ObstacleDistance.__constants['DISTANCE_MAX']
