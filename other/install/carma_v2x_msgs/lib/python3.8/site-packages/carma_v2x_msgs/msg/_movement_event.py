...
class MovementEvent(metaclass=Metaclass_MovementEvent):
    ...
    _fields_and_field_types = {
        ...
        'timing': 'carma_v2x_msgs/TimeChangeDetails',
        'timing_exists': 'boolean',
        'advisory_speed_list': 'sequence<carma_v2x_msgs/AdvisorySpeed>',
        'speeds_exists': 'boolean',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'MovementPhaseState'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'TimeChangeDetails'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'AdvisorySpeed')),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
    )
