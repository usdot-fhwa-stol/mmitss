...
class TrafficControlMessageV01(metaclass=Metaclass_TrafficControlMessageV01):
    ...
    _fields_and_field_types = {
        ...
        'updated': 'builtin_interfaces/Time',
        'package': 'j2735_v2x_msgs/TrafficControlPackage',
        'package_exists': 'boolean',
        'params': 'carma_v2x_msgs/TrafficControlParams',
        'params_exists': 'boolean',
        'geometry': 'carma_v2x_msgs/TrafficControlGeometry',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'TrafficControlParams'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'TrafficControlGeometry'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from builtin_interfaces.msg import Time
        self.updated = kwargs.get('updated', Time())
        from j2735_v2x_msgs.msg import TrafficControlPackage
    ...
    def updated(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'updated' field must be a sub message of type 'Time'"
        self._updated = value
