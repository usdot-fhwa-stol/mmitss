...
bool carma_v2x_msgs__msg__obstacle_direction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._obstacle_direction.ObstacleDirection", full_classname_dest, 56) == 0);
  }
  carma_v2x_msgs__msg__ObstacleDirection * ros_message = _ros_message;
  {  // direction
    PyObject * field = PyObject_GetAttrString(_pymsg, "direction");
    if (!field) {
      return false;
    }
    if (!carma_v2x_msgs__msg__angle__convert_from_py(field, &ros_message->direction)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__obstacle_direction__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._obstacle_direction");
  ...
  {  // direction
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__angle__convert_to_py(&ros_message->direction);
    if (!field) {
      return NULL;
    }
    {
