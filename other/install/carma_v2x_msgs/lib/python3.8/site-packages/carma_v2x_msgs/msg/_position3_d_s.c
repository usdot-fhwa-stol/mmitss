...
bool carma_v2x_msgs__msg__position3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._position3_d.Position3D", full_classname_dest, 42) == 0);
  }
  carma_v2x_msgs__msg__Position3D * ros_message = _ros_message;
  {  // latitude
...
PyObject * carma_v2x_msgs__msg__position3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._position3_d");
