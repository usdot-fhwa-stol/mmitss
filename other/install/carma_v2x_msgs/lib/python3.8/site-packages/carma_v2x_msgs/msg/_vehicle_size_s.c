...
bool carma_v2x_msgs__msg__vehicle_size__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._vehicle_size.VehicleSize", full_classname_dest, 44) == 0);
  }
  carma_v2x_msgs__msg__VehicleSize * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // vehicle_length
    ...
    assert(PyFloat_Check(field));
    ros_message->vehicle_length = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * carma_v2x_msgs__msg__vehicle_size__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._vehicle_size");
