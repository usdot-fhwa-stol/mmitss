...
class Metaclass_TrailerData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import TrailerUnitDescriptionList
...
class TrailerData(metaclass=Metaclass_TrailerData):
    ...
    _fields_and_field_types = {
        'ssp_index': 'uint8',
        'connection': 'carma_v2x_msgs/PivotPointDescription',
        'units': 'carma_v2x_msgs/TrailerUnitDescriptionList',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'PivotPointDescription'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'TrailerUnitDescriptionList'),  # noqa: E501
    )
