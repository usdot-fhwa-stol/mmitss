...
bool carma_v2x_msgs__msg__mobility_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._mobility_path.MobilityPath", full_classname_dest, 46) == 0);
  }
  carma_v2x_msgs__msg__MobilityPath * ros_message = _ros_message;
  {  // m_header
...
{
  /* NOTE(esteve): Call constructor of MobilityPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._mobility_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MobilityPath");
