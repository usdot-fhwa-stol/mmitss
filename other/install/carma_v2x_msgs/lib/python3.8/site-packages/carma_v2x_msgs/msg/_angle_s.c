...
bool carma_v2x_msgs__msg__angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._angle.Angle", full_classname_dest, 31) == 0);
  }
  carma_v2x_msgs__msg__Angle * ros_message = _ros_message;
  {  // angle
...
PyObject * carma_v2x_msgs__msg__angle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._angle");
