...
bool carma_v2x_msgs__msg__vehicle_height__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._vehicle_height.VehicleHeight", full_classname_dest, 48) == 0);
  }
  carma_v2x_msgs__msg__VehicleHeight * ros_message = _ros_message;
  {  // vehicle_height
    ...
    ros_message->vehicle_height = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // unavailable
...
{
  /* NOTE(esteve): Call constructor of VehicleHeight */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._vehicle_height");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleHeight");
  ...
  {  // vehicle_height
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->vehicle_height);
    {
