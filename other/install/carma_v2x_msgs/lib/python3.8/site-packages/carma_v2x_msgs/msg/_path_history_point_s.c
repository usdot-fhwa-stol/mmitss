...
bool carma_v2x_msgs__msg__offset_llb18__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * carma_v2x_msgs__msg__offset_llb18__convert_to_py(void * raw_ros_message);
bool carma_v2x_msgs__msg__vert_offset_b12__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool carma_v2x_msgs__msg__path_history_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._path_history_point.PathHistoryPoint", full_classname_dest, 55) == 0);
  }
  carma_v2x_msgs__msg__PathHistoryPoint * ros_message = _ros_message;
  {  // lat_offset
    PyObject * field = PyObject_GetAttrString(_pymsg, "lat_offset");
    if (!field) {
      return false;
    }
    if (!carma_v2x_msgs__msg__offset_llb18__convert_from_py(field, &ros_message->lat_offset)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // lon_offset
    ...
    if (!carma_v2x_msgs__msg__offset_llb18__convert_from_py(field, &ros_message->lon_offset)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // elevation_offset
    ...
    if (!carma_v2x_msgs__msg__vert_offset_b12__convert_from_py(field, &ros_message->elevation_offset)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__path_history_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._path_history_point");
  ...
  {  // lat_offset
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__offset_llb18__convert_to_py(&ros_message->lat_offset);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // lon_offset
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__offset_llb18__convert_to_py(&ros_message->lon_offset);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // elevation_offset
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__vert_offset_b12__convert_to_py(&ros_message->elevation_offset);
    if (!field) {
      return NULL;
    }
    {
