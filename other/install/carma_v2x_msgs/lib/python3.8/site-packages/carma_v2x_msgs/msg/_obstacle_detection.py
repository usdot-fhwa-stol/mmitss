...
class ObstacleDetection(metaclass=Metaclass_ObstacleDetection):
    ...
    _fields_and_field_types = {
        ...
        'ob_dist': 'carma_v2x_msgs/ObstacleDistance',
        'ob_direct': 'carma_v2x_msgs/ObstacleDirection',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'ObstacleDistance'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'ObstacleDirection'),  # noqa: E501
