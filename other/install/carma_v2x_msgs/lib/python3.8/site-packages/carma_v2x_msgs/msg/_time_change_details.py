...
class TimeChangeDetails(metaclass=Metaclass_TimeChangeDetails):
    ...
    def __init__(self, **kwargs):
        ...
        self.min_end_time = kwargs.get('min_end_time', float())
        self.max_end_time = kwargs.get('max_end_time', float())
        self.max_end_time_exists = kwargs.get('max_end_time_exists', bool())
        self.likely_time = kwargs.get('likely_time', float())
        ...
        self.next_time = kwargs.get('next_time', float())
    ...
    def min_end_time(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'min_end_time' field must be of type 'float'"
    ...
    def max_end_time(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'max_end_time' field must be of type 'float'"
    ...
    def likely_time(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'likely_time' field must be of type 'float'"
    ...
    def next_time(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'next_time' field must be of type 'float'"
