...
bool carma_v2x_msgs__msg__acceleration_set4_way__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._acceleration_set4_way.AccelerationSet4Way", full_classname_dest, 61) == 0);
  }
  carma_v2x_msgs__msg__AccelerationSet4Way * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // vert
    ...
    assert(PyFloat_Check(field));
    ros_message->vert = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // yaw_rate
...
PyObject * carma_v2x_msgs__msg__acceleration_set4_way__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._acceleration_set4_way");
  ...
  {  // vert
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->vert);
    {
