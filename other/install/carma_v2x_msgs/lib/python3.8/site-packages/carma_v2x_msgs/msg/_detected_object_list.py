...
class Metaclass_DetectedObjectList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import DetectedObjectData
...
class DetectedObjectList(metaclass=Metaclass_DetectedObjectList):
    ...
    _fields_and_field_types = {
        'detected_object_data': 'sequence<carma_v2x_msgs/DetectedObjectData>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'DetectedObjectData')),  # noqa: E501
    )
