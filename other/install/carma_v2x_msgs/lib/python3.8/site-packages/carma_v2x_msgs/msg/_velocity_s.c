...
bool carma_v2x_msgs__msg__velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._velocity.Velocity", full_classname_dest, 37) == 0);
  }
  carma_v2x_msgs__msg__Velocity * ros_message = _ros_message;
  {  // velocity
...
PyObject * carma_v2x_msgs__msg__velocity__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._velocity");
