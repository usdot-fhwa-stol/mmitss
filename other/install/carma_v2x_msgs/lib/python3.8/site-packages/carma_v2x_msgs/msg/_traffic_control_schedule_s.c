...
bool carma_v2x_msgs__msg__repeat_params__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool carma_v2x_msgs__msg__traffic_control_schedule__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._traffic_control_schedule.TrafficControlSchedule", full_classname_dest, 67) == 0);
  }
  carma_v2x_msgs__msg__TrafficControlSchedule * ros_message = _ros_message;
  {  // start
  ...
  {  // between
    ...
    if (!carma_v2x_msgs__msg__DailySchedule__Sequence__init(&(ros_message->between), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create carma_v2x_msgs__msg__DailySchedule__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    carma_v2x_msgs__msg__DailySchedule * dest = ros_message->between.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!carma_v2x_msgs__msg__daily_schedule__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // repeat
    ...
    if (!carma_v2x_msgs__msg__repeat_params__convert_from_py(field, &ros_message->repeat)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__traffic_control_schedule__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._traffic_control_schedule");
  ...
  {  // between
    ...
    carma_v2x_msgs__msg__DailySchedule * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->between.data[i]);
      PyObject * pyitem = carma_v2x_msgs__msg__daily_schedule__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // repeat
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__repeat_params__convert_to_py(&ros_message->repeat);
    if (!field) {
      return NULL;
    }
    {
