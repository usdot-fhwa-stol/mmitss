...
class Metaclass_PathPrediction(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'MIN_RADIUS': cls.__constants['MIN_RADIUS'],
            'MAX_RADIUS': cls.__constants['MAX_RADIUS'],
            'MIN_CONFIDENCE': cls.__constants['MIN_CONFIDENCE'],
            'MAX_CONFIDENCE': cls.__constants['MAX_CONFIDENCE'],
        }

    @property
    def MIN_RADIUS(self):
        """Message constant 'MIN_RADIUS'."""
        return Metaclass_PathPrediction.__constants['MIN_RADIUS']

    @property
    def MAX_RADIUS(self):
        """Message constant 'MAX_RADIUS'."""
        return Metaclass_PathPrediction.__constants['MAX_RADIUS']

    @property
    def MIN_CONFIDENCE(self):
        """Message constant 'MIN_CONFIDENCE'."""
        return Metaclass_PathPrediction.__constants['MIN_CONFIDENCE']

    @property
    def MAX_CONFIDENCE(self):
        """Message constant 'MAX_CONFIDENCE'."""
        return Metaclass_PathPrediction.__constants['MAX_CONFIDENCE']
...
class PathPrediction(metaclass=Metaclass_PathPrediction):
    ...
    def __init__(self, **kwargs):
        ...
        self.radius_of_curvature = kwargs.get('radius_of_curvature', float())
    ...
    def radius_of_curvature(self, value):
        if __debug__:
            assert \
                ...
                "The 'radius_of_curvature' field must be of type 'float'"
