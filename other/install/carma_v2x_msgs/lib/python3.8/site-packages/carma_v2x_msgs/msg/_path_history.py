...
class PathHistory(metaclass=Metaclass_PathHistory):
    ...
    _fields_and_field_types = {
        ...
        'crumb_data': 'carma_v2x_msgs/PathHistoryPointList',
        'initial_position': 'carma_v2x_msgs/FullPositionVector',
        'curr_gnss_status': 'j2735_v2x_msgs/GNSSStatus',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'PathHistoryPointList'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'FullPositionVector'),  # noqa: E501
