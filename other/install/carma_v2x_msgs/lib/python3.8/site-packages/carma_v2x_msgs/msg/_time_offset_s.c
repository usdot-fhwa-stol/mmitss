...
bool carma_v2x_msgs__msg__time_offset__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._time_offset.TimeOffset", full_classname_dest, 42) == 0);
  }
  carma_v2x_msgs__msg__TimeOffset * ros_message = _ros_message;
  {  // offset
...
{
  /* NOTE(esteve): Call constructor of TimeOffset */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._time_offset");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TimeOffset");
