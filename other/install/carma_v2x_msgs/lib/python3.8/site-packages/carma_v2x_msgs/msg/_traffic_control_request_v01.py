...
class Metaclass_TrafficControlRequestV01(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from carma_v2x_msgs.msg import TrafficControlBounds
...
class TrafficControlRequestV01(metaclass=Metaclass_TrafficControlRequestV01):
    ...
    _fields_and_field_types = {
        ...
        'reqseq': 'uint8',
        'bounds': 'sequence<carma_v2x_msgs/TrafficControlBounds>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['j2735_v2x_msgs', 'msg'], 'Id64b'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'TrafficControlBounds')),  # noqa: E501
    )
