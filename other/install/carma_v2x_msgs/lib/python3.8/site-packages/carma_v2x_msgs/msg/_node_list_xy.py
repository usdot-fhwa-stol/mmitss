...
class NodeListXY(metaclass=Metaclass_NodeListXY):
    ...
    _fields_and_field_types = {
        'choice': 'uint8',
        'nodes': 'carma_v2x_msgs/NodeSetXY',
        'computed': 'carma_v2x_msgs/ComputedLane',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'NodeSetXY'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['carma_v2x_msgs', 'msg'], 'ComputedLane'),  # noqa: E501
    )
