...
bool carma_v2x_msgs__msg__bsm_core_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._bsm_core_data.BSMCoreData", full_classname_dest, 45) == 0);
  }
  carma_v2x_msgs__msg__BSMCoreData * ros_message = _ros_message;
  {  // msg_count
  ...
  {  // accuracy
    ...
    if (!carma_v2x_msgs__msg__positional_accuracy__convert_from_py(field, &ros_message->accuracy)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // accel_set
    ...
    if (!carma_v2x_msgs__msg__acceleration_set4_way__convert_from_py(field, &ros_message->accel_set)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__bsm_core_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._bsm_core_data");
  ...
  {  // accuracy
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__positional_accuracy__convert_to_py(&ros_message->accuracy);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // accel_set
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__acceleration_set4_way__convert_to_py(&ros_message->accel_set);
    if (!field) {
      return NULL;
    }
    {
