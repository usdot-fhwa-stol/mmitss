...
bool carma_v2x_msgs__msg__vehicle_mass__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool carma_v2x_msgs__msg__vehicle_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carma_v2x_msgs.msg._vehicle_data.VehicleData", full_classname_dest, 44) == 0);
  }
  carma_v2x_msgs__msg__VehicleData * ros_message = _ros_message;
  {  // presence_vector
  ...
  {  // bumpers
    ...
    if (!carma_v2x_msgs__msg__bumper_heights__convert_from_py(field, &ros_message->bumpers)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // mass
    ...
    if (!carma_v2x_msgs__msg__vehicle_mass__convert_from_py(field, &ros_message->mass)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // trailer_weight
    ...
    if (!carma_v2x_msgs__msg__trailer_weight__convert_from_py(field, &ros_message->trailer_weight)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * carma_v2x_msgs__msg__vehicle_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("carma_v2x_msgs.msg._vehicle_data");
  ...
  {  // bumpers
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__bumper_heights__convert_to_py(&ros_message->bumpers);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // mass
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__vehicle_mass__convert_to_py(&ros_message->mass);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // trailer_weight
    PyObject * field = NULL;
    field = carma_v2x_msgs__msg__trailer_weight__convert_to_py(&ros_message->trailer_weight);
    if (!field) {
      return NULL;
    }
    {
