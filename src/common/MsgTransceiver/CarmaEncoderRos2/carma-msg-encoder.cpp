...
int main(int argc, char **argv)
{
    ...
    rclcpp::Node n = rclcpp::Node::make_shared("mmitss_carma_publisher");
    rclcpp::Publisher<cav_msgs::ByteArray::ConstPtr>::SharedPtr outbound_msg_publisher =  n.create_publisher<cav_msgs::ByteArray::ConstPtr>("/hardware_interface/comms/outbound_binary_message", 1000);
